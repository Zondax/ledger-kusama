...
| Name                               | Nano S | Nano S XL          | Nano SP/X          | Nesting            | Arguments                                                                      |
| ---------------------------------- | ------ | ------------------ | ------------------ | ------------------ | ------------------------------------------------------------------------------ |
| Propose                            |        | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | `Hash`proposal_hash<br/>`CompactBalance`amount<br/>                            |
| Second                             |        | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | `Compactu32`proposal<br/>`Compactu32`seconds_upper_bound<br/>                  |
...
| External propose                   |        | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | `Hash`proposal_hash<br/>                                                       |
| External propose majority          |        | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | `Hash`proposal_hash<br/>                                                       |
| External propose default           |        | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | `Hash`proposal_hash<br/>                                                       |
| Fast track                         |        | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | `Hash`proposal_hash<br/>`BlockNumber`voting_period<br/>`BlockNumber`delay<br/> |
| Veto external                      |        | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | `Hash`proposal_hash<br/>                                                       |
| Cancel referendum                  |        | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | `Compactu32`ref_index<br/>                                                     |
| Cancel queued                      |        | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | `ReferendumIndex`which<br/>                                                    |
...
| Reap preimage                      |        | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | `Hash`proposal_hash<br/>`Compactu32`proposal_len_upper_bound<br/>              |
...
| Enact proposal                     |        | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | `Hash`proposal_hash<br/>`ReferendumIndex`index<br/>                            |
...
| Found                     |        | :heavy_check_mark: | :heavy_check_mark: |         | `AccountIdLookupOfT`founder<br/>`u32`max_members<br/>`Bytes`rules<br/> |
