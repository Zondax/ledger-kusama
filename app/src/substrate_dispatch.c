...
__Z_INLINE parser_error_t
_readMethod_democracy_propose(parser_context_t *c, pd_democracy_propose_t *m) {
...
__Z_INLINE parser_error_t
_readMethod_democracy_second(parser_context_t *c, pd_democracy_second_t *m) {
  CHECK_ERROR(_readCompactPropIndex(c, &m->proposal))
  CHECK_ERROR(_readCompactu32(c, &m->seconds_upper_bound))
  return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_democracy_vote(parser_context_t *c,
                                                     pd_democracy_vote_t *m) {
...
__Z_INLINE parser_error_t
_readMethod_democracy_note_imminent_preimage_operational(
...
__Z_INLINE parser_error_t
_readMethod_democracy_unlock(parser_context_t *c, pd_democracy_unlock_t *m) {
...
__Z_INLINE parser_error_t _readMethod_council_execute(parser_context_t *c,
                                                      pd_council_execute_t *m) {
  CHECK_ERROR(_readProposal(c, &m->proposal))
  CHECK_ERROR(_readCompactu32(c, &m->length_bound))
  return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_council_propose(parser_context_t *c,
                                                      pd_council_propose_t *m) {
...
__Z_INLINE parser_error_t _readMethod_council_vote(parser_context_t *c,
                                                   pd_council_vote_t *m) {
...
__Z_INLINE parser_error_t _readMethod_council_close(parser_context_t *c,
                                                    pd_council_close_t *m) {
  CHECK_ERROR(_readHash(c, &m->proposal_hash))
  CHECK_ERROR(_readCompactProposalIndex(c, &m->index))
...
__Z_INLINE parser_error_t
_readMethod_treasury_tip_new(parser_context_t *c, pd_treasury_tip_new_t *m) {
  CHECK_ERROR(_readBytes(c, &m->reason))
  CHECK_ERROR(_readAccountId(c, &m->who))
...
__Z_INLINE parser_error_t _readMethod_treasury_tip(parser_context_t *c,
                                                   pd_treasury_tip_t *m) {
  CHECK_ERROR(_readHash(c, &m->hash))
  CHECK_ERROR(_readCompactBalanceOf(c, &m->tip_value))
  return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_claims_claim(parser_context_t *c,
                                                   pd_claims_claim_t *m) {
...
__Z_INLINE parser_error_t
_readMethod_claims_mint_claim(parser_context_t *c, pd_claims_mint_claim_t *m) {
  CHECK_ERROR(_readEthereumAddress(c, &m->who))
  CHECK_ERROR(_readBalanceOf(c, &m->value))
  CHECK_ERROR(
      _readOptionTupleBalanceOfBalanceOfBlockNumber(c, &m->vesting_schedule))
...
__Z_INLINE parser_error_t _readMethod_claims_attest(parser_context_t *c,
                                                    pd_claims_attest_t *m) {
  CHECK_ERROR(_readBytes(c, &m->statement))
  return parser_ok;
}

__Z_INLINE parser_error_t
_readMethod_claims_move_claim(parser_context_t *c, pd_claims_move_claim_t *m) {
...
__Z_INLINE parser_error_t
_readMethod_utility_batch_all(parser_context_t *c, pd_utility_batch_all_t *m) {
  CHECK_ERROR(_readVecCall(c, &m->calls))
  return parser_ok;
}
...
__Z_INLINE parser_error_t
_readMethod_identity_set_subs(parser_context_t *c, pd_identity_set_subs_t *m) {
...
__Z_INLINE parser_error_t
_readMethod_identity_set_fee(parser_context_t *c, pd_identity_set_fee_t *m) {
...
__Z_INLINE parser_error_t
_readMethod_identity_add_sub(parser_context_t *c, pd_identity_add_sub_t *m) {
...
__Z_INLINE parser_error_t
_readMethod_identity_quit_sub(parser_context_t *c, pd_identity_quit_sub_t *m) {
  return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_society_bid(parser_context_t *c,
                                                  pd_society_bid_t *m) {
  CHECK_ERROR(_readBalanceOf(c, &m->value))
  return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_society_unbid(parser_context_t *c,
                                                    pd_society_unbid_t *m) {
  CHECK_ERROR(_readu32(c, &m->pos))
  return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_society_vouch(parser_context_t *c,
                                                    pd_society_vouch_t *m) {
  CHECK_ERROR(_readAccountId(c, &m->who))
  CHECK_ERROR(_readBalanceOf(c, &m->value))
...
__Z_INLINE parser_error_t _readMethod_society_unvouch(parser_context_t *c,
                                                      pd_society_unvouch_t *m) {
  CHECK_ERROR(_readu32(c, &m->pos))
  return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_society_vote(parser_context_t *c,
                                                   pd_society_vote_t *m) {
...
__Z_INLINE parser_error_t _readMethod_society_payout(parser_context_t *c,
                                                     pd_society_payout_t *m) {
  return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_society_found(parser_context_t *c,
                                                    pd_society_found_t *m) {
...
__Z_INLINE parser_error_t _readMethod_society_unfound(parser_context_t *c,
                                                      pd_society_unfound_t *m) {
  return parser_ok;
}
...
__Z_INLINE parser_error_t _readMethod_vesting_vest(parser_context_t *c,
                                                   pd_vesting_vest_t *m) {
  return parser_ok;
}
...
__Z_INLINE parser_error_t _readMethod_proxy_proxy(parser_context_t *c,
                                                  pd_proxy_proxy_t *m) {
...
__Z_INLINE parser_error_t _readMethod_proxy_add_proxy(parser_context_t *c,
                                                      pd_proxy_add_proxy_t *m) {
...
__Z_INLINE parser_error_t _readMethod_proxy_anonymous(parser_context_t *c,
                                                      pd_proxy_anonymous_t *m) {
  CHECK_ERROR(_readProxyType(c, &m->proxy_type))
  CHECK_ERROR(_readBlockNumber(c, &m->delay))
  CHECK_ERROR(_readu16(c, &m->index))
  return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_proxy_announce(parser_context_t *c,
                                                     pd_proxy_announce_t *m) {
  CHECK_ERROR(_readAccountId(c, &m->real))
...
__Z_INLINE parser_error_t
_readMethod_multisig_as_multi(parser_context_t *c, pd_multisig_as_multi_t *m) {
  CHECK_ERROR(_readu16(c, &m->threshold))
  CHECK_ERROR(_readVecAccountId(c, &m->other_signatories))
...
parser_error_t _readMethodBasic(parser_context_t *c, uint8_t moduleIdx,
  ...
  case 1027: /* module 4 call 3 */
    CHECK_ERROR(_readMethod_balances_transfer_keep_alive(
        c, &method->balances_transfer_keep_alive))
    break;
  ...
  case 3331: /* module 13 call 3 */
    CHECK_ERROR(_readMethod_democracy_emergency_cancel(
        c, &method->democracy_emergency_cancel))
    break;
  case 3332: /* module 13 call 4 */
    CHECK_ERROR(_readMethod_democracy_external_propose(
        c, &method->democracy_external_propose))
    break;
  case 3333: /* module 13 call 5 */
    CHECK_ERROR(_readMethod_democracy_external_propose_majority(
        c, &method->democracy_external_propose_majority))
    break;
  case 3334: /* module 13 call 6 */
    CHECK_ERROR(_readMethod_democracy_external_propose_default(
        c, &method->democracy_external_propose_default))
    break;
  case 3335: /* module 13 call 7 */
    CHECK_ERROR(
        _readMethod_democracy_fast_track(c, &method->democracy_fast_track))
    break;
  case 3336: /* module 13 call 8 */
    CHECK_ERROR(_readMethod_democracy_veto_external(
        c, &method->democracy_veto_external))
    break;
  case 3337: /* module 13 call 9 */
    CHECK_ERROR(_readMethod_democracy_cancel_referendum(
        c, &method->democracy_cancel_referendum))
    break;
  case 3338: /* module 13 call 10 */
    CHECK_ERROR(_readMethod_democracy_cancel_queued(
        c, &method->democracy_cancel_queued))
    break;
  ...
  case 3340: /* module 13 call 12 */
    CHECK_ERROR(
        _readMethod_democracy_undelegate(c, &method->democracy_undelegate))
    break;
  case 3341: /* module 13 call 13 */
    CHECK_ERROR(_readMethod_democracy_clear_public_proposals(
        c, &method->democracy_clear_public_proposals))
    break;
  case 3342: /* module 13 call 14 */
    CHECK_ERROR(_readMethod_democracy_note_preimage(
        c, &method->democracy_note_preimage))
    break;
  case 3343: /* module 13 call 15 */
    CHECK_ERROR(_readMethod_democracy_note_preimage_operational(
        c, &method->democracy_note_preimage_operational))
    break;
  case 3344: /* module 13 call 16 */
    CHECK_ERROR(_readMethod_democracy_note_imminent_preimage(
        c, &method->democracy_note_imminent_preimage))
    break;
  case 3345: /* module 13 call 17 */
    CHECK_ERROR(_readMethod_democracy_note_imminent_preimage_operational(
        c, &method->democracy_note_imminent_preimage_operational))
    break;
  case 3346: /* module 13 call 18 */
    CHECK_ERROR(_readMethod_democracy_reap_preimage(
        c, &method->democracy_reap_preimage))
    break;
  ...
  case 3348: /* module 13 call 20 */
    CHECK_ERROR(
        _readMethod_democracy_remove_vote(c, &method->democracy_remove_vote))
    break;
  case 3349: /* module 13 call 21 */
    CHECK_ERROR(_readMethod_democracy_remove_other_vote(
        c, &method->democracy_remove_other_vote))
    break;
  case 3350: /* module 13 call 22 */
    CHECK_ERROR(_readMethod_democracy_enact_proposal(
        c, &method->democracy_enact_proposal))
    break;
  case 3351: /* module 13 call 23 */
    CHECK_ERROR(
        _readMethod_democracy_blacklist(c, &method->democracy_blacklist))
    break;
  case 3352: /* module 13 call 24 */
    CHECK_ERROR(_readMethod_democracy_cancel_proposal(
        c, &method->democracy_cancel_proposal))
    break;
  case 3584: /* module 14 call 0 */
    CHECK_ERROR(
        _readMethod_council_set_members(c, &method->council_set_members))
    break;
  ...
  case 3589: /* module 14 call 5 */
    CHECK_ERROR(_readMethod_council_disapprove_proposal(
        c, &method->council_disapprove_proposal))
    break;
  case 3840: /* module 15 call 0 */
    CHECK_ERROR(_readMethod_technicalcommittee_set_members(
        c, &method->technicalcommittee_set_members))
    break;
  ...
  case 3845: /* module 15 call 5 */
    CHECK_ERROR(_readMethod_technicalcommittee_disapprove_proposal(
        c, &method->technicalcommittee_disapprove_proposal))
    break;
  case 4096: /* module 16 call 0 */
    CHECK_ERROR(
        _readMethod_electionsphragmen_vote(c, &method->electionsphragmen_vote))
    break;
  case 4097: /* module 16 call 1 */
    CHECK_ERROR(_readMethod_electionsphragmen_remove_voter(
        c, &method->electionsphragmen_remove_voter))
    break;
  case 4098: /* module 16 call 2 */
    CHECK_ERROR(_readMethod_electionsphragmen_report_defunct_voter(
        c, &method->electionsphragmen_report_defunct_voter))
    break;
  case 4099: /* module 16 call 3 */
    CHECK_ERROR(_readMethod_electionsphragmen_submit_candidacy(
        c, &method->electionsphragmen_submit_candidacy))
    break;
  case 4100: /* module 16 call 4 */
    CHECK_ERROR(_readMethod_electionsphragmen_renounce_candidacy(
        c, &method->electionsphragmen_renounce_candidacy))
    break;
  case 4101: /* module 16 call 5 */
    CHECK_ERROR(_readMethod_electionsphragmen_remove_member(
        c, &method->electionsphragmen_remove_member))
    break;
  case 4352: /* module 17 call 0 */
    CHECK_ERROR(_readMethod_technicalmembership_add_member(
        c, &method->technicalmembership_add_member))
    break;
  case 4353: /* module 17 call 1 */
    CHECK_ERROR(_readMethod_technicalmembership_remove_member(
        c, &method->technicalmembership_remove_member))
    break;
  case 4354: /* module 17 call 2 */
    CHECK_ERROR(_readMethod_technicalmembership_swap_member(
        c, &method->technicalmembership_swap_member))
    break;
  case 4355: /* module 17 call 3 */
    CHECK_ERROR(_readMethod_technicalmembership_reset_members(
        c, &method->technicalmembership_reset_members))
    break;
  case 4356: /* module 17 call 4 */
    CHECK_ERROR(_readMethod_technicalmembership_change_key(
        c, &method->technicalmembership_change_key))
    break;
  case 4357: /* module 17 call 5 */
    CHECK_ERROR(_readMethod_technicalmembership_set_prime(
        c, &method->technicalmembership_set_prime))
    break;
  case 4358: /* module 17 call 6 */
    CHECK_ERROR(_readMethod_technicalmembership_clear_prime(
        c, &method->technicalmembership_clear_prime))
    break;
  case 4608: /* module 18 call 0 */
    CHECK_ERROR(
        _readMethod_treasury_propose_spend(c, &method->treasury_propose_spend))
    break;
  case 4609: /* module 18 call 1 */
    CHECK_ERROR(_readMethod_treasury_reject_proposal(
        c, &method->treasury_reject_proposal))
    break;
  case 4610: /* module 18 call 2 */
    CHECK_ERROR(_readMethod_treasury_approve_proposal(
        c, &method->treasury_approve_proposal))
    break;
  case 4611: /* module 18 call 3 */
    CHECK_ERROR(_readMethod_treasury_report_awesome(
        c, &method->treasury_report_awesome))
    break;
  case 4612: /* module 18 call 4 */
    CHECK_ERROR(
        _readMethod_treasury_retract_tip(c, &method->treasury_retract_tip))
    break;
  ...
  case 4616: /* module 18 call 8 */
    CHECK_ERROR(_readMethod_treasury_propose_bounty(
        c, &method->treasury_propose_bounty))
    break;
  case 4617: /* module 18 call 9 */
    CHECK_ERROR(_readMethod_treasury_approve_bounty(
        c, &method->treasury_approve_bounty))
    break;
  case 4618: /* module 18 call 10 */
    CHECK_ERROR(_readMethod_treasury_propose_curator(
        c, &method->treasury_propose_curator))
    break;
  case 4619: /* module 18 call 11 */
    CHECK_ERROR(_readMethod_treasury_unassign_curator(
        c, &method->treasury_unassign_curator))
    break;
  case 4620: /* module 18 call 12 */
    CHECK_ERROR(_readMethod_treasury_accept_curator(
        c, &method->treasury_accept_curator))
    break;
  case 4621: /* module 18 call 13 */
    CHECK_ERROR(
        _readMethod_treasury_award_bounty(c, &method->treasury_award_bounty))
    break;
  case 4622: /* module 18 call 14 */
    CHECK_ERROR(
        _readMethod_treasury_claim_bounty(c, &method->treasury_claim_bounty))
    break;
  case 4623: /* module 18 call 15 */
    CHECK_ERROR(
        _readMethod_treasury_close_bounty(c, &method->treasury_close_bounty))
    break;
  case 4624: /* module 18 call 16 */
    CHECK_ERROR(_readMethod_treasury_extend_bounty_expiry(
        c, &method->treasury_extend_bounty_expiry))
    break;
  ...
  case 4866: /* module 19 call 2 */
    CHECK_ERROR(
        _readMethod_claims_claim_attest(c, &method->claims_claim_attest))
    break;
  ...
  case 6145: /* module 24 call 1 */
    CHECK_ERROR(
        _readMethod_utility_as_derivative(c, &method->utility_as_derivative))
    break;
  ...
  case 6400: /* module 25 call 0 */
    CHECK_ERROR(
        _readMethod_identity_add_registrar(c, &method->identity_add_registrar))
    break;
  case 6401: /* module 25 call 1 */
    CHECK_ERROR(
        _readMethod_identity_set_identity(c, &method->identity_set_identity))
    break;
  case 6402: /* module 25 call 2 */
    CHECK_ERROR(_readMethod_identity_set_subs(c, &method->identity_set_subs))
    break;
  case 6403: /* module 25 call 3 */
    CHECK_ERROR(_readMethod_identity_clear_identity(
        c, &method->identity_clear_identity))
    break;
  case 6404: /* module 25 call 4 */
    CHECK_ERROR(_readMethod_identity_request_judgement(
        c, &method->identity_request_judgement))
    break;
  case 6405: /* module 25 call 5 */
    CHECK_ERROR(_readMethod_identity_cancel_request(
        c, &method->identity_cancel_request))
    break;
  case 6406: /* module 25 call 6 */
    CHECK_ERROR(_readMethod_identity_set_fee(c, &method->identity_set_fee))
    break;
  case 6407: /* module 25 call 7 */
    CHECK_ERROR(_readMethod_identity_set_account_id(
        c, &method->identity_set_account_id))
    break;
  case 6408: /* module 25 call 8 */
    CHECK_ERROR(
        _readMethod_identity_set_fields(c, &method->identity_set_fields))
    break;
  case 6409: /* module 25 call 9 */
    CHECK_ERROR(_readMethod_identity_provide_judgement(
        c, &method->identity_provide_judgement))
    break;
  case 6410: /* module 25 call 10 */
    CHECK_ERROR(
        _readMethod_identity_kill_identity(c, &method->identity_kill_identity))
    break;
  ...
  case 6412: /* module 25 call 12 */
    CHECK_ERROR(
        _readMethod_identity_rename_sub(c, &method->identity_rename_sub))
    break;
  case 6413: /* module 25 call 13 */
    CHECK_ERROR(
        _readMethod_identity_remove_sub(c, &method->identity_remove_sub))
    break;
  ...
  case 6661: /* module 26 call 5 */
    CHECK_ERROR(
        _readMethod_society_defender_vote(c, &method->society_defender_vote))
    break;
  ...
  case 6665: /* module 26 call 9 */
    CHECK_ERROR(_readMethod_society_judge_suspended_member(
        c, &method->society_judge_suspended_member))
    break;
  case 6666: /* module 26 call 10 */
    CHECK_ERROR(_readMethod_society_judge_suspended_candidate(
        c, &method->society_judge_suspended_candidate))
    break;
  case 6667: /* module 26 call 11 */
    CHECK_ERROR(_readMethod_society_set_max_members(
        c, &method->society_set_max_members))
    break;
  case 6912: /* module 27 call 0 */
    CHECK_ERROR(
        _readMethod_recovery_as_recovered(c, &method->recovery_as_recovered))
    break;
  case 6913: /* module 27 call 1 */
    CHECK_ERROR(
        _readMethod_recovery_set_recovered(c, &method->recovery_set_recovered))
    break;
  case 6914: /* module 27 call 2 */
    CHECK_ERROR(_readMethod_recovery_create_recovery(
        c, &method->recovery_create_recovery))
    break;
  case 6915: /* module 27 call 3 */
    CHECK_ERROR(_readMethod_recovery_initiate_recovery(
        c, &method->recovery_initiate_recovery))
    break;
  case 6916: /* module 27 call 4 */
    CHECK_ERROR(_readMethod_recovery_vouch_recovery(
        c, &method->recovery_vouch_recovery))
    break;
  case 6917: /* module 27 call 5 */
    CHECK_ERROR(_readMethod_recovery_claim_recovery(
        c, &method->recovery_claim_recovery))
    break;
  case 6918: /* module 27 call 6 */
    CHECK_ERROR(_readMethod_recovery_close_recovery(
        c, &method->recovery_close_recovery))
    break;
  case 6919: /* module 27 call 7 */
    CHECK_ERROR(_readMethod_recovery_remove_recovery(
        c, &method->recovery_remove_recovery))
    break;
  case 6920: /* module 27 call 8 */
    CHECK_ERROR(_readMethod_recovery_cancel_recovered(
        c, &method->recovery_cancel_recovered))
    break;
  ...
  case 7170: /* module 28 call 2 */
    CHECK_ERROR(_readMethod_vesting_vested_transfer(
        c, &method->vesting_vested_transfer))
    break;
  case 7171: /* module 28 call 3 */
    CHECK_ERROR(_readMethod_vesting_force_vested_transfer(
        c, &method->vesting_force_vested_transfer))
    break;
  ...
  case 7683: /* module 30 call 3 */
    CHECK_ERROR(
        _readMethod_proxy_remove_proxies(c, &method->proxy_remove_proxies))
    break;
  ...
  case 7685: /* module 30 call 5 */
    CHECK_ERROR(
        _readMethod_proxy_kill_anonymous(c, &method->proxy_kill_anonymous))
    break;
  case 7686: /* module 30 call 6 */
    CHECK_ERROR(_readMethod_proxy_announce(c, &method->proxy_announce))
    break;
  case 7687: /* module 30 call 7 */
    CHECK_ERROR(_readMethod_proxy_remove_announcement(
        c, &method->proxy_remove_announcement))
    break;
  case 7688: /* module 30 call 8 */
    CHECK_ERROR(_readMethod_proxy_reject_announcement(
        c, &method->proxy_reject_announcement))
    break;
  case 7689: /* module 30 call 9 */
    CHECK_ERROR(
        _readMethod_proxy_proxy_announced(c, &method->proxy_proxy_announced))
    break;
  case 7936: /* module 31 call 0 */
    CHECK_ERROR(_readMethod_multisig_as_multi_threshold_1(
        c, &method->multisig_as_multi_threshold_1))
    break;
  case 7937: /* module 31 call 1 */
    CHECK_ERROR(_readMethod_multisig_as_multi(c, &method->multisig_as_multi))
    break;
  case 7938: /* module 31 call 2 */
    CHECK_ERROR(_readMethod_multisig_approve_as_multi(
        c, &method->multisig_approve_as_multi))
    break;
  case 7939: /* module 31 call 3 */
    CHECK_ERROR(_readMethod_multisig_cancel_as_multi(
        c, &method->multisig_cancel_as_multi))
    break;
  default:
...
parser_error_t _readMethod(parser_context_t *c, uint8_t moduleIdx,
  ...
  case 1027: /* module 4 call 3 */
    CHECK_ERROR(_readMethod_balances_transfer_keep_alive(
        c, &method->basic.balances_transfer_keep_alive))
    break;
  case 1280: /* module 5 call 0 */
  ...
  case 3328: /* module 13 call 0 */
    CHECK_ERROR(
        _readMethod_democracy_propose(c, &method->basic.democracy_propose))
    break;
  case 3329: /* module 13 call 1 */
    CHECK_ERROR(
        _readMethod_democracy_second(c, &method->basic.democracy_second))
    break;
  case 3330: /* module 13 call 2 */
  ...
  case 3331: /* module 13 call 3 */
    CHECK_ERROR(_readMethod_democracy_emergency_cancel(
        c, &method->basic.democracy_emergency_cancel))
    break;
  case 3332: /* module 13 call 4 */
    CHECK_ERROR(_readMethod_democracy_external_propose(
        c, &method->basic.democracy_external_propose))
    break;
  case 3333: /* module 13 call 5 */
    CHECK_ERROR(_readMethod_democracy_external_propose_majority(
        c, &method->basic.democracy_external_propose_majority))
    break;
  case 3334: /* module 13 call 6 */
    CHECK_ERROR(_readMethod_democracy_external_propose_default(
        c, &method->basic.democracy_external_propose_default))
    break;
  case 3335: /* module 13 call 7 */
    CHECK_ERROR(_readMethod_democracy_fast_track(
        c, &method->basic.democracy_fast_track))
    break;
  case 3336: /* module 13 call 8 */
    CHECK_ERROR(_readMethod_democracy_veto_external(
        c, &method->basic.democracy_veto_external))
    break;
  case 3337: /* module 13 call 9 */
    CHECK_ERROR(_readMethod_democracy_cancel_referendum(
        c, &method->basic.democracy_cancel_referendum))
    break;
  case 3338: /* module 13 call 10 */
    CHECK_ERROR(_readMethod_democracy_cancel_queued(
        c, &method->basic.democracy_cancel_queued))
    break;
  case 3339: /* module 13 call 11 */
    CHECK_ERROR(
        _readMethod_democracy_delegate(c, &method->basic.democracy_delegate))
    break;
  case 3340: /* module 13 call 12 */
    CHECK_ERROR(_readMethod_democracy_undelegate(
        c, &method->basic.democracy_undelegate))
    break;
  case 3341: /* module 13 call 13 */
    CHECK_ERROR(_readMethod_democracy_clear_public_proposals(
        c, &method->basic.democracy_clear_public_proposals))
    break;
  case 3342: /* module 13 call 14 */
    CHECK_ERROR(_readMethod_democracy_note_preimage(
        c, &method->basic.democracy_note_preimage))
    break;
  case 3343: /* module 13 call 15 */
    CHECK_ERROR(_readMethod_democracy_note_preimage_operational(
        c, &method->basic.democracy_note_preimage_operational))
    break;
  case 3344: /* module 13 call 16 */
    CHECK_ERROR(_readMethod_democracy_note_imminent_preimage(
        c, &method->basic.democracy_note_imminent_preimage))
    break;
  case 3345: /* module 13 call 17 */
    CHECK_ERROR(_readMethod_democracy_note_imminent_preimage_operational(
        c, &method->basic.democracy_note_imminent_preimage_operational))
    break;
  case 3346: /* module 13 call 18 */
    CHECK_ERROR(_readMethod_democracy_reap_preimage(
        c, &method->basic.democracy_reap_preimage))
    break;
  case 3347: /* module 13 call 19 */
    CHECK_ERROR(
        _readMethod_democracy_unlock(c, &method->basic.democracy_unlock))
    break;
  case 3348: /* module 13 call 20 */
    CHECK_ERROR(_readMethod_democracy_remove_vote(
        c, &method->basic.democracy_remove_vote))
    break;
  case 3349: /* module 13 call 21 */
    CHECK_ERROR(_readMethod_democracy_remove_other_vote(
        c, &method->basic.democracy_remove_other_vote))
    break;
  case 3350: /* module 13 call 22 */
    CHECK_ERROR(_readMethod_democracy_enact_proposal(
        c, &method->basic.democracy_enact_proposal))
    break;
  case 3351: /* module 13 call 23 */
    CHECK_ERROR(
        _readMethod_democracy_blacklist(c, &method->basic.democracy_blacklist))
    break;
  case 3352: /* module 13 call 24 */
    CHECK_ERROR(_readMethod_democracy_cancel_proposal(
        c, &method->basic.democracy_cancel_proposal))
    break;
  case 3584: /* module 14 call 0 */
    CHECK_ERROR(
        _readMethod_council_set_members(c, &method->basic.council_set_members))
    break;
  ...
  case 3589: /* module 14 call 5 */
    CHECK_ERROR(_readMethod_council_disapprove_proposal(
        c, &method->basic.council_disapprove_proposal))
    break;
  case 3840: /* module 15 call 0 */
    CHECK_ERROR(_readMethod_technicalcommittee_set_members(
        c, &method->basic.technicalcommittee_set_members))
    break;
  case 3841: /* module 15 call 1 */
    CHECK_ERROR(_readMethod_technicalcommittee_execute(
        c, &method->nested.technicalcommittee_execute))
    break;
  case 3842: /* module 15 call 2 */
    CHECK_ERROR(_readMethod_technicalcommittee_propose(
        c, &method->nested.technicalcommittee_propose))
    break;
  case 3843: /* module 15 call 3 */
    CHECK_ERROR(_readMethod_technicalcommittee_vote(
  ...
  case 3845: /* module 15 call 5 */
    CHECK_ERROR(_readMethod_technicalcommittee_disapprove_proposal(
        c, &method->basic.technicalcommittee_disapprove_proposal))
    break;
  case 4096: /* module 16 call 0 */
    CHECK_ERROR(_readMethod_electionsphragmen_vote(
        c, &method->basic.electionsphragmen_vote))
    break;
  case 4097: /* module 16 call 1 */
    CHECK_ERROR(_readMethod_electionsphragmen_remove_voter(
        c, &method->basic.electionsphragmen_remove_voter))
    break;
  case 4098: /* module 16 call 2 */
    CHECK_ERROR(_readMethod_electionsphragmen_report_defunct_voter(
        c, &method->basic.electionsphragmen_report_defunct_voter))
    break;
  case 4099: /* module 16 call 3 */
    CHECK_ERROR(_readMethod_electionsphragmen_submit_candidacy(
        c, &method->basic.electionsphragmen_submit_candidacy))
    break;
  case 4100: /* module 16 call 4 */
    CHECK_ERROR(_readMethod_electionsphragmen_renounce_candidacy(
        c, &method->basic.electionsphragmen_renounce_candidacy))
    break;
  case 4101: /* module 16 call 5 */
    CHECK_ERROR(_readMethod_electionsphragmen_remove_member(
        c, &method->basic.electionsphragmen_remove_member))
    break;
  case 4352: /* module 17 call 0 */
    CHECK_ERROR(_readMethod_technicalmembership_add_member(
        c, &method->basic.technicalmembership_add_member))
    break;
  case 4353: /* module 17 call 1 */
    CHECK_ERROR(_readMethod_technicalmembership_remove_member(
        c, &method->basic.technicalmembership_remove_member))
    break;
  case 4354: /* module 17 call 2 */
    CHECK_ERROR(_readMethod_technicalmembership_swap_member(
        c, &method->basic.technicalmembership_swap_member))
    break;
  case 4355: /* module 17 call 3 */
    CHECK_ERROR(_readMethod_technicalmembership_reset_members(
        c, &method->basic.technicalmembership_reset_members))
    break;
  case 4356: /* module 17 call 4 */
    CHECK_ERROR(_readMethod_technicalmembership_change_key(
        c, &method->basic.technicalmembership_change_key))
    break;
  case 4357: /* module 17 call 5 */
    CHECK_ERROR(_readMethod_technicalmembership_set_prime(
        c, &method->basic.technicalmembership_set_prime))
    break;
  case 4358: /* module 17 call 6 */
    CHECK_ERROR(_readMethod_technicalmembership_clear_prime(
        c, &method->basic.technicalmembership_clear_prime))
    break;
  case 4608: /* module 18 call 0 */
    CHECK_ERROR(_readMethod_treasury_propose_spend(
        c, &method->basic.treasury_propose_spend))
    break;
  case 4609: /* module 18 call 1 */
    CHECK_ERROR(_readMethod_treasury_reject_proposal(
        c, &method->basic.treasury_reject_proposal))
    break;
  case 4610: /* module 18 call 2 */
    CHECK_ERROR(_readMethod_treasury_approve_proposal(
        c, &method->basic.treasury_approve_proposal))
    break;
  case 4611: /* module 18 call 3 */
    CHECK_ERROR(_readMethod_treasury_report_awesome(
        c, &method->basic.treasury_report_awesome))
    break;
  case 4612: /* module 18 call 4 */
    CHECK_ERROR(_readMethod_treasury_retract_tip(
        c, &method->basic.treasury_retract_tip))
    break;
  case 4613: /* module 18 call 5 */
    CHECK_ERROR(
        _readMethod_treasury_tip_new(c, &method->basic.treasury_tip_new))
    break;
  case 4614: /* module 18 call 6 */
  ...
  case 4615: /* module 18 call 7 */
    CHECK_ERROR(
        _readMethod_treasury_close_tip(c, &method->basic.treasury_close_tip))
    break;
  case 4616: /* module 18 call 8 */
    CHECK_ERROR(_readMethod_treasury_propose_bounty(
        c, &method->basic.treasury_propose_bounty))
    break;
  case 4617: /* module 18 call 9 */
    CHECK_ERROR(_readMethod_treasury_approve_bounty(
        c, &method->basic.treasury_approve_bounty))
    break;
  case 4618: /* module 18 call 10 */
    CHECK_ERROR(_readMethod_treasury_propose_curator(
        c, &method->basic.treasury_propose_curator))
    break;
  case 4619: /* module 18 call 11 */
    CHECK_ERROR(_readMethod_treasury_unassign_curator(
        c, &method->basic.treasury_unassign_curator))
    break;
  case 4620: /* module 18 call 12 */
    CHECK_ERROR(_readMethod_treasury_accept_curator(
        c, &method->basic.treasury_accept_curator))
    break;
  case 4621: /* module 18 call 13 */
    CHECK_ERROR(_readMethod_treasury_award_bounty(
        c, &method->basic.treasury_award_bounty))
    break;
  case 4622: /* module 18 call 14 */
    CHECK_ERROR(_readMethod_treasury_claim_bounty(
        c, &method->basic.treasury_claim_bounty))
    break;
  case 4623: /* module 18 call 15 */
    CHECK_ERROR(_readMethod_treasury_close_bounty(
        c, &method->basic.treasury_close_bounty))
    break;
  case 4624: /* module 18 call 16 */
    CHECK_ERROR(_readMethod_treasury_extend_bounty_expiry(
        c, &method->basic.treasury_extend_bounty_expiry))
    break;
  case 4864: /* module 19 call 0 */
  ...
  case 4865: /* module 19 call 1 */
    CHECK_ERROR(
        _readMethod_claims_mint_claim(c, &method->basic.claims_mint_claim))
    break;
  case 4866: /* module 19 call 2 */
    CHECK_ERROR(
        _readMethod_claims_claim_attest(c, &method->basic.claims_claim_attest))
    break;
  case 4867: /* module 19 call 3 */
  ...
  case 4868: /* module 19 call 4 */
    CHECK_ERROR(
        _readMethod_claims_move_claim(c, &method->basic.claims_move_claim))
    break;
  case 6144: /* module 24 call 0 */
    CHECK_ERROR(_readMethod_utility_batch(c, &method->basic.utility_batch))
    break;
  case 6145: /* module 24 call 1 */
    CHECK_ERROR(_readMethod_utility_as_derivative(
        c, &method->basic.utility_as_derivative))
    break;
  case 6146: /* module 24 call 2 */
    CHECK_ERROR(
        _readMethod_utility_batch_all(c, &method->basic.utility_batch_all))
    break;
  case 6400: /* module 25 call 0 */
    CHECK_ERROR(_readMethod_identity_add_registrar(
        c, &method->basic.identity_add_registrar))
    break;
  case 6401: /* module 25 call 1 */
    CHECK_ERROR(_readMethod_identity_set_identity(
        c, &method->basic.identity_set_identity))
    break;
  case 6402: /* module 25 call 2 */
    CHECK_ERROR(
        _readMethod_identity_set_subs(c, &method->basic.identity_set_subs))
    break;
  case 6403: /* module 25 call 3 */
    CHECK_ERROR(_readMethod_identity_clear_identity(
        c, &method->basic.identity_clear_identity))
    break;
  case 6404: /* module 25 call 4 */
    CHECK_ERROR(_readMethod_identity_request_judgement(
        c, &method->basic.identity_request_judgement))
    break;
  case 6405: /* module 25 call 5 */
    CHECK_ERROR(_readMethod_identity_cancel_request(
        c, &method->basic.identity_cancel_request))
    break;
  case 6406: /* module 25 call 6 */
    CHECK_ERROR(
        _readMethod_identity_set_fee(c, &method->basic.identity_set_fee))
    break;
  case 6407: /* module 25 call 7 */
    CHECK_ERROR(_readMethod_identity_set_account_id(
        c, &method->basic.identity_set_account_id))
    break;
  case 6408: /* module 25 call 8 */
    CHECK_ERROR(
        _readMethod_identity_set_fields(c, &method->basic.identity_set_fields))
    break;
  case 6409: /* module 25 call 9 */
    CHECK_ERROR(_readMethod_identity_provide_judgement(
        c, &method->basic.identity_provide_judgement))
    break;
  case 6410: /* module 25 call 10 */
    CHECK_ERROR(_readMethod_identity_kill_identity(
        c, &method->basic.identity_kill_identity))
    break;
  case 6411: /* module 25 call 11 */
    CHECK_ERROR(
        _readMethod_identity_add_sub(c, &method->basic.identity_add_sub))
    break;
  case 6412: /* module 25 call 12 */
    CHECK_ERROR(
        _readMethod_identity_rename_sub(c, &method->basic.identity_rename_sub))
    break;
  case 6413: /* module 25 call 13 */
    CHECK_ERROR(
        _readMethod_identity_remove_sub(c, &method->basic.identity_remove_sub))
    break;
  case 6414: /* module 25 call 14 */
    CHECK_ERROR(
        _readMethod_identity_quit_sub(c, &method->basic.identity_quit_sub))
    break;
  case 6656: /* module 26 call 0 */
  ...
  case 6660: /* module 26 call 4 */
    ...
    break;
  case 6661: /* module 26 call 5 */
    CHECK_ERROR(_readMethod_society_defender_vote(
        c, &method->basic.society_defender_vote))
    break;
  case 6662: /* module 26 call 6 */
  ...
  case 6665: /* module 26 call 9 */
    CHECK_ERROR(_readMethod_society_judge_suspended_member(
        c, &method->basic.society_judge_suspended_member))
    break;
  case 6666: /* module 26 call 10 */
    CHECK_ERROR(_readMethod_society_judge_suspended_candidate(
        c, &method->basic.society_judge_suspended_candidate))
    break;
  case 6667: /* module 26 call 11 */
    CHECK_ERROR(_readMethod_society_set_max_members(
        c, &method->basic.society_set_max_members))
    break;
  case 6912: /* module 27 call 0 */
    CHECK_ERROR(_readMethod_recovery_as_recovered(
        c, &method->basic.recovery_as_recovered))
    break;
  case 6913: /* module 27 call 1 */
    CHECK_ERROR(_readMethod_recovery_set_recovered(
        c, &method->basic.recovery_set_recovered))
    break;
  case 6914: /* module 27 call 2 */
    CHECK_ERROR(_readMethod_recovery_create_recovery(
        c, &method->basic.recovery_create_recovery))
    break;
  case 6915: /* module 27 call 3 */
    CHECK_ERROR(_readMethod_recovery_initiate_recovery(
        c, &method->basic.recovery_initiate_recovery))
    break;
  case 6916: /* module 27 call 4 */
    CHECK_ERROR(_readMethod_recovery_vouch_recovery(
        c, &method->basic.recovery_vouch_recovery))
    break;
  case 6917: /* module 27 call 5 */
    CHECK_ERROR(_readMethod_recovery_claim_recovery(
        c, &method->basic.recovery_claim_recovery))
    break;
  case 6918: /* module 27 call 6 */
    CHECK_ERROR(_readMethod_recovery_close_recovery(
        c, &method->basic.recovery_close_recovery))
    break;
  case 6919: /* module 27 call 7 */
    CHECK_ERROR(_readMethod_recovery_remove_recovery(
        c, &method->basic.recovery_remove_recovery))
    break;
  case 6920: /* module 27 call 8 */
    CHECK_ERROR(_readMethod_recovery_cancel_recovered(
        c, &method->basic.recovery_cancel_recovered))
    break;
  case 7168: /* module 28 call 0 */
  ...
  case 7169: /* module 28 call 1 */
    CHECK_ERROR(
        _readMethod_vesting_vest_other(c, &method->basic.vesting_vest_other))
    break;
  case 7170: /* module 28 call 2 */
    CHECK_ERROR(_readMethod_vesting_vested_transfer(
        c, &method->basic.vesting_vested_transfer))
    break;
  case 7171: /* module 28 call 3 */
    CHECK_ERROR(_readMethod_vesting_force_vested_transfer(
        c, &method->basic.vesting_force_vested_transfer))
    break;
  case 7424: /* module 29 call 0 */
    CHECK_ERROR(
  ...
  case 7682: /* module 30 call 2 */
    CHECK_ERROR(
        _readMethod_proxy_remove_proxy(c, &method->basic.proxy_remove_proxy))
    break;
  case 7683: /* module 30 call 3 */
    CHECK_ERROR(_readMethod_proxy_remove_proxies(
        c, &method->basic.proxy_remove_proxies))
    break;
  case 7684: /* module 30 call 4 */
    CHECK_ERROR(_readMethod_proxy_anonymous(c, &method->basic.proxy_anonymous))
    break;
  case 7685: /* module 30 call 5 */
    CHECK_ERROR(_readMethod_proxy_kill_anonymous(
        c, &method->basic.proxy_kill_anonymous))
    break;
  case 7686: /* module 30 call 6 */
  ...
  case 7687: /* module 30 call 7 */
    CHECK_ERROR(_readMethod_proxy_remove_announcement(
        c, &method->basic.proxy_remove_announcement))
    break;
  case 7688: /* module 30 call 8 */
    CHECK_ERROR(_readMethod_proxy_reject_announcement(
        c, &method->basic.proxy_reject_announcement))
    break;
  case 7689: /* module 30 call 9 */
    CHECK_ERROR(_readMethod_proxy_proxy_announced(
        c, &method->basic.proxy_proxy_announced))
    break;
  case 7936: /* module 31 call 0 */
    CHECK_ERROR(_readMethod_multisig_as_multi_threshold_1(
        c, &method->basic.multisig_as_multi_threshold_1))
    break;
  case 7937: /* module 31 call 1 */
    CHECK_ERROR(
        _readMethod_multisig_as_multi(c, &method->basic.multisig_as_multi))
    break;
  case 7938: /* module 31 call 2 */
    CHECK_ERROR(_readMethod_multisig_approve_as_multi(
        c, &method->basic.multisig_approve_as_multi))
    break;
  case 7939: /* module 31 call 3 */
    CHECK_ERROR(_readMethod_multisig_cancel_as_multi(
        c, &method->basic.multisig_cancel_as_multi))
    break;
  default:
    return parser_unexpected_callIndex;
  }
...
parser_error_t _getMethod_ItemValue(pd_Method_t *m, uint8_t moduleIdx,
  ...
  case 1027: /* module 4 call 3 */
    ...
    case 0: /* balances_transfer_keep_alive - dest */;
      return _toStringLookupSource(&m->basic.balances_transfer_keep_alive.dest,
                                   outValue, outValueLen, pageIdx, pageCount);
    case 1: /* balances_transfer_keep_alive - value */;
      return _toStringCompactBalance(
          &m->basic.balances_transfer_keep_alive.value, outValue, outValueLen,
          pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  ...
  case 1550: /* module 6 call 14 */
    ...
    case 0: /* staking_set_invulnerables - invulnerables */;
      return _toStringVecAccountId(
          &m->basic.staking_set_invulnerables.invulnerables, outValue,
          outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  ...
  case 3328: /* module 13 call 0 */
    ...
    case 0: /* democracy_propose - proposal_hash */;
      return _toStringHash(&m->basic.democracy_propose.proposal_hash, outValue,
                           outValueLen, pageIdx, pageCount);
    case 1: /* democracy_propose - value */;
      return _toStringCompactBalanceOf(&m->basic.democracy_propose.value,
                                       outValue, outValueLen, pageIdx,
                                       pageCount);
    default:
      return parser_no_data;
  ...
  case 3329: /* module 13 call 1 */
    ...
    case 0: /* democracy_second - proposal */;
      return _toStringCompactPropIndex(&m->basic.democracy_second.proposal,
                                       outValue, outValueLen, pageIdx,
                                       pageCount);
    case 1: /* democracy_second - seconds_upper_bound */;
      return _toStringCompactu32(&m->basic.democracy_second.seconds_upper_bound,
                                 outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3330: /* module 13 call 2 */
    ...
    case 0: /* democracy_vote - ref_index */;
      return _toStringCompactReferendumIndex(&m->basic.democracy_vote.ref_index,
                                             outValue, outValueLen, pageIdx,
                                             pageCount);
    case 1: /* democracy_vote - vote */;
      return _toStringAccountVote(&m->basic.democracy_vote.vote, outValue,
                                  outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3331: /* module 13 call 3 */
    ...
    case 0: /* democracy_emergency_cancel - ref_index */;
      return _toStringReferendumIndex(
          &m->basic.democracy_emergency_cancel.ref_index, outValue, outValueLen,
          pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3332: /* module 13 call 4 */
    ...
    case 0: /* democracy_external_propose - proposal_hash */;
      return _toStringHash(&m->basic.democracy_external_propose.proposal_hash,
                           outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3333: /* module 13 call 5 */
    ...
    case 0: /* democracy_external_propose_majority - proposal_hash */;
      return _toStringHash(
          &m->basic.democracy_external_propose_majority.proposal_hash, outValue,
          outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3334: /* module 13 call 6 */
    ...
    case 0: /* democracy_external_propose_default - proposal_hash */;
      return _toStringHash(
          &m->basic.democracy_external_propose_default.proposal_hash, outValue,
          outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3335: /* module 13 call 7 */
    ...
    case 0: /* democracy_fast_track - proposal_hash */;
      return _toStringHash(&m->basic.democracy_fast_track.proposal_hash,
                           outValue, outValueLen, pageIdx, pageCount);
    case 1: /* democracy_fast_track - voting_period */;
      return _toStringBlockNumber(&m->basic.democracy_fast_track.voting_period,
                                  outValue, outValueLen, pageIdx, pageCount);
    case 2: /* democracy_fast_track - delay */;
      return _toStringBlockNumber(&m->basic.democracy_fast_track.delay,
                                  outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3336: /* module 13 call 8 */
    ...
    case 0: /* democracy_veto_external - proposal_hash */;
      return _toStringHash(&m->basic.democracy_veto_external.proposal_hash,
                           outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3337: /* module 13 call 9 */
    ...
    case 0: /* democracy_cancel_referendum - ref_index */;
      return _toStringCompactReferendumIndex(
          &m->basic.democracy_cancel_referendum.ref_index, outValue,
          outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3338: /* module 13 call 10 */
    ...
    case 0: /* democracy_cancel_queued - which */;
      return _toStringReferendumIndex(&m->basic.democracy_cancel_queued.which,
                                      outValue, outValueLen, pageIdx,
                                      pageCount);
    default:
      return parser_no_data;
  ...
  case 3339: /* module 13 call 11 */
    ...
    case 0: /* democracy_delegate - to */;
      return _toStringAccountId(&m->basic.democracy_delegate.to, outValue,
                                outValueLen, pageIdx, pageCount);
    case 1: /* democracy_delegate - conviction */;
      return _toStringConviction(&m->basic.democracy_delegate.conviction,
                                 outValue, outValueLen, pageIdx, pageCount);
    case 2: /* democracy_delegate - balance */;
      return _toStringBalanceOf(&m->basic.democracy_delegate.balance, outValue,
                                outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  ...
  case 3342: /* module 13 call 14 */
    ...
    case 0: /* democracy_note_preimage - encoded_proposal */;
      return _toStringBytes(&m->basic.democracy_note_preimage.encoded_proposal,
                            outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  ...
  case 3344: /* module 13 call 16 */
    ...
    case 0: /* democracy_note_imminent_preimage - encoded_proposal */;
      return _toStringBytes(
          &m->basic.democracy_note_imminent_preimage.encoded_proposal, outValue,
          outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3345: /* module 13 call 17 */
    ...
    case 0: /* democracy_note_imminent_preimage_operational - encoded_proposal
        ...
        ;
      return _toStringBytes(
          &m->basic.democracy_note_imminent_preimage_operational
               .encoded_proposal,
          outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
  ...
  case 3346: /* module 13 call 18 */
    ...
    case 0: /* democracy_reap_preimage - proposal_hash */;
      return _toStringHash(&m->basic.democracy_reap_preimage.proposal_hash,
                           outValue, outValueLen, pageIdx, pageCount);
    case 1: /* democracy_reap_preimage - proposal_len_upper_bound */;
      return _toStringCompactu32(
          &m->basic.democracy_reap_preimage.proposal_len_upper_bound, outValue,
          outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3347: /* module 13 call 19 */
    ...
    case 0: /* democracy_unlock - target */;
      return _toStringAccountId(&m->basic.democracy_unlock.target, outValue,
                                outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3348: /* module 13 call 20 */
    ...
    case 0: /* democracy_remove_vote - index */;
      return _toStringReferendumIndex(&m->basic.democracy_remove_vote.index,
                                      outValue, outValueLen, pageIdx,
                                      pageCount);
    default:
      return parser_no_data;
  ...
  case 3349: /* module 13 call 21 */
    ...
    case 0: /* democracy_remove_other_vote - target */;
      return _toStringAccountId(&m->basic.democracy_remove_other_vote.target,
                                outValue, outValueLen, pageIdx, pageCount);
    case 1: /* democracy_remove_other_vote - index */;
      return _toStringReferendumIndex(
          &m->basic.democracy_remove_other_vote.index, outValue, outValueLen,
          pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3350: /* module 13 call 22 */
    ...
    case 0: /* democracy_enact_proposal - proposal_hash */;
      return _toStringHash(&m->basic.democracy_enact_proposal.proposal_hash,
                           outValue, outValueLen, pageIdx, pageCount);
    case 1: /* democracy_enact_proposal - index */;
      return _toStringReferendumIndex(&m->basic.democracy_enact_proposal.index,
                                      outValue, outValueLen, pageIdx,
                                      pageCount);
    default:
      return parser_no_data;
  ...
  case 3351: /* module 13 call 23 */
    ...
    case 0: /* democracy_blacklist - proposal_hash */;
      return _toStringHash(&m->basic.democracy_blacklist.proposal_hash,
                           outValue, outValueLen, pageIdx, pageCount);
    case 1: /* democracy_blacklist - maybe_ref_index */;
      return _toStringOptionReferendumIndex(
          &m->basic.democracy_blacklist.maybe_ref_index, outValue, outValueLen,
          pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3352: /* module 13 call 24 */
    ...
    case 0: /* democracy_cancel_proposal - prop_index */;
      return _toStringCompactPropIndex(
          &m->basic.democracy_cancel_proposal.prop_index, outValue, outValueLen,
          pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3584: /* module 14 call 0 */
    ...
    case 0: /* council_set_members - new_members */;
      return _toStringVecAccountId(&m->basic.council_set_members.new_members,
                                   outValue, outValueLen, pageIdx, pageCount);
    case 1: /* council_set_members - prime */;
      return _toStringOptionAccountId(&m->basic.council_set_members.prime,
                                      outValue, outValueLen, pageIdx,
                                      pageCount);
    case 2: /* council_set_members - old_count */;
      return _toStringMemberCount(&m->basic.council_set_members.old_count,
                                  outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3585: /* module 14 call 1 */
    ...
    case 0: /* council_execute - proposal */;
      return _toStringProposal(&m->nested.council_execute.proposal, outValue,
                               outValueLen, pageIdx, pageCount);
    case 1: /* council_execute - length_bound */;
      return _toStringCompactu32(&m->nested.council_execute.length_bound,
                                 outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3586: /* module 14 call 2 */
    ...
    case 0: /* council_propose - threshold */;
      return _toStringCompactMemberCount(&m->nested.council_propose.threshold,
                                         outValue, outValueLen, pageIdx,
                                         pageCount);
    case 1: /* council_propose - proposal */;
      return _toStringProposal(&m->nested.council_propose.proposal, outValue,
                               outValueLen, pageIdx, pageCount);
    case 2: /* council_propose - length_bound */;
      return _toStringCompactu32(&m->nested.council_propose.length_bound,
                                 outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3587: /* module 14 call 3 */
    ...
    case 0: /* council_vote - proposal */;
      return _toStringHash(&m->basic.council_vote.proposal, outValue,
                           outValueLen, pageIdx, pageCount);
    case 1: /* council_vote - index */;
      return _toStringCompactProposalIndex(&m->basic.council_vote.index,
                                           outValue, outValueLen, pageIdx,
                                           pageCount);
    case 2: /* council_vote - approve */;
      return _toStringbool(&m->basic.council_vote.approve, outValue,
                           outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3588: /* module 14 call 4 */
    ...
    case 0: /* council_close - proposal_hash */;
      return _toStringHash(&m->basic.council_close.proposal_hash, outValue,
                           outValueLen, pageIdx, pageCount);
    case 1: /* council_close - index */;
      return _toStringCompactProposalIndex(&m->basic.council_close.index,
                                           outValue, outValueLen, pageIdx,
                                           pageCount);
    case 2: /* council_close - proposal_weight_bound */;
      return _toStringCompactWeight(
          &m->basic.council_close.proposal_weight_bound, outValue, outValueLen,
          pageIdx, pageCount);
    case 3: /* council_close - length_bound */;
      return _toStringCompactu32(&m->basic.council_close.length_bound, outValue,
                                 outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3589: /* module 14 call 5 */
    ...
    case 0: /* council_disapprove_proposal - proposal_hash */;
      return _toStringHash(&m->basic.council_disapprove_proposal.proposal_hash,
                           outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3840: /* module 15 call 0 */
    ...
    case 0: /* technicalcommittee_set_members - new_members */;
      return _toStringVecAccountId(
          &m->basic.technicalcommittee_set_members.new_members, outValue,
          outValueLen, pageIdx, pageCount);
    case 1: /* technicalcommittee_set_members - prime */;
      return _toStringOptionAccountId(
          &m->basic.technicalcommittee_set_members.prime, outValue, outValueLen,
          pageIdx, pageCount);
    case 2: /* technicalcommittee_set_members - old_count */;
      return _toStringMemberCount(
          &m->basic.technicalcommittee_set_members.old_count, outValue,
          outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3841: /* module 15 call 1 */
    ...
    case 0: /* technicalcommittee_execute - proposal */;
      return _toStringProposal(&m->nested.technicalcommittee_execute.proposal,
                               outValue, outValueLen, pageIdx, pageCount);
    case 1: /* technicalcommittee_execute - length_bound */;
      return _toStringCompactu32(
          &m->nested.technicalcommittee_execute.length_bound, outValue,
          outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3842: /* module 15 call 2 */
    ...
    case 0: /* technicalcommittee_propose - threshold */;
      return _toStringCompactMemberCount(
          &m->nested.technicalcommittee_propose.threshold, outValue,
          outValueLen, pageIdx, pageCount);
    case 1: /* technicalcommittee_propose - proposal */;
      return _toStringProposal(&m->nested.technicalcommittee_propose.proposal,
                               outValue, outValueLen, pageIdx, pageCount);
    case 2: /* technicalcommittee_propose - length_bound */;
      return _toStringCompactu32(
          &m->nested.technicalcommittee_propose.length_bound, outValue,
          outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 3843: /* module 15 call 3 */
    ...
    case 1: /* technicalcommittee_vote - index */;
      return _toStringCompactProposalIndex(
          &m->basic.technicalcommittee_vote.index, outValue, outValueLen,
          pageIdx, pageCount);
  ...
  case 3844: /* module 15 call 4 */
    ...
    case 0: /* technicalcommittee_close - proposal_hash */;
      return _toStringHash(&m->basic.technicalcommittee_close.proposal_hash,
                           outValue, outValueLen, pageIdx, pageCount);
    ...
    case 2: /* technicalcommittee_close - proposal_weight_bound */;
      return _toStringCompactWeight(
          &m->basic.technicalcommittee_close.proposal_weight_bound, outValue,
          outValueLen, pageIdx, pageCount);
    case 3: /* technicalcommittee_close - length_bound */;
      return _toStringCompactu32(
          &m->basic.technicalcommittee_close.length_bound, outValue,
          outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  ...
  case 4096: /* module 16 call 0 */
    ...
    case 0: /* electionsphragmen_vote - votes */;
      return _toStringVecAccountId(&m->basic.electionsphragmen_vote.votes,
                                   outValue, outValueLen, pageIdx, pageCount);
    case 1: /* electionsphragmen_vote - value */;
      return _toStringCompactBalanceOf(&m->basic.electionsphragmen_vote.value,
                                       outValue, outValueLen, pageIdx,
                                       pageCount);
    default:
      return parser_no_data;
  ...
  case 4098: /* module 16 call 2 */
    ...
    case 0: /* electionsphragmen_report_defunct_voter - defunct */;
      return _toStringDefunctVoter(
          &m->basic.electionsphragmen_report_defunct_voter.defunct, outValue,
          outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  ...
  case 4100: /* module 16 call 4 */
    ...
    case 0: /* electionsphragmen_renounce_candidacy - renouncing */;
      return _toStringRenouncing(
          &m->basic.electionsphragmen_renounce_candidacy.renouncing, outValue,
          outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4101: /* module 16 call 5 */
    ...
    case 0: /* electionsphragmen_remove_member - who */;
      return _toStringLookupSource(
          &m->basic.electionsphragmen_remove_member.who, outValue, outValueLen,
          pageIdx, pageCount);
    case 1: /* electionsphragmen_remove_member - has_replacement */;
      return _toStringbool(
          &m->basic.electionsphragmen_remove_member.has_replacement, outValue,
          outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4352: /* module 17 call 0 */
    ...
    case 0: /* technicalmembership_add_member - who */;
      return _toStringAccountId(&m->basic.technicalmembership_add_member.who,
                                outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4353: /* module 17 call 1 */
    ...
    case 0: /* technicalmembership_remove_member - who */;
      return _toStringAccountId(&m->basic.technicalmembership_remove_member.who,
                                outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4354: /* module 17 call 2 */
    ...
    case 0: /* technicalmembership_swap_member - remove */;
      return _toStringAccountId(
          &m->basic.technicalmembership_swap_member.remove, outValue,
          outValueLen, pageIdx, pageCount);
    case 1: /* technicalmembership_swap_member - add */;
      return _toStringAccountId(&m->basic.technicalmembership_swap_member.add,
                                outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4355: /* module 17 call 3 */
    ...
    case 0: /* technicalmembership_reset_members - members */;
      return _toStringVecAccountId(
          &m->basic.technicalmembership_reset_members.members, outValue,
          outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4356: /* module 17 call 4 */
    ...
    case 0: /* technicalmembership_change_key - new_ */;
      return _toStringAccountId(&m->basic.technicalmembership_change_key.new_,
                                outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4357: /* module 17 call 5 */
    ...
    case 0: /* technicalmembership_set_prime - who */;
      return _toStringAccountId(&m->basic.technicalmembership_set_prime.who,
                                outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  ...
  case 4608: /* module 18 call 0 */
    ...
    case 0: /* treasury_propose_spend - value */;
      return _toStringCompactBalanceOf(&m->basic.treasury_propose_spend.value,
                                       outValue, outValueLen, pageIdx,
                                       pageCount);
    case 1: /* treasury_propose_spend - beneficiary */;
      return _toStringLookupSource(&m->basic.treasury_propose_spend.beneficiary,
                                   outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4609: /* module 18 call 1 */
    ...
    case 0: /* treasury_reject_proposal - proposal_id */;
      return _toStringCompactProposalIndex(
          &m->basic.treasury_reject_proposal.proposal_id, outValue, outValueLen,
          pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4610: /* module 18 call 2 */
    ...
    case 0: /* treasury_approve_proposal - proposal_id */;
      return _toStringCompactProposalIndex(
          &m->basic.treasury_approve_proposal.proposal_id, outValue,
          outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4611: /* module 18 call 3 */
    ...
    case 0: /* treasury_report_awesome - reason */;
      return _toStringBytes(&m->basic.treasury_report_awesome.reason, outValue,
                            outValueLen, pageIdx, pageCount);
    case 1: /* treasury_report_awesome - who */;
      return _toStringAccountId(&m->basic.treasury_report_awesome.who, outValue,
                                outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4612: /* module 18 call 4 */
    ...
    case 0: /* treasury_retract_tip - hash */;
      return _toStringHash(&m->basic.treasury_retract_tip.hash, outValue,
                           outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4613: /* module 18 call 5 */
    ...
    case 0: /* treasury_tip_new - reason */;
      return _toStringBytes(&m->basic.treasury_tip_new.reason, outValue,
                            outValueLen, pageIdx, pageCount);
    case 1: /* treasury_tip_new - who */;
      return _toStringAccountId(&m->basic.treasury_tip_new.who, outValue,
                                outValueLen, pageIdx, pageCount);
    case 2: /* treasury_tip_new - tip_value */;
      return _toStringCompactBalanceOf(&m->basic.treasury_tip_new.tip_value,
                                       outValue, outValueLen, pageIdx,
                                       pageCount);
    default:
      return parser_no_data;
  ...
  case 4614: /* module 18 call 6 */
    ...
    case 0: /* treasury_tip - hash */;
      return _toStringHash(&m->basic.treasury_tip.hash, outValue, outValueLen,
                           pageIdx, pageCount);
    case 1: /* treasury_tip - tip_value */;
      return _toStringCompactBalanceOf(&m->basic.treasury_tip.tip_value,
                                       outValue, outValueLen, pageIdx,
                                       pageCount);
    default:
      return parser_no_data;
  ...
  case 4615: /* module 18 call 7 */
    ...
    case 0: /* treasury_close_tip - hash */;
      return _toStringHash(&m->basic.treasury_close_tip.hash, outValue,
                           outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4616: /* module 18 call 8 */
    ...
    case 0: /* treasury_propose_bounty - value */;
      return _toStringCompactBalanceOf(&m->basic.treasury_propose_bounty.value,
                                       outValue, outValueLen, pageIdx,
                                       pageCount);
    case 1: /* treasury_propose_bounty - description */;
      return _toStringBytes(&m->basic.treasury_propose_bounty.description,
                            outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4617: /* module 18 call 9 */
    ...
    case 0: /* treasury_approve_bounty - bounty_id */;
      return _toStringCompactProposalIndex(
          &m->basic.treasury_approve_bounty.bounty_id, outValue, outValueLen,
          pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4618: /* module 18 call 10 */
    ...
    case 0: /* treasury_propose_curator - bounty_id */;
      return _toStringCompactProposalIndex(
          &m->basic.treasury_propose_curator.bounty_id, outValue, outValueLen,
          pageIdx, pageCount);
    case 1: /* treasury_propose_curator - curator */;
      return _toStringLookupSource(&m->basic.treasury_propose_curator.curator,
                                   outValue, outValueLen, pageIdx, pageCount);
    case 2: /* treasury_propose_curator - fee */;
      return _toStringCompactBalanceOf(&m->basic.treasury_propose_curator.fee,
                                       outValue, outValueLen, pageIdx,
                                       pageCount);
    default:
      return parser_no_data;
  ...
  case 4619: /* module 18 call 11 */
    ...
    case 0: /* treasury_unassign_curator - bounty_id */;
      return _toStringCompactProposalIndex(
          &m->basic.treasury_unassign_curator.bounty_id, outValue, outValueLen,
          pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4620: /* module 18 call 12 */
    ...
    case 0: /* treasury_accept_curator - bounty_id */;
      return _toStringCompactProposalIndex(
          &m->basic.treasury_accept_curator.bounty_id, outValue, outValueLen,
          pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4621: /* module 18 call 13 */
    ...
    case 0: /* treasury_award_bounty - bounty_id */;
      return _toStringCompactProposalIndex(
          &m->basic.treasury_award_bounty.bounty_id, outValue, outValueLen,
          pageIdx, pageCount);
    case 1: /* treasury_award_bounty - beneficiary */;
      return _toStringLookupSource(&m->basic.treasury_award_bounty.beneficiary,
                                   outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4622: /* module 18 call 14 */
    ...
    case 0: /* treasury_claim_bounty - bounty_id */;
      return _toStringCompactBountyIndex(
          &m->basic.treasury_claim_bounty.bounty_id, outValue, outValueLen,
          pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4623: /* module 18 call 15 */
    ...
    case 0: /* treasury_close_bounty - bounty_id */;
      return _toStringCompactBountyIndex(
          &m->basic.treasury_close_bounty.bounty_id, outValue, outValueLen,
          pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4624: /* module 18 call 16 */
    ...
    case 0: /* treasury_extend_bounty_expiry - bounty_id */;
      return _toStringCompactBountyIndex(
          &m->basic.treasury_extend_bounty_expiry.bounty_id, outValue,
          outValueLen, pageIdx, pageCount);
    case 1: /* treasury_extend_bounty_expiry - _remark */;
      return _toStringBytes(&m->basic.treasury_extend_bounty_expiry._remark,
                            outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4864: /* module 19 call 0 */
    ...
    case 0: /* claims_claim - dest */;
      return _toStringAccountId(&m->basic.claims_claim.dest, outValue,
                                outValueLen, pageIdx, pageCount);
    case 1: /* claims_claim - ethereum_signature */;
      return _toStringEcdsaSignature(&m->basic.claims_claim.ethereum_signature,
                                     outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4865: /* module 19 call 1 */
    ...
    case 0: /* claims_mint_claim - who */;
      return _toStringEthereumAddress(&m->basic.claims_mint_claim.who, outValue,
                                      outValueLen, pageIdx, pageCount);
    case 1: /* claims_mint_claim - value */;
      return _toStringBalanceOf(&m->basic.claims_mint_claim.value, outValue,
                                outValueLen, pageIdx, pageCount);
    case 2: /* claims_mint_claim - vesting_schedule */;
      return _toStringOptionTupleBalanceOfBalanceOfBlockNumber(
          &m->basic.claims_mint_claim.vesting_schedule, outValue, outValueLen,
          pageIdx, pageCount);
    case 3: /* claims_mint_claim - statement */;
      return _toStringOptionStatementKind(&m->basic.claims_mint_claim.statement,
                                          outValue, outValueLen, pageIdx,
                                          pageCount);
    default:
      return parser_no_data;
  ...
  case 4866: /* module 19 call 2 */
    ...
    case 0: /* claims_claim_attest - dest */;
      return _toStringAccountId(&m->basic.claims_claim_attest.dest, outValue,
                                outValueLen, pageIdx, pageCount);
    case 1: /* claims_claim_attest - ethereum_signature */;
      return _toStringEcdsaSignature(
          &m->basic.claims_claim_attest.ethereum_signature, outValue,
          outValueLen, pageIdx, pageCount);
    case 2: /* claims_claim_attest - statement */;
      return _toStringBytes(&m->basic.claims_claim_attest.statement, outValue,
                            outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4867: /* module 19 call 3 */
    ...
    case 0: /* claims_attest - statement */;
      return _toStringBytes(&m->basic.claims_attest.statement, outValue,
                            outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 4868: /* module 19 call 4 */
    ...
    case 0: /* claims_move_claim - old */;
      return _toStringEthereumAddress(&m->basic.claims_move_claim.old, outValue,
                                      outValueLen, pageIdx, pageCount);
    case 1: /* claims_move_claim - new_ */;
      return _toStringEthereumAddress(&m->basic.claims_move_claim.new_,
                                      outValue, outValueLen, pageIdx,
                                      pageCount);
    case 2: /* claims_move_claim - maybe_preclaim */;
      return _toStringOptionAccountId(
          &m->basic.claims_move_claim.maybe_preclaim, outValue, outValueLen,
          pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  ...
  case 6145: /* module 24 call 1 */
    ...
    case 0: /* utility_as_derivative - index */;
      return _toStringu16(&m->basic.utility_as_derivative.index, outValue,
                          outValueLen, pageIdx, pageCount);
    case 1: /* utility_as_derivative - call */;
      return _toStringCall(&m->basic.utility_as_derivative.call, outValue,
                           outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6146: /* module 24 call 2 */
    ...
    case 0: /* utility_batch_all - calls */;
      return _toStringVecCall(&m->basic.utility_batch_all.calls, outValue,
                              outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6400: /* module 25 call 0 */
    ...
    case 0: /* identity_add_registrar - account */;
      return _toStringAccountId(&m->basic.identity_add_registrar.account,
                                outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6401: /* module 25 call 1 */
    ...
    case 0: /* identity_set_identity - info */;
      return _toStringIdentityInfo(&m->basic.identity_set_identity.info,
                                   outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6402: /* module 25 call 2 */
    ...
    case 0: /* identity_set_subs - subs */;
      return _toStringVecTupleAccountIdData(&m->basic.identity_set_subs.subs,
                                            outValue, outValueLen, pageIdx,
                                            pageCount);
    default:
      return parser_no_data;
  ...
  case 6404: /* module 25 call 4 */
    ...
    case 0: /* identity_request_judgement - reg_index */;
      return _toStringCompactRegistrarIndex(
          &m->basic.identity_request_judgement.reg_index, outValue, outValueLen,
          pageIdx, pageCount);
    case 1: /* identity_request_judgement - max_fee */;
      return _toStringCompactBalanceOf(
          &m->basic.identity_request_judgement.max_fee, outValue, outValueLen,
          pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6405: /* module 25 call 5 */
    ...
    case 0: /* identity_cancel_request - reg_index */;
      return _toStringRegistrarIndex(
          &m->basic.identity_cancel_request.reg_index, outValue, outValueLen,
          pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6406: /* module 25 call 6 */
    ...
    case 0: /* identity_set_fee - index */;
      return _toStringCompactRegistrarIndex(&m->basic.identity_set_fee.index,
                                            outValue, outValueLen, pageIdx,
                                            pageCount);
    case 1: /* identity_set_fee - fee */;
      return _toStringCompactBalanceOf(&m->basic.identity_set_fee.fee, outValue,
                                       outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6407: /* module 25 call 7 */
    ...
    case 0: /* identity_set_account_id - index */;
      return _toStringCompactRegistrarIndex(
          &m->basic.identity_set_account_id.index, outValue, outValueLen,
          pageIdx, pageCount);
    case 1: /* identity_set_account_id - new_ */;
      return _toStringAccountId(&m->basic.identity_set_account_id.new_,
                                outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6408: /* module 25 call 8 */
    ...
    case 0: /* identity_set_fields - index */;
      return _toStringCompactRegistrarIndex(&m->basic.identity_set_fields.index,
                                            outValue, outValueLen, pageIdx,
                                            pageCount);
    case 1: /* identity_set_fields - fields */;
      return _toStringIdentityFields(&m->basic.identity_set_fields.fields,
                                     outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6409: /* module 25 call 9 */
    ...
    case 0: /* identity_provide_judgement - reg_index */;
      return _toStringCompactRegistrarIndex(
          &m->basic.identity_provide_judgement.reg_index, outValue, outValueLen,
          pageIdx, pageCount);
    case 1: /* identity_provide_judgement - target */;
      return _toStringLookupSource(&m->basic.identity_provide_judgement.target,
                                   outValue, outValueLen, pageIdx, pageCount);
    case 2: /* identity_provide_judgement - judgement */;
      return _toStringJudgement(&m->basic.identity_provide_judgement.judgement,
                                outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6410: /* module 25 call 10 */
    ...
    case 0: /* identity_kill_identity - target */;
      return _toStringLookupSource(&m->basic.identity_kill_identity.target,
                                   outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6411: /* module 25 call 11 */
    ...
    case 0: /* identity_add_sub - sub */;
      return _toStringLookupSource(&m->basic.identity_add_sub.sub, outValue,
                                   outValueLen, pageIdx, pageCount);
    case 1: /* identity_add_sub - data */;
      return _toStringData(&m->basic.identity_add_sub.data, outValue,
                           outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6412: /* module 25 call 12 */
    ...
    case 0: /* identity_rename_sub - sub */;
      return _toStringLookupSource(&m->basic.identity_rename_sub.sub, outValue,
                                   outValueLen, pageIdx, pageCount);
    case 1: /* identity_rename_sub - data */;
      return _toStringData(&m->basic.identity_rename_sub.data, outValue,
                           outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6413: /* module 25 call 13 */
    ...
    case 0: /* identity_remove_sub - sub */;
      return _toStringLookupSource(&m->basic.identity_remove_sub.sub, outValue,
                                   outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  ...
  case 6656: /* module 26 call 0 */
    ...
    case 0: /* society_bid - value */;
      return _toStringBalanceOf(&m->basic.society_bid.value, outValue,
                                outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6657: /* module 26 call 1 */
    ...
    case 0: /* society_unbid - pos */;
      return _toStringu32(&m->basic.society_unbid.pos, outValue, outValueLen,
                          pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6658: /* module 26 call 2 */
    ...
    case 0: /* society_vouch - who */;
      return _toStringAccountId(&m->basic.society_vouch.who, outValue,
                                outValueLen, pageIdx, pageCount);
    case 1: /* society_vouch - value */;
      return _toStringBalanceOf(&m->basic.society_vouch.value, outValue,
                                outValueLen, pageIdx, pageCount);
    case 2: /* society_vouch - tip */;
      return _toStringBalanceOf(&m->basic.society_vouch.tip, outValue,
                                outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6659: /* module 26 call 3 */
    ...
    case 0: /* society_unvouch - pos */;
      return _toStringu32(&m->basic.society_unvouch.pos, outValue, outValueLen,
                          pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6660: /* module 26 call 4 */
    ...
    case 0: /* society_vote - candidate */;
      return _toStringLookupSource(&m->basic.society_vote.candidate, outValue,
                                   outValueLen, pageIdx, pageCount);
    case 1: /* society_vote - approve */;
      return _toStringbool(&m->basic.society_vote.approve, outValue,
                           outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6661: /* module 26 call 5 */
    ...
    case 0: /* society_defender_vote - approve */;
      return _toStringbool(&m->basic.society_defender_vote.approve, outValue,
                           outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  ...
  case 6663: /* module 26 call 7 */
    ...
    case 0: /* society_found - founder */;
      return _toStringAccountId(&m->basic.society_found.founder, outValue,
                                outValueLen, pageIdx, pageCount);
    case 1: /* society_found - max_members */;
      return _toStringu32(&m->basic.society_found.max_members, outValue,
                          outValueLen, pageIdx, pageCount);
    case 2: /* society_found - rules */;
      return _toStringBytes(&m->basic.society_found.rules, outValue,
                            outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  ...
  case 6665: /* module 26 call 9 */
    ...
    case 0: /* society_judge_suspended_member - who */;
      return _toStringAccountId(&m->basic.society_judge_suspended_member.who,
                                outValue, outValueLen, pageIdx, pageCount);
    case 1: /* society_judge_suspended_member - forgive */;
      return _toStringbool(&m->basic.society_judge_suspended_member.forgive,
                           outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6666: /* module 26 call 10 */
    ...
    case 0: /* society_judge_suspended_candidate - who */;
      return _toStringAccountId(&m->basic.society_judge_suspended_candidate.who,
                                outValue, outValueLen, pageIdx, pageCount);
    case 1: /* society_judge_suspended_candidate - judgement */;
      return _toStringJudgement(
          &m->basic.society_judge_suspended_candidate.judgement, outValue,
          outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6667: /* module 26 call 11 */
    ...
    case 0: /* society_set_max_members - max */;
      return _toStringu32(&m->basic.society_set_max_members.max, outValue,
                          outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6912: /* module 27 call 0 */
    ...
    case 0: /* recovery_as_recovered - account */;
      return _toStringAccountId(&m->basic.recovery_as_recovered.account,
                                outValue, outValueLen, pageIdx, pageCount);
    case 1: /* recovery_as_recovered - call */;
      return _toStringCall(&m->basic.recovery_as_recovered.call, outValue,
                           outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6913: /* module 27 call 1 */
    ...
    case 0: /* recovery_set_recovered - lost */;
      return _toStringAccountId(&m->basic.recovery_set_recovered.lost, outValue,
                                outValueLen, pageIdx, pageCount);
    case 1: /* recovery_set_recovered - rescuer */;
      return _toStringAccountId(&m->basic.recovery_set_recovered.rescuer,
                                outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6914: /* module 27 call 2 */
    ...
    case 0: /* recovery_create_recovery - friends */;
      return _toStringVecAccountId(&m->basic.recovery_create_recovery.friends,
                                   outValue, outValueLen, pageIdx, pageCount);
    case 1: /* recovery_create_recovery - threshold */;
      return _toStringu16(&m->basic.recovery_create_recovery.threshold,
                          outValue, outValueLen, pageIdx, pageCount);
    case 2: /* recovery_create_recovery - delay_period */;
      return _toStringBlockNumber(
          &m->basic.recovery_create_recovery.delay_period, outValue,
          outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6915: /* module 27 call 3 */
    ...
    case 0: /* recovery_initiate_recovery - account */;
      return _toStringAccountId(&m->basic.recovery_initiate_recovery.account,
                                outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6916: /* module 27 call 4 */
    ...
    case 0: /* recovery_vouch_recovery - lost */;
      return _toStringAccountId(&m->basic.recovery_vouch_recovery.lost,
                                outValue, outValueLen, pageIdx, pageCount);
    case 1: /* recovery_vouch_recovery - rescuer */;
      return _toStringAccountId(&m->basic.recovery_vouch_recovery.rescuer,
                                outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6917: /* module 27 call 5 */
    ...
    case 0: /* recovery_claim_recovery - account */;
      return _toStringAccountId(&m->basic.recovery_claim_recovery.account,
                                outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 6918: /* module 27 call 6 */
    ...
    case 0: /* recovery_close_recovery - rescuer */;
      return _toStringAccountId(&m->basic.recovery_close_recovery.rescuer,
                                outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  ...
  case 6920: /* module 27 call 8 */
    ...
    case 0: /* recovery_cancel_recovered - account */;
      return _toStringAccountId(&m->basic.recovery_cancel_recovered.account,
                                outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  ...
  case 7169: /* module 28 call 1 */
    ...
    case 0: /* vesting_vest_other - target */;
      return _toStringLookupSource(&m->basic.vesting_vest_other.target,
                                   outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 7170: /* module 28 call 2 */
    ...
    case 0: /* vesting_vested_transfer - target */;
      return _toStringLookupSource(&m->basic.vesting_vested_transfer.target,
                                   outValue, outValueLen, pageIdx, pageCount);
    case 1: /* vesting_vested_transfer - schedule */;
      return _toStringVestingInfo(&m->basic.vesting_vested_transfer.schedule,
                                  outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 7171: /* module 28 call 3 */
    ...
    case 0: /* vesting_force_vested_transfer - source */;
      return _toStringLookupSource(
          &m->basic.vesting_force_vested_transfer.source, outValue, outValueLen,
          pageIdx, pageCount);
    case 1: /* vesting_force_vested_transfer - target */;
      return _toStringLookupSource(
          &m->basic.vesting_force_vested_transfer.target, outValue, outValueLen,
          pageIdx, pageCount);
    case 2: /* vesting_force_vested_transfer - schedule */;
      return _toStringVestingInfo(
          &m->basic.vesting_force_vested_transfer.schedule, outValue,
          outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  ...
  case 7680: /* module 30 call 0 */
    ...
    case 0: /* proxy_proxy - real */;
      return _toStringAccountId(&m->basic.proxy_proxy.real, outValue,
                                outValueLen, pageIdx, pageCount);
    case 1: /* proxy_proxy - force_proxy_type */;
      return _toStringOptionProxyType(&m->basic.proxy_proxy.force_proxy_type,
                                      outValue, outValueLen, pageIdx,
                                      pageCount);
    case 2: /* proxy_proxy - call */;
      return _toStringCall(&m->basic.proxy_proxy.call, outValue, outValueLen,
                           pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 7681: /* module 30 call 1 */
    ...
    case 0: /* proxy_add_proxy - delegate */;
      return _toStringAccountId(&m->basic.proxy_add_proxy.delegate, outValue,
                                outValueLen, pageIdx, pageCount);
    case 1: /* proxy_add_proxy - proxy_type */;
      return _toStringProxyType(&m->basic.proxy_add_proxy.proxy_type, outValue,
                                outValueLen, pageIdx, pageCount);
    case 2: /* proxy_add_proxy - delay */;
      return _toStringBlockNumber(&m->basic.proxy_add_proxy.delay, outValue,
                                  outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 7682: /* module 30 call 2 */
    ...
    case 0: /* proxy_remove_proxy - delegate */;
      return _toStringAccountId(&m->basic.proxy_remove_proxy.delegate, outValue,
                                outValueLen, pageIdx, pageCount);
    case 1: /* proxy_remove_proxy - proxy_type */;
      return _toStringProxyType(&m->basic.proxy_remove_proxy.proxy_type,
                                outValue, outValueLen, pageIdx, pageCount);
    case 2: /* proxy_remove_proxy - delay */;
      return _toStringBlockNumber(&m->basic.proxy_remove_proxy.delay, outValue,
                                  outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  ...
  case 7684: /* module 30 call 4 */
    ...
    case 0: /* proxy_anonymous - proxy_type */;
      return _toStringProxyType(&m->basic.proxy_anonymous.proxy_type, outValue,
                                outValueLen, pageIdx, pageCount);
    case 1: /* proxy_anonymous - delay */;
      return _toStringBlockNumber(&m->basic.proxy_anonymous.delay, outValue,
                                  outValueLen, pageIdx, pageCount);
    case 2: /* proxy_anonymous - index */;
      return _toStringu16(&m->basic.proxy_anonymous.index, outValue,
                          outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 7685: /* module 30 call 5 */
    ...
    case 0: /* proxy_kill_anonymous - spawner */;
      return _toStringAccountId(&m->basic.proxy_kill_anonymous.spawner,
                                outValue, outValueLen, pageIdx, pageCount);
    case 1: /* proxy_kill_anonymous - proxy_type */;
      return _toStringProxyType(&m->basic.proxy_kill_anonymous.proxy_type,
                                outValue, outValueLen, pageIdx, pageCount);
    case 2: /* proxy_kill_anonymous - index */;
      return _toStringu16(&m->basic.proxy_kill_anonymous.index, outValue,
                          outValueLen, pageIdx, pageCount);
    case 3: /* proxy_kill_anonymous - height */;
      return _toStringCompactBlockNumber(&m->basic.proxy_kill_anonymous.height,
                                         outValue, outValueLen, pageIdx,
                                         pageCount);
    case 4: /* proxy_kill_anonymous - ext_index */;
      return _toStringCompactu32(&m->basic.proxy_kill_anonymous.ext_index,
                                 outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 7686: /* module 30 call 6 */
    ...
    case 0: /* proxy_announce - real */;
      return _toStringAccountId(&m->basic.proxy_announce.real, outValue,
                                outValueLen, pageIdx, pageCount);
    case 1: /* proxy_announce - call_hash */;
      return _toStringCallHashOf(&m->basic.proxy_announce.call_hash, outValue,
                                 outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 7687: /* module 30 call 7 */
    ...
    case 0: /* proxy_remove_announcement - real */;
      return _toStringAccountId(&m->basic.proxy_remove_announcement.real,
                                outValue, outValueLen, pageIdx, pageCount);
    case 1: /* proxy_remove_announcement - call_hash */;
      return _toStringCallHashOf(&m->basic.proxy_remove_announcement.call_hash,
                                 outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 7688: /* module 30 call 8 */
    ...
    case 0: /* proxy_reject_announcement - delegate */;
      return _toStringAccountId(&m->basic.proxy_reject_announcement.delegate,
                                outValue, outValueLen, pageIdx, pageCount);
    case 1: /* proxy_reject_announcement - call_hash */;
      return _toStringCallHashOf(&m->basic.proxy_reject_announcement.call_hash,
                                 outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 7689: /* module 30 call 9 */
    ...
    case 0: /* proxy_proxy_announced - delegate */;
      return _toStringAccountId(&m->basic.proxy_proxy_announced.delegate,
                                outValue, outValueLen, pageIdx, pageCount);
    case 1: /* proxy_proxy_announced - real */;
      return _toStringAccountId(&m->basic.proxy_proxy_announced.real, outValue,
                                outValueLen, pageIdx, pageCount);
    case 2: /* proxy_proxy_announced - force_proxy_type */;
      return _toStringOptionProxyType(
          &m->basic.proxy_proxy_announced.force_proxy_type, outValue,
          outValueLen, pageIdx, pageCount);
    case 3: /* proxy_proxy_announced - call */;
      return _toStringCall(&m->basic.proxy_proxy_announced.call, outValue,
                           outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 7936: /* module 31 call 0 */
    ...
    case 0: /* multisig_as_multi_threshold_1 - other_signatories */;
      return _toStringVecAccountId(
          &m->basic.multisig_as_multi_threshold_1.other_signatories, outValue,
          outValueLen, pageIdx, pageCount);
    case 1: /* multisig_as_multi_threshold_1 - call */;
      return _toStringCall(&m->basic.multisig_as_multi_threshold_1.call,
                           outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 7937: /* module 31 call 1 */
    ...
    case 0: /* multisig_as_multi - threshold */;
      return _toStringu16(&m->basic.multisig_as_multi.threshold, outValue,
                          outValueLen, pageIdx, pageCount);
    case 1: /* multisig_as_multi - other_signatories */;
      return _toStringVecAccountId(
          &m->basic.multisig_as_multi.other_signatories, outValue, outValueLen,
          pageIdx, pageCount);
    case 2: /* multisig_as_multi - maybe_timepoint */;
      return _toStringOptionTimepoint(
          &m->basic.multisig_as_multi.maybe_timepoint, outValue, outValueLen,
          pageIdx, pageCount);
    case 3: /* multisig_as_multi - call */;
      return _toStringOpaqueCall(&m->basic.multisig_as_multi.call, outValue,
                                 outValueLen, pageIdx, pageCount);
    case 4: /* multisig_as_multi - store_call */;
      return _toStringbool(&m->basic.multisig_as_multi.store_call, outValue,
                           outValueLen, pageIdx, pageCount);
    case 5: /* multisig_as_multi - max_weight */;
      return _toStringWeight(&m->basic.multisig_as_multi.max_weight, outValue,
                             outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 7938: /* module 31 call 2 */
    ...
    case 0: /* multisig_approve_as_multi - threshold */;
      return _toStringu16(&m->basic.multisig_approve_as_multi.threshold,
                          outValue, outValueLen, pageIdx, pageCount);
    case 1: /* multisig_approve_as_multi - other_signatories */;
      return _toStringVecAccountId(
          &m->basic.multisig_approve_as_multi.other_signatories, outValue,
          outValueLen, pageIdx, pageCount);
    case 2: /* multisig_approve_as_multi - maybe_timepoint */;
      return _toStringOptionTimepoint(
          &m->basic.multisig_approve_as_multi.maybe_timepoint, outValue,
          outValueLen, pageIdx, pageCount);
    case 3: /* multisig_approve_as_multi - call_hash */;
      return _toStringu8_array_32(&m->basic.multisig_approve_as_multi.call_hash,
                                  outValue, outValueLen, pageIdx, pageCount);
    case 4: /* multisig_approve_as_multi - max_weight */;
      return _toStringWeight(&m->basic.multisig_approve_as_multi.max_weight,
                             outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
  case 7939: /* module 31 call 3 */
    ...
    case 0: /* multisig_cancel_as_multi - threshold */;
      return _toStringu16(&m->basic.multisig_cancel_as_multi.threshold,
                          outValue, outValueLen, pageIdx, pageCount);
    case 1: /* multisig_cancel_as_multi - other_signatories */;
      return _toStringVecAccountId(
          &m->basic.multisig_cancel_as_multi.other_signatories, outValue,
          outValueLen, pageIdx, pageCount);
    case 2: /* multisig_cancel_as_multi - timepoint */;
      return _toStringTimepoint(&m->basic.multisig_cancel_as_multi.timepoint,
                                outValue, outValueLen, pageIdx, pageCount);
    case 3: /* multisig_cancel_as_multi - call_hash */;
      return _toStringu8_array_32(&m->basic.multisig_cancel_as_multi.call_hash,
                                  outValue, outValueLen, pageIdx, pageCount);
    default:
      return parser_no_data;
    }
