...
#define PD_CALL_TIMESTAMP_V8 2
#define PD_CALL_INDICES_V8 3
#define PD_CALL_BALANCES_V8 4
#define PD_CALL_STAKING_V8 6
#define PD_CALL_SESSION_V8 8
#define PD_CALL_GRANDPA_V8 10
#define PD_CALL_DEMOCRACY_V8 13
#define PD_CALL_COUNCIL_V8 14
#define PD_CALL_TECHNICALCOMMITTEE_V8 15
#define PD_CALL_PHRAGMENELECTION_V8 16
#define PD_CALL_TECHNICALMEMBERSHIP_V8 17
#define PD_CALL_TREASURY_V8 18
#define PD_CALL_CLAIMS_V8 19
#define PD_CALL_UTILITY_V8 24
#define PD_CALL_IDENTITY_V8 25
#define PD_CALL_SOCIETY_V8 26
#define PD_CALL_RECOVERY_V8 27
#define PD_CALL_VESTING_V8 28
#define PD_CALL_PROXY_V8 30
#define PD_CALL_MULTISIG_V8 31
#define PD_CALL_BOUNTIES_V8 35
#define PD_CALL_TIPS_V8 36
#define PD_CALL_GILT_V8 38
#define PD_CALL_BAGSLIST_V8 39
#define PD_CALL_CONFIGURATION_V8 51
#define PD_CALL_INITIALIZER_V8 57
#define PD_CALL_HRMP_V8 60
#define PD_CALL_PARASDISPUTES_V8 62
...
#define PD_CALL_SOCIETY_BID_V8 0
typedef struct {
    pd_Balance_t amount;
} pd_society_bid_V8_t;

#define PD_CALL_SOCIETY_UNBID_V8 1
typedef struct {
    pd_u32_t pos;
} pd_society_unbid_V8_t;

#define PD_CALL_SOCIETY_VOUCH_V8 2
typedef struct {
    pd_AccountId_V8_t who;
    pd_Balance_t amount;
    pd_Balance_t tip;
} pd_society_vouch_V8_t;

#define PD_CALL_SOCIETY_UNVOUCH_V8 3
typedef struct {
    pd_u32_t pos;
} pd_society_unvouch_V8_t;

#define PD_CALL_SOCIETY_VOTE_V8 4
typedef struct {
    pd_LookupasStaticLookupSource_V8_t candidate;
    pd_bool_t approve;
} pd_society_vote_V8_t;

#define PD_CALL_SOCIETY_DEFENDER_VOTE_V8 5
typedef struct {
    pd_bool_t approve;
} pd_society_defender_vote_V8_t;

#define PD_CALL_SOCIETY_PAYOUT_V8 6
typedef struct {
} pd_society_payout_V8_t;

#define PD_CALL_SOCIETY_FOUND_V8 7
typedef struct {
    pd_AccountId_V8_t founder;
    pd_u32_t max_members;
    pd_Bytes_t rules;
} pd_society_found_V8_t;

#define PD_CALL_SOCIETY_UNFOUND_V8 8
typedef struct {
} pd_society_unfound_V8_t;

#define PD_CALL_SOCIETY_JUDGE_SUSPENDED_MEMBER_V8 9
typedef struct {
    pd_AccountId_V8_t who;
    pd_bool_t forgive;
} pd_society_judge_suspended_member_V8_t;

#define PD_CALL_SOCIETY_SET_MAX_MEMBERS_V8 11
typedef struct {
    pd_u32_t max;
} pd_society_set_max_members_V8_t;

#define PD_CALL_RECOVERY_SET_RECOVERED_V8 1
typedef struct {
    pd_AccountId_V8_t lost;
    pd_AccountId_V8_t rescuer;
} pd_recovery_set_recovered_V8_t;

#define PD_CALL_RECOVERY_INITIATE_RECOVERY_V8 3
typedef struct {
    pd_AccountId_V8_t account;
} pd_recovery_initiate_recovery_V8_t;

#define PD_CALL_RECOVERY_VOUCH_RECOVERY_V8 4
typedef struct {
    pd_AccountId_V8_t lost;
    pd_AccountId_V8_t rescuer;
} pd_recovery_vouch_recovery_V8_t;

#define PD_CALL_RECOVERY_CLAIM_RECOVERY_V8 5
typedef struct {
    pd_AccountId_V8_t account;
} pd_recovery_claim_recovery_V8_t;

#define PD_CALL_RECOVERY_CLOSE_RECOVERY_V8 6
typedef struct {
    pd_AccountId_V8_t rescuer;
} pd_recovery_close_recovery_V8_t;

#define PD_CALL_RECOVERY_REMOVE_RECOVERY_V8 7
typedef struct {
} pd_recovery_remove_recovery_V8_t;

#define PD_CALL_RECOVERY_CANCEL_RECOVERED_V8 8
typedef struct {
    pd_AccountId_V8_t account;
} pd_recovery_cancel_recovered_V8_t;
...
#define PD_CALL_GILT_PLACE_BID_V8 0
typedef struct {
    pd_CompactBalance_t amount;
    pd_u32_t duration;
} pd_gilt_place_bid_V8_t;

#define PD_CALL_GILT_RETRACT_BID_V8 1
typedef struct {
    pd_CompactBalance_t amount;
    pd_u32_t duration;
} pd_gilt_retract_bid_V8_t;

#define PD_CALL_BAGSLIST_REBAG_V8 0
typedef struct {
    pd_AccountId_V8_t dislocated;
} pd_bagslist_rebag_V8_t;
...
#define PD_CALL_PARASDISPUTES_FORCE_UNFREEZE_V8 0
typedef struct {
} pd_parasdisputes_force_unfreeze_V8_t;
...
typedef union {
    ...
    pd_society_bid_V8_t society_bid_V8;
    pd_society_unbid_V8_t society_unbid_V8;
    pd_society_vouch_V8_t society_vouch_V8;
    pd_society_unvouch_V8_t society_unvouch_V8;
    pd_society_vote_V8_t society_vote_V8;
    pd_society_defender_vote_V8_t society_defender_vote_V8;
    pd_society_payout_V8_t society_payout_V8;
    pd_society_found_V8_t society_found_V8;
    pd_society_unfound_V8_t society_unfound_V8;
    pd_society_judge_suspended_member_V8_t society_judge_suspended_member_V8;
    pd_society_set_max_members_V8_t society_set_max_members_V8;
    pd_recovery_set_recovered_V8_t recovery_set_recovered_V8;
    pd_recovery_initiate_recovery_V8_t recovery_initiate_recovery_V8;
    pd_recovery_vouch_recovery_V8_t recovery_vouch_recovery_V8;
    pd_recovery_claim_recovery_V8_t recovery_claim_recovery_V8;
    pd_recovery_close_recovery_V8_t recovery_close_recovery_V8;
    pd_recovery_remove_recovery_V8_t recovery_remove_recovery_V8;
    pd_recovery_cancel_recovered_V8_t recovery_cancel_recovered_V8;
    ...
    pd_gilt_place_bid_V8_t gilt_place_bid_V8;
    pd_gilt_retract_bid_V8_t gilt_retract_bid_V8;
    pd_bagslist_rebag_V8_t bagslist_rebag_V8;
    ...
    pd_parasdisputes_force_unfreeze_V8_t parasdisputes_force_unfreeze_V8;
