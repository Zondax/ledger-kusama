...
#define PD_CALL_TIMESTAMP_V15 2
#define PD_CALL_INDICES_V15 3
#define PD_CALL_BALANCES_V15 4
#define PD_CALL_STAKING_V15 6
#define PD_CALL_SESSION_V15 8
#define PD_CALL_DEMOCRACY_V15 13
#define PD_CALL_COUNCIL_V15 14
#define PD_CALL_TECHNICALCOMMITTEE_V15 15
#define PD_CALL_PHRAGMENELECTION_V15 16
#define PD_CALL_TECHNICALMEMBERSHIP_V15 17
#define PD_CALL_TREASURY_V15 18
#define PD_CALL_CONVICTIONVOTING_V15 20
#define PD_CALL_REFERENDA_V15 21
#define PD_CALL_FELLOWSHIPCOLLECTIVE_V15 22
#define PD_CALL_FELLOWSHIPREFERENDA_V15 23
#define PD_CALL_WHITELIST_V15 44
#define PD_CALL_CLAIMS_V15 19
#define PD_CALL_UTILITY_V15 24
#define PD_CALL_IDENTITY_V15 25
#define PD_CALL_SOCIETY_V15 26
#define PD_CALL_RECOVERY_V15 27
#define PD_CALL_VESTING_V15 28
#define PD_CALL_PROXY_V15 30
#define PD_CALL_MULTISIG_V15 31
#define PD_CALL_PREIMAGE_V15 32
#define PD_CALL_BOUNTIES_V15 35
#define PD_CALL_CHILDBOUNTIES_V15 40
#define PD_CALL_TIPS_V15 36
#define PD_CALL_GILT_V15 38
#define PD_CALL_VOTERLIST_V15 39
#define PD_CALL_NOMINATIONPOOLS_V15 41
#define PD_CALL_FASTUNSTAKE_V15 42
...
#define PD_CALL_DEMOCRACY_BLACKLIST_V15 16
typedef struct {
...
#define PD_CALL_COUNCIL_CLOSE_OLD_WEIGHT_V15 4
typedef struct {
    pd_Hash_t proposal_hash;
    pd_Compactu32_t index;
    pd_Compactu64_t proposal_weight_bound;
    pd_Compactu32_t length_bound;
} pd_council_close_old_weight_V15_t;
...
#define PD_CALL_COUNCIL_CLOSE_V15 6
typedef struct {
    pd_Hash_t proposal_hash;
    pd_Compactu32_t index;
    pd_Weight_V15_t proposal_weight_bound;
    pd_Compactu32_t length_bound;
...
#define PD_CALL_TECHNICALCOMMITTEE_CLOSE_OLD_WEIGHT_V15 4
typedef struct {
    pd_Hash_t proposal_hash;
    pd_Compactu32_t index;
    pd_Compactu64_t proposal_weight_bound;
    pd_Compactu32_t length_bound;
} pd_technicalcommittee_close_old_weight_V15_t;
...
#define PD_CALL_TECHNICALCOMMITTEE_CLOSE_V15 6
typedef struct {
    pd_Hash_t proposal_hash;
    pd_Compactu32_t index;
    pd_Weight_V15_t proposal_weight_bound;
...
#define PD_CALL_CONVICTIONVOTING_VOTE_V15 0
typedef struct {
    pd_Compactu32_t poll_index;
    pd_AccountVote_V15_t vote;
} pd_convictionvoting_vote_V15_t;

#define PD_CALL_CONVICTIONVOTING_DELEGATE_V15 1
typedef struct {
    pd_ClassOf_V15_t class_;
    pd_AccountIdLookupOfT_V15_t to;
    pd_Conviction_V15_t conviction;
    pd_BalanceOf_t balance;
} pd_convictionvoting_delegate_V15_t;

#define PD_CALL_CONVICTIONVOTING_UNDELEGATE_V15 2
typedef struct {
    pd_ClassOf_V15_t class_;
} pd_convictionvoting_undelegate_V15_t;

#define PD_CALL_CONVICTIONVOTING_UNLOCK_V15 3
typedef struct {
    pd_ClassOf_V15_t class_;
    pd_AccountIdLookupOfT_V15_t target;
} pd_convictionvoting_unlock_V15_t;

#define PD_CALL_CONVICTIONVOTING_REMOVE_VOTE_V15 4
typedef struct {
    pd_OptionClassOf_V15_t class_;
    pd_PollIndexOf_V15_t index;
} pd_convictionvoting_remove_vote_V15_t;

#define PD_CALL_CONVICTIONVOTING_REMOVE_OTHER_VOTE_V15 5
typedef struct {
    pd_AccountIdLookupOfT_V15_t target;
    pd_ClassOf_V15_t class_;
    pd_PollIndexOf_V15_t index;
} pd_convictionvoting_remove_other_vote_V15_t;

#define PD_CALL_REFERENDA_PLACE_DECISION_DEPOSIT_V15 1
typedef struct {
    pd_ReferendumIndex_V15_t index;
} pd_referenda_place_decision_deposit_V15_t;

#define PD_CALL_REFERENDA_REFUND_DECISION_DEPOSIT_V15 2
typedef struct {
    pd_ReferendumIndex_V15_t index;
} pd_referenda_refund_decision_deposit_V15_t;

#define PD_CALL_REFERENDA_CANCEL_V15 3
typedef struct {
    pd_ReferendumIndex_V15_t index;
} pd_referenda_cancel_V15_t;

#define PD_CALL_REFERENDA_KILL_V15 4
typedef struct {
    pd_ReferendumIndex_V15_t index;
} pd_referenda_kill_V15_t;

#define PD_CALL_REFERENDA_NUDGE_REFERENDUM_V15 5
typedef struct {
    pd_ReferendumIndex_V15_t index;
} pd_referenda_nudge_referendum_V15_t;

#define PD_CALL_REFERENDA_ONE_FEWER_DECIDING_V15 6
typedef struct {
    pd_TrackIdOf_V15_t track;
} pd_referenda_one_fewer_deciding_V15_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_ADD_MEMBER_V15 0
typedef struct {
    pd_AccountIdLookupOfT_V15_t who;
} pd_fellowshipcollective_add_member_V15_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_PROMOTE_MEMBER_V15 1
typedef struct {
    pd_AccountIdLookupOfT_V15_t who;
} pd_fellowshipcollective_promote_member_V15_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_DEMOTE_MEMBER_V15 2
typedef struct {
    pd_AccountIdLookupOfT_V15_t who;
} pd_fellowshipcollective_demote_member_V15_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_REMOVE_MEMBER_V15 3
typedef struct {
    pd_AccountIdLookupOfT_V15_t who;
    pd_Rank_V15_t min_rank;
} pd_fellowshipcollective_remove_member_V15_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_VOTE_V15 4
typedef struct {
    pd_PollIndexOf_V15_t poll;
    pd_bool_t aye;
} pd_fellowshipcollective_vote_V15_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_CLEANUP_POLL_V15 5
typedef struct {
    pd_PollIndexOf_V15_t poll_index;
    pd_u32_t max;
} pd_fellowshipcollective_cleanup_poll_V15_t;

#define PD_CALL_FELLOWSHIPREFERENDA_PLACE_DECISION_DEPOSIT_V15 1
typedef struct {
    pd_ReferendumIndex_V15_t index;
} pd_fellowshipreferenda_place_decision_deposit_V15_t;

#define PD_CALL_FELLOWSHIPREFERENDA_REFUND_DECISION_DEPOSIT_V15 2
typedef struct {
    pd_ReferendumIndex_V15_t index;
} pd_fellowshipreferenda_refund_decision_deposit_V15_t;

#define PD_CALL_FELLOWSHIPREFERENDA_CANCEL_V15 3
typedef struct {
    pd_ReferendumIndex_V15_t index;
} pd_fellowshipreferenda_cancel_V15_t;

#define PD_CALL_FELLOWSHIPREFERENDA_KILL_V15 4
typedef struct {
    pd_ReferendumIndex_V15_t index;
} pd_fellowshipreferenda_kill_V15_t;

#define PD_CALL_FELLOWSHIPREFERENDA_NUDGE_REFERENDUM_V15 5
typedef struct {
    pd_ReferendumIndex_V15_t index;
} pd_fellowshipreferenda_nudge_referendum_V15_t;

#define PD_CALL_FELLOWSHIPREFERENDA_ONE_FEWER_DECIDING_V15 6
typedef struct {
    pd_TrackIdOf_V15_t track;
} pd_fellowshipreferenda_one_fewer_deciding_V15_t;

#define PD_CALL_WHITELIST_WHITELIST_CALL_V15 0
typedef struct {
    pd_Hash_t call_hash;
} pd_whitelist_whitelist_call_V15_t;

#define PD_CALL_WHITELIST_REMOVE_WHITELISTED_CALL_V15 1
typedef struct {
    pd_Hash_t call_hash;
} pd_whitelist_remove_whitelisted_call_V15_t;

#define PD_CALL_WHITELIST_DISPATCH_WHITELISTED_CALL_V15 2
typedef struct {
    pd_Hash_t call_hash;
    pd_Weight_V15_t call_weight_witness;
} pd_whitelist_dispatch_whitelisted_call_V15_t;

#define PD_CALL_WHITELIST_DISPATCH_WHITELISTED_CALL_WITH_PREIMAGE_V15 3
typedef struct {
    pd_Call_t call;
} pd_whitelist_dispatch_whitelisted_call_with_preimage_V15_t;
...
#define PD_CALL_SOCIETY_BID_V15 0
typedef struct {
    pd_BalanceOf_t amount;
} pd_society_bid_V15_t;

#define PD_CALL_SOCIETY_UNBID_V15 1
typedef struct {
    pd_u32_t pos;
} pd_society_unbid_V15_t;

#define PD_CALL_SOCIETY_VOUCH_V15 2
typedef struct {
    pd_AccountIdLookupOfT_V15_t who;
    pd_BalanceOf_t amount;
    pd_BalanceOf_t tip;
} pd_society_vouch_V15_t;

#define PD_CALL_SOCIETY_UNVOUCH_V15 3
typedef struct {
    pd_u32_t pos;
} pd_society_unvouch_V15_t;

#define PD_CALL_SOCIETY_VOTE_V15 4
typedef struct {
    pd_AccountIdLookupOfT_V15_t candidate;
    pd_bool_t approve;
} pd_society_vote_V15_t;

#define PD_CALL_SOCIETY_DEFENDER_VOTE_V15 5
typedef struct {
    pd_bool_t approve;
} pd_society_defender_vote_V15_t;

#define PD_CALL_SOCIETY_PAYOUT_V15 6
typedef struct {
} pd_society_payout_V15_t;

#define PD_CALL_SOCIETY_FOUND_V15 7
typedef struct {
    pd_AccountIdLookupOfT_V15_t founder;
    pd_u32_t max_members;
    pd_Bytes_t rules;
} pd_society_found_V15_t;

#define PD_CALL_SOCIETY_UNFOUND_V15 8
typedef struct {
} pd_society_unfound_V15_t;

#define PD_CALL_SOCIETY_JUDGE_SUSPENDED_MEMBER_V15 9
typedef struct {
    pd_AccountIdLookupOfT_V15_t who;
    pd_bool_t forgive;
} pd_society_judge_suspended_member_V15_t;

#define PD_CALL_SOCIETY_SET_MAX_MEMBERS_V15 11
typedef struct {
    pd_u32_t max;
} pd_society_set_max_members_V15_t;

#define PD_CALL_RECOVERY_SET_RECOVERED_V15 1
typedef struct {
    pd_AccountIdLookupOfT_V15_t lost;
    pd_AccountIdLookupOfT_V15_t rescuer;
} pd_recovery_set_recovered_V15_t;

#define PD_CALL_RECOVERY_INITIATE_RECOVERY_V15 3
typedef struct {
    pd_AccountIdLookupOfT_V15_t account;
} pd_recovery_initiate_recovery_V15_t;

#define PD_CALL_RECOVERY_VOUCH_RECOVERY_V15 4
typedef struct {
    pd_AccountIdLookupOfT_V15_t lost;
    pd_AccountIdLookupOfT_V15_t rescuer;
} pd_recovery_vouch_recovery_V15_t;

#define PD_CALL_RECOVERY_CLAIM_RECOVERY_V15 5
typedef struct {
    pd_AccountIdLookupOfT_V15_t account;
} pd_recovery_claim_recovery_V15_t;

#define PD_CALL_RECOVERY_CLOSE_RECOVERY_V15 6
typedef struct {
    pd_AccountIdLookupOfT_V15_t rescuer;
} pd_recovery_close_recovery_V15_t;

#define PD_CALL_RECOVERY_REMOVE_RECOVERY_V15 7
typedef struct {
} pd_recovery_remove_recovery_V15_t;

#define PD_CALL_RECOVERY_CANCEL_RECOVERED_V15 8
typedef struct {
    pd_AccountIdLookupOfT_V15_t account;
} pd_recovery_cancel_recovered_V15_t;
...
#define PD_CALL_GILT_PLACE_BID_V15 0
typedef struct {
    pd_CompactBalance_t amount;
    pd_u32_t duration;
} pd_gilt_place_bid_V15_t;

#define PD_CALL_GILT_RETRACT_BID_V15 1
typedef struct {
    pd_CompactBalance_t amount;
    pd_u32_t duration;
} pd_gilt_retract_bid_V15_t;

#define PD_CALL_GILT_SET_TARGET_V15 2
typedef struct {
    pd_Compactu64_t target;
} pd_gilt_set_target_V15_t;

#define PD_CALL_GILT_THAW_V15 3
typedef struct {
    pd_Compactu32_t index;
} pd_gilt_thaw_V15_t;
...
#define PD_CALL_CONFIGURATION_SET_DISPUTE_PERIOD_V15 14
typedef struct {
    pd_SessionIndex_V15_t new_;
} pd_configuration_set_dispute_period_V15_t;
...
typedef union {
    ...
    pd_council_close_old_weight_V15_t council_close_old_weight_V15;
    ...
    pd_technicalcommittee_close_old_weight_V15_t technicalcommittee_close_old_weight_V15;
    ...
    pd_convictionvoting_vote_V15_t convictionvoting_vote_V15;
    pd_convictionvoting_delegate_V15_t convictionvoting_delegate_V15;
    pd_convictionvoting_undelegate_V15_t convictionvoting_undelegate_V15;
    pd_convictionvoting_unlock_V15_t convictionvoting_unlock_V15;
    pd_convictionvoting_remove_vote_V15_t convictionvoting_remove_vote_V15;
    pd_convictionvoting_remove_other_vote_V15_t convictionvoting_remove_other_vote_V15;
    pd_referenda_place_decision_deposit_V15_t referenda_place_decision_deposit_V15;
    pd_referenda_refund_decision_deposit_V15_t referenda_refund_decision_deposit_V15;
    pd_referenda_cancel_V15_t referenda_cancel_V15;
    pd_referenda_kill_V15_t referenda_kill_V15;
    pd_referenda_nudge_referendum_V15_t referenda_nudge_referendum_V15;
    pd_referenda_one_fewer_deciding_V15_t referenda_one_fewer_deciding_V15;
    pd_fellowshipcollective_add_member_V15_t fellowshipcollective_add_member_V15;
    pd_fellowshipcollective_promote_member_V15_t fellowshipcollective_promote_member_V15;
    pd_fellowshipcollective_demote_member_V15_t fellowshipcollective_demote_member_V15;
    pd_fellowshipcollective_remove_member_V15_t fellowshipcollective_remove_member_V15;
    pd_fellowshipcollective_vote_V15_t fellowshipcollective_vote_V15;
    pd_fellowshipcollective_cleanup_poll_V15_t fellowshipcollective_cleanup_poll_V15;
    pd_fellowshipreferenda_place_decision_deposit_V15_t fellowshipreferenda_place_decision_deposit_V15;
    pd_fellowshipreferenda_refund_decision_deposit_V15_t fellowshipreferenda_refund_decision_deposit_V15;
    pd_fellowshipreferenda_cancel_V15_t fellowshipreferenda_cancel_V15;
    pd_fellowshipreferenda_kill_V15_t fellowshipreferenda_kill_V15;
    pd_fellowshipreferenda_nudge_referendum_V15_t fellowshipreferenda_nudge_referendum_V15;
    pd_fellowshipreferenda_one_fewer_deciding_V15_t fellowshipreferenda_one_fewer_deciding_V15;
    pd_whitelist_whitelist_call_V15_t whitelist_whitelist_call_V15;
    pd_whitelist_remove_whitelisted_call_V15_t whitelist_remove_whitelisted_call_V15;
    pd_whitelist_dispatch_whitelisted_call_V15_t whitelist_dispatch_whitelisted_call_V15;
    pd_whitelist_dispatch_whitelisted_call_with_preimage_V15_t whitelist_dispatch_whitelisted_call_with_preimage_V15;
    ...
    pd_society_bid_V15_t society_bid_V15;
    pd_society_unbid_V15_t society_unbid_V15;
    pd_society_vouch_V15_t society_vouch_V15;
    pd_society_unvouch_V15_t society_unvouch_V15;
    pd_society_vote_V15_t society_vote_V15;
    pd_society_defender_vote_V15_t society_defender_vote_V15;
    pd_society_payout_V15_t society_payout_V15;
    pd_society_found_V15_t society_found_V15;
    pd_society_unfound_V15_t society_unfound_V15;
    pd_society_judge_suspended_member_V15_t society_judge_suspended_member_V15;
    pd_society_set_max_members_V15_t society_set_max_members_V15;
    pd_recovery_set_recovered_V15_t recovery_set_recovered_V15;
    pd_recovery_initiate_recovery_V15_t recovery_initiate_recovery_V15;
    pd_recovery_vouch_recovery_V15_t recovery_vouch_recovery_V15;
    pd_recovery_claim_recovery_V15_t recovery_claim_recovery_V15;
    pd_recovery_close_recovery_V15_t recovery_close_recovery_V15;
    pd_recovery_remove_recovery_V15_t recovery_remove_recovery_V15;
    pd_recovery_cancel_recovered_V15_t recovery_cancel_recovered_V15;
    ...
    pd_gilt_place_bid_V15_t gilt_place_bid_V15;
    pd_gilt_retract_bid_V15_t gilt_retract_bid_V15;
    pd_gilt_set_target_V15_t gilt_set_target_V15;
    pd_gilt_thaw_V15_t gilt_thaw_V15;
    ...
    pd_configuration_set_dispute_period_V15_t configuration_set_dispute_period_V15;
...
typedef struct {
    pd_BoundedCallOfT_V15_t proposal;
    pd_CompactBalance_t amount;
...
#define PD_CALL_DEMOCRACY_DELEGATE_V15 10
typedef struct {
    pd_AccountIdLookupOfT_V15_t to;
    pd_Conviction_V15_t conviction;
...
#define PD_CALL_DEMOCRACY_UNDELEGATE_V15 11
typedef struct {
} pd_democracy_undelegate_V15_t;

#define PD_CALL_DEMOCRACY_CLEAR_PUBLIC_PROPOSALS_V15 12
typedef struct {
} pd_democracy_clear_public_proposals_V15_t;

#define PD_CALL_DEMOCRACY_UNLOCK_V15 13
typedef struct {
    pd_AccountIdLookupOfT_V15_t target;
} pd_democracy_unlock_V15_t;

#define PD_CALL_DEMOCRACY_REMOVE_VOTE_V15 14
typedef struct {
    pd_ReferendumIndex_V15_t index;
} pd_democracy_remove_vote_V15_t;

#define PD_CALL_DEMOCRACY_REMOVE_OTHER_VOTE_V15 15
typedef struct {
    pd_AccountIdLookupOfT_V15_t target;
    pd_ReferendumIndex_V15_t index;
} pd_democracy_remove_other_vote_V15_t;

#define PD_CALL_DEMOCRACY_CANCEL_PROPOSAL_V15 17
typedef struct {
