...
#define PD_CALL_TIMESTAMP_V20 2
#define PD_CALL_INDICES_V20 3
#define PD_CALL_BALANCES_V20 4
#define PD_CALL_STAKING_V20 6
#define PD_CALL_SESSION_V20 8
#define PD_CALL_DEMOCRACY_V20 13
#define PD_CALL_COUNCIL_V20 14
#define PD_CALL_TECHNICALCOMMITTEE_V20 15
#define PD_CALL_PHRAGMENELECTION_V20 16
#define PD_CALL_TECHNICALMEMBERSHIP_V20 17
#define PD_CALL_TREASURY_V20 18
#define PD_CALL_CONVICTIONVOTING_V20 20
#define PD_CALL_REFERENDA_V20 21
#define PD_CALL_FELLOWSHIPCOLLECTIVE_V20 22
#define PD_CALL_FELLOWSHIPREFERENDA_V20 23
#define PD_CALL_WHITELIST_V20 44
#define PD_CALL_CLAIMS_V20 19
#define PD_CALL_UTILITY_V20 24
#define PD_CALL_IDENTITY_V20 25
#define PD_CALL_SOCIETY_V20 26
#define PD_CALL_RECOVERY_V20 27
#define PD_CALL_VESTING_V20 28
#define PD_CALL_PROXY_V20 30
#define PD_CALL_MULTISIG_V20 31
#define PD_CALL_PREIMAGE_V20 32
#define PD_CALL_BOUNTIES_V20 35
#define PD_CALL_CHILDBOUNTIES_V20 40
#define PD_CALL_TIPS_V20 36
#define PD_CALL_NIS_V20 38
#define PD_CALL_NISCOUNTERPARTBALANCES_V20 45
#define PD_CALL_VOTERLIST_V20 39
#define PD_CALL_NOMINATIONPOOLS_V20 41
#define PD_CALL_FASTUNSTAKE_V20 42
...
#ifndef TARGET_NANOS
#define PD_CALL_XCMPALLET_TELEPORT_ASSETS_V20 1
typedef struct {
...
} pd_xcmpallet_teleport_assets_V20_t;
...
#define PD_CALL_XCMPALLET_LIMITED_TELEPORT_ASSETS_V20 9
typedef struct {
    pd_BoxVersionedMultiLocation_t dest;
    pd_BoxVersionedMultiLocation_t beneficiary;
    pd_BoxVersionedMultiAssets_t assets;
    pd_u32_t fee_asset_item;
    pd_WeightLimit_t weight_limit;
} pd_xcmpallet_limited_teleport_assets_V20_t;
#endif
...
#define PD_CALL_DEMOCRACY_SET_METADATA_V20 18
typedef struct {
    pd_MetadataOwner_t owner;
    pd_OptionPreimageHash_t maybe_hash;
} pd_democracy_set_metadata_V20_t;
...
#define PD_CALL_CONVICTIONVOTING_VOTE_V20 0
typedef struct {
    pd_Compactu32_t poll_index;
    pd_AccountVote_t vote;
} pd_convictionvoting_vote_V20_t;

#define PD_CALL_CONVICTIONVOTING_DELEGATE_V20 1
typedef struct {
    pd_ClassOf_t class_;
    pd_AccountIdLookupOfT_t to;
    pd_Conviction_t conviction;
    pd_BalanceOf_t balance;
} pd_convictionvoting_delegate_V20_t;

#define PD_CALL_CONVICTIONVOTING_UNDELEGATE_V20 2
typedef struct {
    pd_ClassOf_t class_;
} pd_convictionvoting_undelegate_V20_t;

#define PD_CALL_CONVICTIONVOTING_UNLOCK_V20 3
typedef struct {
    pd_ClassOf_t class_;
    pd_AccountIdLookupOfT_t target;
} pd_convictionvoting_unlock_V20_t;

#define PD_CALL_CONVICTIONVOTING_REMOVE_VOTE_V20 4
typedef struct {
    pd_OptionClassOf_t class_;
    pd_PollIndexOf_t index;
} pd_convictionvoting_remove_vote_V20_t;

#define PD_CALL_CONVICTIONVOTING_REMOVE_OTHER_VOTE_V20 5
typedef struct {
    pd_AccountIdLookupOfT_t target;
    pd_ClassOf_t class_;
    pd_PollIndexOf_t index;
} pd_convictionvoting_remove_other_vote_V20_t;

#define PD_CALL_REFERENDA_PLACE_DECISION_DEPOSIT_V20 1
typedef struct {
    pd_ReferendumIndex_t index;
} pd_referenda_place_decision_deposit_V20_t;

#define PD_CALL_REFERENDA_REFUND_DECISION_DEPOSIT_V20 2
typedef struct {
    pd_ReferendumIndex_t index;
} pd_referenda_refund_decision_deposit_V20_t;

#define PD_CALL_REFERENDA_CANCEL_V20 3
typedef struct {
    pd_ReferendumIndex_t index;
} pd_referenda_cancel_V20_t;

#define PD_CALL_REFERENDA_KILL_V20 4
typedef struct {
    pd_ReferendumIndex_t index;
} pd_referenda_kill_V20_t;

#define PD_CALL_REFERENDA_NUDGE_REFERENDUM_V20 5
typedef struct {
    pd_ReferendumIndex_t index;
} pd_referenda_nudge_referendum_V20_t;

#define PD_CALL_REFERENDA_ONE_FEWER_DECIDING_V20 6
typedef struct {
    pd_TrackIdOf_t track;
} pd_referenda_one_fewer_deciding_V20_t;

#define PD_CALL_REFERENDA_REFUND_SUBMISSION_DEPOSIT_V20 7
typedef struct {
    pd_ReferendumIndex_t index;
} pd_referenda_refund_submission_deposit_V20_t;

#define PD_CALL_REFERENDA_SET_METADATA_V20 8
typedef struct {
    pd_ReferendumIndex_t index;
    pd_OptionPreimageHash_t maybe_hash;
} pd_referenda_set_metadata_V20_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_ADD_MEMBER_V20 0
typedef struct {
    pd_AccountIdLookupOfT_t who;
} pd_fellowshipcollective_add_member_V20_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_PROMOTE_MEMBER_V20 1
typedef struct {
    pd_AccountIdLookupOfT_t who;
} pd_fellowshipcollective_promote_member_V20_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_DEMOTE_MEMBER_V20 2
typedef struct {
    pd_AccountIdLookupOfT_t who;
} pd_fellowshipcollective_demote_member_V20_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_REMOVE_MEMBER_V20 3
typedef struct {
    pd_AccountIdLookupOfT_t who;
    pd_Rank_t min_rank;
} pd_fellowshipcollective_remove_member_V20_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_VOTE_V20 4
typedef struct {
    pd_PollIndexOf_t poll;
    pd_bool_t aye;
} pd_fellowshipcollective_vote_V20_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_CLEANUP_POLL_V20 5
typedef struct {
    pd_PollIndexOf_t poll_index;
    pd_u32_t max;
} pd_fellowshipcollective_cleanup_poll_V20_t;

#define PD_CALL_FELLOWSHIPREFERENDA_PLACE_DECISION_DEPOSIT_V20 1
typedef struct {
    pd_ReferendumIndex_t index;
} pd_fellowshipreferenda_place_decision_deposit_V20_t;

#define PD_CALL_FELLOWSHIPREFERENDA_REFUND_DECISION_DEPOSIT_V20 2
typedef struct {
    pd_ReferendumIndex_t index;
} pd_fellowshipreferenda_refund_decision_deposit_V20_t;

#define PD_CALL_FELLOWSHIPREFERENDA_CANCEL_V20 3
typedef struct {
    pd_ReferendumIndex_t index;
} pd_fellowshipreferenda_cancel_V20_t;

#define PD_CALL_FELLOWSHIPREFERENDA_KILL_V20 4
typedef struct {
    pd_ReferendumIndex_t index;
} pd_fellowshipreferenda_kill_V20_t;

#define PD_CALL_FELLOWSHIPREFERENDA_NUDGE_REFERENDUM_V20 5
typedef struct {
    pd_ReferendumIndex_t index;
} pd_fellowshipreferenda_nudge_referendum_V20_t;

#define PD_CALL_FELLOWSHIPREFERENDA_ONE_FEWER_DECIDING_V20 6
typedef struct {
    pd_TrackIdOf_t track;
} pd_fellowshipreferenda_one_fewer_deciding_V20_t;

#define PD_CALL_FELLOWSHIPREFERENDA_REFUND_SUBMISSION_DEPOSIT_V20 7
typedef struct {
    pd_ReferendumIndex_t index;
} pd_fellowshipreferenda_refund_submission_deposit_V20_t;

#define PD_CALL_FELLOWSHIPREFERENDA_SET_METADATA_V20 8
typedef struct {
    pd_ReferendumIndex_t index;
    pd_OptionPreimageHash_t maybe_hash;
} pd_fellowshipreferenda_set_metadata_V20_t;

#define PD_CALL_WHITELIST_WHITELIST_CALL_V20 0
typedef struct {
    pd_PreimageHash_t call_hash;
} pd_whitelist_whitelist_call_V20_t;

#define PD_CALL_WHITELIST_REMOVE_WHITELISTED_CALL_V20 1
typedef struct {
    pd_PreimageHash_t call_hash;
} pd_whitelist_remove_whitelisted_call_V20_t;

#define PD_CALL_WHITELIST_DISPATCH_WHITELISTED_CALL_V20 2
typedef struct {
    pd_PreimageHash_t call_hash;
    pd_u32_t call_encoded_len;
    pd_Weight_t call_weight_witness;
} pd_whitelist_dispatch_whitelisted_call_V20_t;

#define PD_CALL_WHITELIST_DISPATCH_WHITELISTED_CALL_WITH_PREIMAGE_V20 3
typedef struct {
    pd_Call_t call;
} pd_whitelist_dispatch_whitelisted_call_with_preimage_V20_t;
...
#define PD_CALL_SOCIETY_BID_V20 0
typedef struct {
    pd_BalanceOf_t amount;
} pd_society_bid_V20_t;

#define PD_CALL_SOCIETY_UNBID_V20 1
typedef struct {
    pd_u32_t pos;
} pd_society_unbid_V20_t;

#define PD_CALL_SOCIETY_VOUCH_V20 2
typedef struct {
    pd_AccountIdLookupOfT_t who;
    pd_BalanceOf_t amount;
    pd_BalanceOf_t tip;
} pd_society_vouch_V20_t;

#define PD_CALL_SOCIETY_UNVOUCH_V20 3
typedef struct {
    pd_u32_t pos;
} pd_society_unvouch_V20_t;

#define PD_CALL_SOCIETY_VOTE_V20 4
typedef struct {
    pd_AccountIdLookupOfT_t candidate;
    pd_bool_t approve;
} pd_society_vote_V20_t;

#define PD_CALL_SOCIETY_DEFENDER_VOTE_V20 5
typedef struct {
    pd_bool_t approve;
} pd_society_defender_vote_V20_t;

#define PD_CALL_SOCIETY_PAYOUT_V20 6
typedef struct {
} pd_society_payout_V20_t;

#define PD_CALL_SOCIETY_FOUND_V20 7
typedef struct {
    pd_AccountIdLookupOfT_t founder;
    pd_u32_t max_members;
    pd_Bytes_t rules;
} pd_society_found_V20_t;

#define PD_CALL_SOCIETY_UNFOUND_V20 8
typedef struct {
} pd_society_unfound_V20_t;

#define PD_CALL_SOCIETY_JUDGE_SUSPENDED_MEMBER_V20 9
typedef struct {
    pd_AccountIdLookupOfT_t who;
    pd_bool_t forgive;
} pd_society_judge_suspended_member_V20_t;

#define PD_CALL_SOCIETY_SET_MAX_MEMBERS_V20 11
typedef struct {
    pd_u32_t max;
} pd_society_set_max_members_V20_t;

#define PD_CALL_RECOVERY_SET_RECOVERED_V20 1
typedef struct {
    pd_AccountIdLookupOfT_t lost;
    pd_AccountIdLookupOfT_t rescuer;
} pd_recovery_set_recovered_V20_t;

#define PD_CALL_RECOVERY_INITIATE_RECOVERY_V20 3
typedef struct {
    pd_AccountIdLookupOfT_t account;
} pd_recovery_initiate_recovery_V20_t;

#define PD_CALL_RECOVERY_VOUCH_RECOVERY_V20 4
typedef struct {
    pd_AccountIdLookupOfT_t lost;
    pd_AccountIdLookupOfT_t rescuer;
} pd_recovery_vouch_recovery_V20_t;

#define PD_CALL_RECOVERY_CLAIM_RECOVERY_V20 5
typedef struct {
    pd_AccountIdLookupOfT_t account;
} pd_recovery_claim_recovery_V20_t;

#define PD_CALL_RECOVERY_CLOSE_RECOVERY_V20 6
typedef struct {
    pd_AccountIdLookupOfT_t rescuer;
} pd_recovery_close_recovery_V20_t;

#define PD_CALL_RECOVERY_REMOVE_RECOVERY_V20 7
typedef struct {
} pd_recovery_remove_recovery_V20_t;

#define PD_CALL_RECOVERY_CANCEL_RECOVERED_V20 8
typedef struct {
    pd_AccountIdLookupOfT_t account;
} pd_recovery_cancel_recovered_V20_t;
...
#define PD_CALL_NIS_PLACE_BID_V20 0
typedef struct {
    pd_Compactu128_t amount;
    pd_u32_t duration;
} pd_nis_place_bid_V20_t;

#define PD_CALL_NIS_RETRACT_BID_V20 1
typedef struct {
    pd_Compactu128_t amount;
    pd_u32_t duration;
} pd_nis_retract_bid_V20_t;

#define PD_CALL_NIS_FUND_DEFICIT_V20 2
typedef struct {
} pd_nis_fund_deficit_V20_t;

#define PD_CALL_NIS_THAW_PRIVATE_V20 3
typedef struct {
    pd_Compactu32_t index;
    pd_OptionPerquintill_t maybe_proportion;
} pd_nis_thaw_private_V20_t;

#define PD_CALL_NIS_THAW_COMMUNAL_V20 4
typedef struct {
    pd_Compactu32_t index;
} pd_nis_thaw_communal_V20_t;

#define PD_CALL_NIS_COMMUNIFY_V20 5
typedef struct {
    pd_Compactu32_t index;
} pd_nis_communify_V20_t;

#define PD_CALL_NIS_PRIVATIZE_V20 6
typedef struct {
    pd_Compactu32_t index;
} pd_nis_privatize_V20_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_TRANSFER_V20 0
typedef struct {
    pd_AccountIdLookupOfT_t dest;
    pd_Compactu128_t amount;
} pd_niscounterpartbalances_transfer_V20_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_SET_BALANCE_V20 1
typedef struct {
    pd_AccountIdLookupOfT_t who;
    pd_Compactu128_t new_free;
    pd_Compactu128_t new_reserved;
} pd_niscounterpartbalances_set_balance_V20_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_FORCE_TRANSFER_V20 2
typedef struct {
    pd_AccountIdLookupOfT_t source;
    pd_AccountIdLookupOfT_t dest;
    pd_Compactu128_t amount;
} pd_niscounterpartbalances_force_transfer_V20_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_TRANSFER_KEEP_ALIVE_V20 3
typedef struct {
    pd_AccountIdLookupOfT_t dest;
    pd_Compactu128_t amount;
} pd_niscounterpartbalances_transfer_keep_alive_V20_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_TRANSFER_ALL_V20 4
typedef struct {
    pd_AccountIdLookupOfT_t dest;
    pd_bool_t keep_alive;
} pd_niscounterpartbalances_transfer_all_V20_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_FORCE_UNRESERVE_V20 5
typedef struct {
    pd_AccountIdLookupOfT_t who;
    pd_Balance_t amount;
} pd_niscounterpartbalances_force_unreserve_V20_t;
...
#define PD_CALL_NOMINATIONPOOLS_BOND_EXTRA_OTHER_V20 14
typedef struct {
    pd_AccountIdLookupOfT_t member;
    pd_BondExtraBalanceOfT_t extra;
} pd_nominationpools_bond_extra_other_V20_t;

#define PD_CALL_NOMINATIONPOOLS_SET_CLAIM_PERMISSION_V20 15
typedef struct {
    pd_ClaimPermission_t permission;
} pd_nominationpools_set_claim_permission_V20_t;

#define PD_CALL_NOMINATIONPOOLS_CLAIM_PAYOUT_OTHER_V20 16
typedef struct {
    pd_AccountId_t other;
} pd_nominationpools_claim_payout_other_V20_t;
...
#define PD_CALL_CONFIGURATION_SET_DISPUTE_PERIOD_V20 14
typedef struct {
    pd_SessionIndex_t new_;
} pd_configuration_set_dispute_period_V20_t;
...
typedef union {
...
#ifdef SUBSTRATE_PARSER_FULL
#ifndef TARGET_NANOS
    pd_xcmpallet_teleport_assets_V20_t xcmpallet_teleport_assets_V20;
    ...
    pd_xcmpallet_limited_teleport_assets_V20_t xcmpallet_limited_teleport_assets_V20;
#endif
    ...
    pd_democracy_set_metadata_V20_t democracy_set_metadata_V20;
    ...
    pd_convictionvoting_vote_V20_t convictionvoting_vote_V20;
    pd_convictionvoting_delegate_V20_t convictionvoting_delegate_V20;
    pd_convictionvoting_undelegate_V20_t convictionvoting_undelegate_V20;
    pd_convictionvoting_unlock_V20_t convictionvoting_unlock_V20;
    pd_convictionvoting_remove_vote_V20_t convictionvoting_remove_vote_V20;
    pd_convictionvoting_remove_other_vote_V20_t convictionvoting_remove_other_vote_V20;
    pd_referenda_place_decision_deposit_V20_t referenda_place_decision_deposit_V20;
    pd_referenda_refund_decision_deposit_V20_t referenda_refund_decision_deposit_V20;
    pd_referenda_cancel_V20_t referenda_cancel_V20;
    pd_referenda_kill_V20_t referenda_kill_V20;
    pd_referenda_nudge_referendum_V20_t referenda_nudge_referendum_V20;
    pd_referenda_one_fewer_deciding_V20_t referenda_one_fewer_deciding_V20;
    pd_referenda_refund_submission_deposit_V20_t referenda_refund_submission_deposit_V20;
    pd_referenda_set_metadata_V20_t referenda_set_metadata_V20;
    pd_fellowshipcollective_add_member_V20_t fellowshipcollective_add_member_V20;
    pd_fellowshipcollective_promote_member_V20_t fellowshipcollective_promote_member_V20;
    pd_fellowshipcollective_demote_member_V20_t fellowshipcollective_demote_member_V20;
    pd_fellowshipcollective_remove_member_V20_t fellowshipcollective_remove_member_V20;
    pd_fellowshipcollective_vote_V20_t fellowshipcollective_vote_V20;
    pd_fellowshipcollective_cleanup_poll_V20_t fellowshipcollective_cleanup_poll_V20;
    pd_fellowshipreferenda_place_decision_deposit_V20_t fellowshipreferenda_place_decision_deposit_V20;
    pd_fellowshipreferenda_refund_decision_deposit_V20_t fellowshipreferenda_refund_decision_deposit_V20;
    pd_fellowshipreferenda_cancel_V20_t fellowshipreferenda_cancel_V20;
    pd_fellowshipreferenda_kill_V20_t fellowshipreferenda_kill_V20;
    pd_fellowshipreferenda_nudge_referendum_V20_t fellowshipreferenda_nudge_referendum_V20;
    pd_fellowshipreferenda_one_fewer_deciding_V20_t fellowshipreferenda_one_fewer_deciding_V20;
    pd_fellowshipreferenda_refund_submission_deposit_V20_t fellowshipreferenda_refund_submission_deposit_V20;
    pd_fellowshipreferenda_set_metadata_V20_t fellowshipreferenda_set_metadata_V20;
    pd_whitelist_whitelist_call_V20_t whitelist_whitelist_call_V20;
    pd_whitelist_remove_whitelisted_call_V20_t whitelist_remove_whitelisted_call_V20;
    pd_whitelist_dispatch_whitelisted_call_V20_t whitelist_dispatch_whitelisted_call_V20;
    pd_whitelist_dispatch_whitelisted_call_with_preimage_V20_t whitelist_dispatch_whitelisted_call_with_preimage_V20;
    ...
    pd_society_bid_V20_t society_bid_V20;
    pd_society_unbid_V20_t society_unbid_V20;
    pd_society_vouch_V20_t society_vouch_V20;
    pd_society_unvouch_V20_t society_unvouch_V20;
    pd_society_vote_V20_t society_vote_V20;
    pd_society_defender_vote_V20_t society_defender_vote_V20;
    pd_society_payout_V20_t society_payout_V20;
    pd_society_found_V20_t society_found_V20;
    pd_society_unfound_V20_t society_unfound_V20;
    pd_society_judge_suspended_member_V20_t society_judge_suspended_member_V20;
    pd_society_set_max_members_V20_t society_set_max_members_V20;
    pd_recovery_set_recovered_V20_t recovery_set_recovered_V20;
    pd_recovery_initiate_recovery_V20_t recovery_initiate_recovery_V20;
    pd_recovery_vouch_recovery_V20_t recovery_vouch_recovery_V20;
    pd_recovery_claim_recovery_V20_t recovery_claim_recovery_V20;
    pd_recovery_close_recovery_V20_t recovery_close_recovery_V20;
    pd_recovery_remove_recovery_V20_t recovery_remove_recovery_V20;
    pd_recovery_cancel_recovered_V20_t recovery_cancel_recovered_V20;
    ...
    pd_nis_place_bid_V20_t nis_place_bid_V20;
    pd_nis_retract_bid_V20_t nis_retract_bid_V20;
    pd_nis_fund_deficit_V20_t nis_fund_deficit_V20;
    pd_nis_thaw_private_V20_t nis_thaw_private_V20;
    pd_nis_thaw_communal_V20_t nis_thaw_communal_V20;
    pd_nis_communify_V20_t nis_communify_V20;
    pd_nis_privatize_V20_t nis_privatize_V20;
    pd_niscounterpartbalances_transfer_V20_t niscounterpartbalances_transfer_V20;
    pd_niscounterpartbalances_set_balance_V20_t niscounterpartbalances_set_balance_V20;
    pd_niscounterpartbalances_force_transfer_V20_t niscounterpartbalances_force_transfer_V20;
    pd_niscounterpartbalances_transfer_keep_alive_V20_t niscounterpartbalances_transfer_keep_alive_V20;
    pd_niscounterpartbalances_transfer_all_V20_t niscounterpartbalances_transfer_all_V20;
    pd_niscounterpartbalances_force_unreserve_V20_t niscounterpartbalances_force_unreserve_V20;
    ...
    pd_nominationpools_bond_extra_other_V20_t nominationpools_bond_extra_other_V20;
    pd_nominationpools_set_claim_permission_V20_t nominationpools_set_claim_permission_V20;
    pd_nominationpools_claim_payout_other_V20_t nominationpools_claim_payout_other_V20;
    ...
    pd_configuration_set_dispute_period_V20_t configuration_set_dispute_period_V20;
