...
__Z_INLINE parser_error_t _readMethod_utility_force_batch_V12(
    parser_context_t* c, pd_utility_force_batch_V12_t* m)
{
    CHECK_ERROR(_readVecCall(c, &m->calls))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_crowdloan_create_V12(
    parser_context_t* c, pd_crowdloan_create_V12_t* m)
{
    ...
    CHECK_ERROR(_readOptionMultiSigner_V12(c, &m->verifier))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_crowdloan_contribute_V12(
    parser_context_t* c, pd_crowdloan_contribute_V12_t* m)
{
    CHECK_ERROR(_readCompactu32(c, &m->index))
    CHECK_ERROR(_readCompactu128(c, &m->amount))
    CHECK_ERROR(_readOptionMultiSignature_V12(c, &m->signature))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_crowdloan_withdraw_V12(
    parser_context_t* c, pd_crowdloan_withdraw_V12_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_crowdloan_refund_V12(
    parser_context_t* c, pd_crowdloan_refund_V12_t* m)
{
    CHECK_ERROR(_readCompactu32(c, &m->index))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_crowdloan_dissolve_V12(
    parser_context_t* c, pd_crowdloan_dissolve_V12_t* m)
{
    CHECK_ERROR(_readCompactu32(c, &m->index))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_crowdloan_edit_V12(
    parser_context_t* c, pd_crowdloan_edit_V12_t* m)
{
    CHECK_ERROR(_readCompactu32(c, &m->index))
    CHECK_ERROR(_readCompactu128(c, &m->cap))
    CHECK_ERROR(_readCompactu32(c, &m->first_period))
...
__Z_INLINE parser_error_t _readMethod_crowdloan_add_memo_V12(
    parser_context_t* c, pd_crowdloan_add_memo_V12_t* m)
{
    CHECK_ERROR(_readParaId_V12(c, &m->index))
    CHECK_ERROR(_readVecu8(c, &m->memo))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_crowdloan_poke_V12(
    parser_context_t* c, pd_crowdloan_poke_V12_t* m)
{
    CHECK_ERROR(_readParaId_V12(c, &m->index))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_crowdloan_contribute_all_V12(
    parser_context_t* c, pd_crowdloan_contribute_all_V12_t* m)
{
    CHECK_ERROR(_readCompactu32(c, &m->index))
    CHECK_ERROR(_readOptionMultiSignature_V12(c, &m->signature))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_indices_transfer_V12(
    parser_context_t* c, pd_indices_transfer_V12_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_council_set_members_V12(
    parser_context_t* c, pd_council_set_members_V12_t* m)
{
    CHECK_ERROR(_readVecAccountId_V12(c, &m->new_members))
    CHECK_ERROR(_readOptionAccountId_V12(c, &m->prime))
    CHECK_ERROR(_readMemberCount_V12(c, &m->old_count))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_council_execute_V12(
    parser_context_t* c, pd_council_execute_V12_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_council_propose_V12(
    parser_context_t* c, pd_council_propose_V12_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_technicalcommittee_set_members_V12(
    parser_context_t* c, pd_technicalcommittee_set_members_V12_t* m)
{
    CHECK_ERROR(_readVecAccountId_V12(c, &m->new_members))
    CHECK_ERROR(_readOptionAccountId_V12(c, &m->prime))
    CHECK_ERROR(_readMemberCount_V12(c, &m->old_count))
...
__Z_INLINE parser_error_t _readMethod_technicalcommittee_execute_V12(
    parser_context_t* c, pd_technicalcommittee_execute_V12_t* m)
{
    CHECK_ERROR(_readProposal(c, &m->proposal))
    CHECK_ERROR(_readCompactu32(c, &m->length_bound))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_technicalcommittee_propose_V12(
    parser_context_t* c, pd_technicalcommittee_propose_V12_t* m)
{
    CHECK_ERROR(_readCompactu32(c, &m->threshold))
    CHECK_ERROR(_readProposal(c, &m->proposal))
    CHECK_ERROR(_readCompactu32(c, &m->length_bound))
...
__Z_INLINE parser_error_t _readMethod_treasury_spend_V12(
    parser_context_t* c, pd_treasury_spend_V12_t* m)
{
    CHECK_ERROR(_readCompactBalance(c, &m->amount))
    CHECK_ERROR(_readLookupasStaticLookupSource_V12(c, &m->beneficiary))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_treasury_remove_approval_V12(
    parser_context_t* c, pd_treasury_remove_approval_V12_t* m)
{
    CHECK_ERROR(_readCompactu32(c, &m->proposal_id))
    return parser_ok;
}
...
__Z_INLINE parser_error_t _readMethod_society_bid_V12(
    parser_context_t* c, pd_society_bid_V12_t* m)
{
    CHECK_ERROR(_readBalanceOf(c, &m->amount))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_society_unbid_V12(
    parser_context_t* c, pd_society_unbid_V12_t* m)
{
    CHECK_ERROR(_readu32(c, &m->pos))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_society_vouch_V12(
    parser_context_t* c, pd_society_vouch_V12_t* m)
{
    CHECK_ERROR(_readAccountId_V12(c, &m->who))
    CHECK_ERROR(_readBalanceOf(c, &m->amount))
...
__Z_INLINE parser_error_t _readMethod_society_unvouch_V12(
    parser_context_t* c, pd_society_unvouch_V12_t* m)
{
    CHECK_ERROR(_readu32(c, &m->pos))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_society_vote_V12(
    parser_context_t* c, pd_society_vote_V12_t* m)
{
    CHECK_ERROR(_readLookupasStaticLookupSource_V12(c, &m->candidate))
    CHECK_ERROR(_readbool(c, &m->approve))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_society_defender_vote_V12(
    parser_context_t* c, pd_society_defender_vote_V12_t* m)
{
    CHECK_ERROR(_readbool(c, &m->approve))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_society_payout_V12(
    parser_context_t* c, pd_society_payout_V12_t* m)
{
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_society_found_V12(
    parser_context_t* c, pd_society_found_V12_t* m)
{
    CHECK_ERROR(_readAccountId_V12(c, &m->founder))
    CHECK_ERROR(_readu32(c, &m->max_members))
    CHECK_ERROR(_readBytes(c, &m->rules))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_society_unfound_V12(
    parser_context_t* c, pd_society_unfound_V12_t* m)
{
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_society_judge_suspended_member_V12(
    parser_context_t* c, pd_society_judge_suspended_member_V12_t* m)
{
    CHECK_ERROR(_readAccountId_V12(c, &m->who))
...
__Z_INLINE parser_error_t _readMethod_society_set_max_members_V12(
    parser_context_t* c, pd_society_set_max_members_V12_t* m)
{
    CHECK_ERROR(_readu32(c, &m->max))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_recovery_set_recovered_V12(
    parser_context_t* c, pd_recovery_set_recovered_V12_t* m)
{
    CHECK_ERROR(_readAccountId_V12(c, &m->lost))
    CHECK_ERROR(_readAccountId_V12(c, &m->rescuer))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_recovery_initiate_recovery_V12(
    parser_context_t* c, pd_recovery_initiate_recovery_V12_t* m)
{
    CHECK_ERROR(_readAccountId_V12(c, &m->account))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_recovery_vouch_recovery_V12(
    parser_context_t* c, pd_recovery_vouch_recovery_V12_t* m)
{
    CHECK_ERROR(_readAccountId_V12(c, &m->lost))
    CHECK_ERROR(_readAccountId_V12(c, &m->rescuer))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_recovery_claim_recovery_V12(
    parser_context_t* c, pd_recovery_claim_recovery_V12_t* m)
{
    CHECK_ERROR(_readAccountId_V12(c, &m->account))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_recovery_close_recovery_V12(
    parser_context_t* c, pd_recovery_close_recovery_V12_t* m)
{
    CHECK_ERROR(_readAccountId_V12(c, &m->rescuer))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_recovery_remove_recovery_V12(
    parser_context_t* c, pd_recovery_remove_recovery_V12_t* m)
{
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_recovery_cancel_recovered_V12(
    parser_context_t* c, pd_recovery_cancel_recovered_V12_t* m)
{
    CHECK_ERROR(_readAccountId_V12(c, &m->account))
    return parser_ok;
}
...
__Z_INLINE parser_error_t _readMethod_vesting_vested_transfer_V12(
    parser_context_t* c, pd_vesting_vested_transfer_V12_t* m)
{
    CHECK_ERROR(_readLookupasStaticLookupSource_V12(c, &m->target))
    CHECK_ERROR(_readVestingInfo_V12(c, &m->schedule))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_vesting_force_vested_transfer_V12(
    parser_context_t* c, pd_vesting_force_vested_transfer_V12_t* m)
{
    CHECK_ERROR(_readLookupasStaticLookupSource_V12(c, &m->source))
    CHECK_ERROR(_readLookupasStaticLookupSource_V12(c, &m->target))
    CHECK_ERROR(_readVestingInfo_V12(c, &m->schedule))
...
__Z_INLINE parser_error_t _readMethod_gilt_place_bid_V12(
    parser_context_t* c, pd_gilt_place_bid_V12_t* m)
{
    CHECK_ERROR(_readCompactBalance(c, &m->amount))
...
__Z_INLINE parser_error_t _readMethod_gilt_retract_bid_V12(
    parser_context_t* c, pd_gilt_retract_bid_V12_t* m)
{
    CHECK_ERROR(_readCompactBalance(c, &m->amount))
    CHECK_ERROR(_readu32(c, &m->duration))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_gilt_set_target_V12(
    parser_context_t* c, pd_gilt_set_target_V12_t* m)
{
    CHECK_ERROR(_readCompactu64(c, &m->target))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_gilt_thaw_V12(
    parser_context_t* c, pd_gilt_thaw_V12_t* m)
{
    CHECK_ERROR(_readCompactu32(c, &m->index))
    return parser_ok;
}
...
__Z_INLINE parser_error_t _readMethod_nominationpools_join_V12(
    parser_context_t* c, pd_nominationpools_join_V12_t* m)
{
    CHECK_ERROR(_readCompactu128(c, &m->amount))
    CHECK_ERROR(_readPoolId_V12(c, &m->pool_id))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_nominationpools_bond_extra_V12(
    parser_context_t* c, pd_nominationpools_bond_extra_V12_t* m)
{
    CHECK_ERROR(_readBondExtraBalanceOfT_V12(c, &m->extra))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_nominationpools_claim_payout_V12(
    parser_context_t* c, pd_nominationpools_claim_payout_V12_t* m)
{
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_nominationpools_unbond_V12(
    parser_context_t* c, pd_nominationpools_unbond_V12_t* m)
{
    CHECK_ERROR(_readAccountId_V12(c, &m->member_account))
    CHECK_ERROR(_readCompactu128(c, &m->unbonding_points))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_nominationpools_pool_withdraw_unbonded_V12(
    parser_context_t* c, pd_nominationpools_pool_withdraw_unbonded_V12_t* m)
{
    CHECK_ERROR(_readPoolId_V12(c, &m->pool_id))
    CHECK_ERROR(_readu32(c, &m->num_slashing_spans))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_nominationpools_withdraw_unbonded_V12(
    parser_context_t* c, pd_nominationpools_withdraw_unbonded_V12_t* m)
{
    CHECK_ERROR(_readAccountId_V12(c, &m->member_account))
    CHECK_ERROR(_readu32(c, &m->num_slashing_spans))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_nominationpools_create_V12(
    parser_context_t* c, pd_nominationpools_create_V12_t* m)
{
    CHECK_ERROR(_readCompactu128(c, &m->amount))
    CHECK_ERROR(_readAccountId_V12(c, &m->root))
    CHECK_ERROR(_readAccountId_V12(c, &m->nominator))
    CHECK_ERROR(_readAccountId_V12(c, &m->state_toggler))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_nominationpools_nominate_V12(
    parser_context_t* c, pd_nominationpools_nominate_V12_t* m)
{
    CHECK_ERROR(_readPoolId_V12(c, &m->pool_id))
    CHECK_ERROR(_readVecAccountId_V12(c, &m->validators))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_nominationpools_set_state_V12(
    parser_context_t* c, pd_nominationpools_set_state_V12_t* m)
{
    CHECK_ERROR(_readPoolId_V12(c, &m->pool_id))
    CHECK_ERROR(_readPoolState_V12(c, &m->state))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_nominationpools_set_metadata_V12(
    parser_context_t* c, pd_nominationpools_set_metadata_V12_t* m)
{
    CHECK_ERROR(_readPoolId_V12(c, &m->pool_id))
...
__Z_INLINE parser_error_t _readMethod_nominationpools_set_configs_V12(
    parser_context_t* c, pd_nominationpools_set_configs_V12_t* m)
{
    CHECK_ERROR(_readConfigOpBalanceOfT_V12(c, &m->min_join_bond))
    CHECK_ERROR(_readConfigOpBalanceOfT_V12(c, &m->min_create_bond))
    CHECK_ERROR(_readConfigOpu32_V12(c, &m->max_pools))
    CHECK_ERROR(_readConfigOpu32_V12(c, &m->max_members))
    CHECK_ERROR(_readConfigOpu32_V12(c, &m->max_members_per_pool))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_nominationpools_update_roles_V12(
    parser_context_t* c, pd_nominationpools_update_roles_V12_t* m)
{
    CHECK_ERROR(_readPoolId_V12(c, &m->pool_id))
    CHECK_ERROR(_readConfigOpAccountId_V12(c, &m->new_root))
    CHECK_ERROR(_readConfigOpAccountId_V12(c, &m->new_nominator))
    CHECK_ERROR(_readConfigOpAccountId_V12(c, &m->new_state_toggler))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_nominationpools_chill_V12(
    parser_context_t* c, pd_nominationpools_chill_V12_t* m)
{
    CHECK_ERROR(_readPoolId_V12(c, &m->pool_id))
    return parser_ok;
}
...
__Z_INLINE parser_error_t _readMethod_configuration_set_dispute_period_V12(
    parser_context_t* c, pd_configuration_set_dispute_period_V12_t* m)
{
    ...
    pd_Method_V12_t* method)
{
    ...
    case 6148: /* module 24 call 4 */
        CHECK_ERROR(_readMethod_utility_force_batch_V12(c, &method->basic.utility_force_batch_V12))
        break;
    case 18688: /* module 73 call 0 */
        CHECK_ERROR(_readMethod_crowdloan_create_V12(c, &method->basic.crowdloan_create_V12))
        break;
    case 18689: /* module 73 call 1 */
        CHECK_ERROR(_readMethod_crowdloan_contribute_V12(c, &method->basic.crowdloan_contribute_V12))
        break;
    case 18690: /* module 73 call 2 */
        CHECK_ERROR(_readMethod_crowdloan_withdraw_V12(c, &method->basic.crowdloan_withdraw_V12))
        break;
    case 18691: /* module 73 call 3 */
        CHECK_ERROR(_readMethod_crowdloan_refund_V12(c, &method->basic.crowdloan_refund_V12))
        break;
    case 18692: /* module 73 call 4 */
        CHECK_ERROR(_readMethod_crowdloan_dissolve_V12(c, &method->basic.crowdloan_dissolve_V12))
        break;
    case 18693: /* module 73 call 5 */
        CHECK_ERROR(_readMethod_crowdloan_edit_V12(c, &method->basic.crowdloan_edit_V12))
        break;
    case 18694: /* module 73 call 6 */
        CHECK_ERROR(_readMethod_crowdloan_add_memo_V12(c, &method->basic.crowdloan_add_memo_V12))
        break;
    case 18695: /* module 73 call 7 */
        CHECK_ERROR(_readMethod_crowdloan_poke_V12(c, &method->basic.crowdloan_poke_V12))
        break;
    case 18696: /* module 73 call 8 */
        CHECK_ERROR(_readMethod_crowdloan_contribute_all_V12(c, &method->basic.crowdloan_contribute_all_V12))
        break;
    ...
    case 769: /* module 3 call 1 */
        CHECK_ERROR(_readMethod_indices_transfer_V12(c, &method->basic.indices_transfer_V12))
        break;
    ...
    case 3328: /* module 13 call 0 */
        CHECK_ERROR(_readMethod_democracy_propose_V12(c, &method->nested.democracy_propose_V12))
        break;
    case 3329: /* module 13 call 1 */
        CHECK_ERROR(_readMethod_democracy_second_V12(c, &method->nested.democracy_second_V12))
        break;
    case 3330: /* module 13 call 2 */
        CHECK_ERROR(_readMethod_democracy_vote_V12(c, &method->nested.democracy_vote_V12))
        break;
    case 3331: /* module 13 call 3 */
        CHECK_ERROR(_readMethod_democracy_emergency_cancel_V12(c, &method->nested.democracy_emergency_cancel_V12))
        break;
    case 3332: /* module 13 call 4 */
        CHECK_ERROR(_readMethod_democracy_external_propose_V12(c, &method->nested.democracy_external_propose_V12))
        break;
    case 3333: /* module 13 call 5 */
        CHECK_ERROR(_readMethod_democracy_external_propose_majority_V12(c, &method->nested.democracy_external_propose_majority_V12))
        break;
    case 3334: /* module 13 call 6 */
        CHECK_ERROR(_readMethod_democracy_external_propose_default_V12(c, &method->nested.democracy_external_propose_default_V12))
        break;
    case 3335: /* module 13 call 7 */
        CHECK_ERROR(_readMethod_democracy_fast_track_V12(c, &method->nested.democracy_fast_track_V12))
        break;
    case 3336: /* module 13 call 8 */
        CHECK_ERROR(_readMethod_democracy_veto_external_V12(c, &method->nested.democracy_veto_external_V12))
        break;
    case 3337: /* module 13 call 9 */
        CHECK_ERROR(_readMethod_democracy_cancel_referendum_V12(c, &method->nested.democracy_cancel_referendum_V12))
        break;
    case 3338: /* module 13 call 10 */
        CHECK_ERROR(_readMethod_democracy_cancel_queued_V12(c, &method->nested.democracy_cancel_queued_V12))
        break;
    case 3339: /* module 13 call 11 */
        CHECK_ERROR(_readMethod_democracy_delegate_V12(c, &method->nested.democracy_delegate_V12))
        break;
    case 3340: /* module 13 call 12 */
        CHECK_ERROR(_readMethod_democracy_undelegate_V12(c, &method->nested.democracy_undelegate_V12))
        break;
    case 3341: /* module 13 call 13 */
        CHECK_ERROR(_readMethod_democracy_clear_public_proposals_V12(c, &method->nested.democracy_clear_public_proposals_V12))
        break;
    ...
    case 3346: /* module 13 call 18 */
        CHECK_ERROR(_readMethod_democracy_reap_preimage_V12(c, &method->nested.democracy_reap_preimage_V12))
        break;
    case 3347: /* module 13 call 19 */
        CHECK_ERROR(_readMethod_democracy_unlock_V12(c, &method->nested.democracy_unlock_V12))
        break;
    case 3348: /* module 13 call 20 */
        CHECK_ERROR(_readMethod_democracy_remove_vote_V12(c, &method->nested.democracy_remove_vote_V12))
        break;
    case 3349: /* module 13 call 21 */
        CHECK_ERROR(_readMethod_democracy_remove_other_vote_V12(c, &method->nested.democracy_remove_other_vote_V12))
        break;
    case 3350: /* module 13 call 22 */
        CHECK_ERROR(_readMethod_democracy_enact_proposal_V12(c, &method->nested.democracy_enact_proposal_V12))
        break;
    case 3352: /* module 13 call 24 */
        CHECK_ERROR(_readMethod_democracy_cancel_proposal_V12(c, &method->nested.democracy_cancel_proposal_V12))
        break;
    case 3584: /* module 14 call 0 */
        CHECK_ERROR(_readMethod_council_set_members_V12(c, &method->basic.council_set_members_V12))
        break;
    case 3585: /* module 14 call 1 */
        CHECK_ERROR(_readMethod_council_execute_V12(c, &method->basic.council_execute_V12))
        break;
    case 3586: /* module 14 call 2 */
        CHECK_ERROR(_readMethod_council_propose_V12(c, &method->basic.council_propose_V12))
        break;
    ...
    case 3840: /* module 15 call 0 */
        CHECK_ERROR(_readMethod_technicalcommittee_set_members_V12(c, &method->basic.technicalcommittee_set_members_V12))
        break;
    case 3841: /* module 15 call 1 */
        CHECK_ERROR(_readMethod_technicalcommittee_execute_V12(c, &method->basic.technicalcommittee_execute_V12))
        break;
    case 3842: /* module 15 call 2 */
        CHECK_ERROR(_readMethod_technicalcommittee_propose_V12(c, &method->basic.technicalcommittee_propose_V12))
        break;
    ...
    case 4611: /* module 18 call 3 */
        CHECK_ERROR(_readMethod_treasury_spend_V12(c, &method->basic.treasury_spend_V12))
        break;
    case 4612: /* module 18 call 4 */
        CHECK_ERROR(_readMethod_treasury_remove_approval_V12(c, &method->basic.treasury_remove_approval_V12))
        break;
    ...
    case 6656: /* module 26 call 0 */
        CHECK_ERROR(_readMethod_society_bid_V12(c, &method->basic.society_bid_V12))
        break;
    case 6657: /* module 26 call 1 */
        CHECK_ERROR(_readMethod_society_unbid_V12(c, &method->basic.society_unbid_V12))
        break;
    case 6658: /* module 26 call 2 */
        CHECK_ERROR(_readMethod_society_vouch_V12(c, &method->basic.society_vouch_V12))
        break;
    case 6659: /* module 26 call 3 */
        CHECK_ERROR(_readMethod_society_unvouch_V12(c, &method->basic.society_unvouch_V12))
        break;
    case 6660: /* module 26 call 4 */
        CHECK_ERROR(_readMethod_society_vote_V12(c, &method->basic.society_vote_V12))
        break;
    case 6661: /* module 26 call 5 */
        CHECK_ERROR(_readMethod_society_defender_vote_V12(c, &method->basic.society_defender_vote_V12))
        break;
    case 6662: /* module 26 call 6 */
        CHECK_ERROR(_readMethod_society_payout_V12(c, &method->basic.society_payout_V12))
        break;
    case 6663: /* module 26 call 7 */
        CHECK_ERROR(_readMethod_society_found_V12(c, &method->basic.society_found_V12))
        break;
    case 6664: /* module 26 call 8 */
        CHECK_ERROR(_readMethod_society_unfound_V12(c, &method->basic.society_unfound_V12))
        break;
    case 6665: /* module 26 call 9 */
        CHECK_ERROR(_readMethod_society_judge_suspended_member_V12(c, &method->basic.society_judge_suspended_member_V12))
        break;
    case 6667: /* module 26 call 11 */
        CHECK_ERROR(_readMethod_society_set_max_members_V12(c, &method->basic.society_set_max_members_V12))
        break;
    case 6913: /* module 27 call 1 */
        CHECK_ERROR(_readMethod_recovery_set_recovered_V12(c, &method->basic.recovery_set_recovered_V12))
        break;
    case 6915: /* module 27 call 3 */
        CHECK_ERROR(_readMethod_recovery_initiate_recovery_V12(c, &method->basic.recovery_initiate_recovery_V12))
        break;
    case 6916: /* module 27 call 4 */
        CHECK_ERROR(_readMethod_recovery_vouch_recovery_V12(c, &method->basic.recovery_vouch_recovery_V12))
        break;
    case 6917: /* module 27 call 5 */
        CHECK_ERROR(_readMethod_recovery_claim_recovery_V12(c, &method->basic.recovery_claim_recovery_V12))
        break;
    case 6918: /* module 27 call 6 */
        CHECK_ERROR(_readMethod_recovery_close_recovery_V12(c, &method->basic.recovery_close_recovery_V12))
        break;
    case 6919: /* module 27 call 7 */
        CHECK_ERROR(_readMethod_recovery_remove_recovery_V12(c, &method->basic.recovery_remove_recovery_V12))
        break;
    case 6920: /* module 27 call 8 */
        CHECK_ERROR(_readMethod_recovery_cancel_recovered_V12(c, &method->basic.recovery_cancel_recovered_V12))
        break;
    ...
    case 7170: /* module 28 call 2 */
        CHECK_ERROR(_readMethod_vesting_vested_transfer_V12(c, &method->basic.vesting_vested_transfer_V12))
        break;
    case 7171: /* module 28 call 3 */
        CHECK_ERROR(_readMethod_vesting_force_vested_transfer_V12(c, &method->basic.vesting_force_vested_transfer_V12))
        break;
    ...
    case 9728: /* module 38 call 0 */
        CHECK_ERROR(_readMethod_gilt_place_bid_V12(c, &method->basic.gilt_place_bid_V12))
        break;
    case 9729: /* module 38 call 1 */
        CHECK_ERROR(_readMethod_gilt_retract_bid_V12(c, &method->basic.gilt_retract_bid_V12))
        break;
    case 9730: /* module 38 call 2 */
        CHECK_ERROR(_readMethod_gilt_set_target_V12(c, &method->basic.gilt_set_target_V12))
        break;
    case 9731: /* module 38 call 3 */
        CHECK_ERROR(_readMethod_gilt_thaw_V12(c, &method->basic.gilt_thaw_V12))
        break;
    ...
    case 10496: /* module 41 call 0 */
        CHECK_ERROR(_readMethod_nominationpools_join_V12(c, &method->basic.nominationpools_join_V12))
        break;
    case 10497: /* module 41 call 1 */
        CHECK_ERROR(_readMethod_nominationpools_bond_extra_V12(c, &method->basic.nominationpools_bond_extra_V12))
        break;
    case 10498: /* module 41 call 2 */
        CHECK_ERROR(_readMethod_nominationpools_claim_payout_V12(c, &method->basic.nominationpools_claim_payout_V12))
        break;
    case 10499: /* module 41 call 3 */
        CHECK_ERROR(_readMethod_nominationpools_unbond_V12(c, &method->basic.nominationpools_unbond_V12))
        break;
    case 10500: /* module 41 call 4 */
        CHECK_ERROR(_readMethod_nominationpools_pool_withdraw_unbonded_V12(c, &method->basic.nominationpools_pool_withdraw_unbonded_V12))
        break;
    case 10501: /* module 41 call 5 */
        CHECK_ERROR(_readMethod_nominationpools_withdraw_unbonded_V12(c, &method->basic.nominationpools_withdraw_unbonded_V12))
        break;
    case 10502: /* module 41 call 6 */
        CHECK_ERROR(_readMethod_nominationpools_create_V12(c, &method->basic.nominationpools_create_V12))
        break;
    case 10503: /* module 41 call 7 */
        CHECK_ERROR(_readMethod_nominationpools_nominate_V12(c, &method->basic.nominationpools_nominate_V12))
        break;
    case 10504: /* module 41 call 8 */
        CHECK_ERROR(_readMethod_nominationpools_set_state_V12(c, &method->basic.nominationpools_set_state_V12))
        break;
    case 10505: /* module 41 call 9 */
        CHECK_ERROR(_readMethod_nominationpools_set_metadata_V12(c, &method->basic.nominationpools_set_metadata_V12))
        break;
    case 10506: /* module 41 call 10 */
        CHECK_ERROR(_readMethod_nominationpools_set_configs_V12(c, &method->basic.nominationpools_set_configs_V12))
        break;
    case 10507: /* module 41 call 11 */
        CHECK_ERROR(_readMethod_nominationpools_update_roles_V12(c, &method->basic.nominationpools_update_roles_V12))
        break;
    case 10508: /* module 41 call 12 */
        CHECK_ERROR(_readMethod_nominationpools_chill_V12(c, &method->basic.nominationpools_chill_V12))
        break;
    ...
    case 13070: /* module 51 call 14 */
        CHECK_ERROR(_readMethod_configuration_set_dispute_period_V12(c, &method->basic.configuration_set_dispute_period_V12))
        break;
    ...
    uint8_t pageIdx, uint8_t* pageCount)
{
    ...
    case 6148: /* module 24 call 4 */
        switch (itemIdx) {
        case 0: /* utility_force_batch_V12 - calls */;
            return _toStringVecCall(
                &m->basic.utility_force_batch_V12.calls,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 18688: /* module 73 call 0 */
        switch (itemIdx) {
        case 0: /* crowdloan_create_V12 - index */;
            return _toStringCompactu32(
                &m->basic.crowdloan_create_V12.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* crowdloan_create_V12 - cap */;
            return _toStringCompactu128(
                &m->basic.crowdloan_create_V12.cap,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* crowdloan_create_V12 - first_period */;
            return _toStringCompactu32(
                &m->basic.crowdloan_create_V12.first_period,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* crowdloan_create_V12 - last_period */;
            return _toStringCompactu32(
                &m->basic.crowdloan_create_V12.last_period,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* crowdloan_create_V12 - end */;
            return _toStringCompactu32(
                &m->basic.crowdloan_create_V12.end,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* crowdloan_create_V12 - verifier */;
            return _toStringOptionMultiSigner_V12(
                &m->basic.crowdloan_create_V12.verifier,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 18689: /* module 73 call 1 */
        switch (itemIdx) {
        case 0: /* crowdloan_contribute_V12 - index */;
            return _toStringCompactu32(
                &m->basic.crowdloan_contribute_V12.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* crowdloan_contribute_V12 - amount */;
            return _toStringCompactu128(
                &m->basic.crowdloan_contribute_V12.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* crowdloan_contribute_V12 - signature */;
            return _toStringOptionMultiSignature_V12(
                &m->basic.crowdloan_contribute_V12.signature,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 18690: /* module 73 call 2 */
        switch (itemIdx) {
        case 0: /* crowdloan_withdraw_V12 - who */;
            return _toStringAccountId_V12(
                &m->basic.crowdloan_withdraw_V12.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* crowdloan_withdraw_V12 - index */;
            return _toStringCompactu32(
                &m->basic.crowdloan_withdraw_V12.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 18691: /* module 73 call 3 */
        switch (itemIdx) {
        case 0: /* crowdloan_refund_V12 - index */;
            return _toStringCompactu32(
                &m->basic.crowdloan_refund_V12.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 18692: /* module 73 call 4 */
        switch (itemIdx) {
        case 0: /* crowdloan_dissolve_V12 - index */;
            return _toStringCompactu32(
                &m->basic.crowdloan_dissolve_V12.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 18693: /* module 73 call 5 */
        switch (itemIdx) {
        case 0: /* crowdloan_edit_V12 - index */;
            return _toStringCompactu32(
                &m->basic.crowdloan_edit_V12.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* crowdloan_edit_V12 - cap */;
            return _toStringCompactu128(
                &m->basic.crowdloan_edit_V12.cap,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* crowdloan_edit_V12 - first_period */;
            return _toStringCompactu32(
                &m->basic.crowdloan_edit_V12.first_period,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* crowdloan_edit_V12 - last_period */;
            return _toStringCompactu32(
                &m->basic.crowdloan_edit_V12.last_period,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* crowdloan_edit_V12 - end */;
            return _toStringCompactu32(
                &m->basic.crowdloan_edit_V12.end,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* crowdloan_edit_V12 - verifier */;
            return _toStringOptionMultiSigner_V12(
                &m->basic.crowdloan_edit_V12.verifier,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 18694: /* module 73 call 6 */
        switch (itemIdx) {
        case 0: /* crowdloan_add_memo_V12 - index */;
            return _toStringParaId_V12(
                &m->basic.crowdloan_add_memo_V12.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* crowdloan_add_memo_V12 - memo */;
            return _toStringVecu8(
                &m->basic.crowdloan_add_memo_V12.memo,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 18695: /* module 73 call 7 */
        switch (itemIdx) {
        case 0: /* crowdloan_poke_V12 - index */;
            return _toStringParaId_V12(
                &m->basic.crowdloan_poke_V12.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 18696: /* module 73 call 8 */
        switch (itemIdx) {
        case 0: /* crowdloan_contribute_all_V12 - index */;
            return _toStringCompactu32(
                &m->basic.crowdloan_contribute_all_V12.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* crowdloan_contribute_all_V12 - signature */;
            return _toStringOptionMultiSignature_V12(
                &m->basic.crowdloan_contribute_all_V12.signature,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 769: /* module 3 call 1 */
        switch (itemIdx) {
        case 0: /* indices_transfer_V12 - new_ */;
            return _toStringAccountId_V12(
                &m->basic.indices_transfer_V12.new_,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* indices_transfer_V12 - index */;
            return _toStringAccountIndex_V12(
                &m->basic.indices_transfer_V12.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3328: /* module 13 call 0 */
        ...
        case 0: /* democracy_propose_V12 - proposal_hash */;
            return _toStringHash(
                &m->nested.democracy_propose_V12.proposal_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* democracy_propose_V12 - amount */;
            return _toStringCompactBalance(
                &m->nested.democracy_propose_V12.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3329: /* module 13 call 1 */
        ...
        case 0: /* democracy_second_V12 - proposal */;
            return _toStringCompactu32(
                &m->nested.democracy_second_V12.proposal,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* democracy_second_V12 - seconds_upper_bound */;
            return _toStringCompactu32(
                &m->nested.democracy_second_V12.seconds_upper_bound,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3330: /* module 13 call 2 */
        ...
        case 0: /* democracy_vote_V12 - ref_index */;
            return _toStringCompactu32(
                &m->nested.democracy_vote_V12.ref_index,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* democracy_vote_V12 - vote */;
            return _toStringAccountVote_V12(
                &m->nested.democracy_vote_V12.vote,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3331: /* module 13 call 3 */
        ...
        case 0: /* democracy_emergency_cancel_V12 - ref_index */;
            return _toStringReferendumIndex_V12(
                &m->nested.democracy_emergency_cancel_V12.ref_index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3332: /* module 13 call 4 */
        ...
        case 0: /* democracy_external_propose_V12 - proposal_hash */;
            return _toStringHash(
                &m->nested.democracy_external_propose_V12.proposal_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3333: /* module 13 call 5 */
        ...
        case 0: /* democracy_external_propose_majority_V12 - proposal_hash */;
            return _toStringHash(
                &m->nested.democracy_external_propose_majority_V12.proposal_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3334: /* module 13 call 6 */
        ...
        case 0: /* democracy_external_propose_default_V12 - proposal_hash */;
            return _toStringHash(
                &m->nested.democracy_external_propose_default_V12.proposal_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3335: /* module 13 call 7 */
        ...
        case 0: /* democracy_fast_track_V12 - proposal_hash */;
            return _toStringHash(
                &m->nested.democracy_fast_track_V12.proposal_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* democracy_fast_track_V12 - voting_period */;
            return _toStringBlockNumber(
                &m->nested.democracy_fast_track_V12.voting_period,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* democracy_fast_track_V12 - delay */;
            return _toStringBlockNumber(
                &m->nested.democracy_fast_track_V12.delay,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3336: /* module 13 call 8 */
        ...
        case 0: /* democracy_veto_external_V12 - proposal_hash */;
            return _toStringHash(
                &m->nested.democracy_veto_external_V12.proposal_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3337: /* module 13 call 9 */
        ...
        case 0: /* democracy_cancel_referendum_V12 - ref_index */;
            return _toStringCompactu32(
                &m->nested.democracy_cancel_referendum_V12.ref_index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3338: /* module 13 call 10 */
        ...
        case 0: /* democracy_cancel_queued_V12 - which */;
            return _toStringReferendumIndex_V12(
                &m->nested.democracy_cancel_queued_V12.which,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3339: /* module 13 call 11 */
        ...
        case 0: /* democracy_delegate_V12 - to */;
            return _toStringAccountId_V12(
                &m->nested.democracy_delegate_V12.to,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* democracy_delegate_V12 - conviction */;
            return _toStringConviction_V12(
                &m->nested.democracy_delegate_V12.conviction,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* democracy_delegate_V12 - balance */;
            return _toStringBalance(
                &m->nested.democracy_delegate_V12.balance,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3346: /* module 13 call 18 */
        ...
        case 0: /* democracy_reap_preimage_V12 - proposal_hash */;
            return _toStringHash(
                &m->nested.democracy_reap_preimage_V12.proposal_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* democracy_reap_preimage_V12 - proposal_len_upper_bound */;
            return _toStringCompactu32(
                &m->nested.democracy_reap_preimage_V12.proposal_len_upper_bound,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3347: /* module 13 call 19 */
        ...
        case 0: /* democracy_unlock_V12 - target */;
            return _toStringAccountId_V12(
                &m->nested.democracy_unlock_V12.target,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3348: /* module 13 call 20 */
        ...
        case 0: /* democracy_remove_vote_V12 - index */;
            return _toStringReferendumIndex_V12(
                &m->nested.democracy_remove_vote_V12.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3349: /* module 13 call 21 */
        ...
        case 0: /* democracy_remove_other_vote_V12 - target */;
            return _toStringAccountId_V12(
                &m->nested.democracy_remove_other_vote_V12.target,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* democracy_remove_other_vote_V12 - index */;
            return _toStringReferendumIndex_V12(
                &m->nested.democracy_remove_other_vote_V12.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3350: /* module 13 call 22 */
        ...
        case 0: /* democracy_enact_proposal_V12 - proposal_hash */;
            return _toStringHash(
                &m->nested.democracy_enact_proposal_V12.proposal_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* democracy_enact_proposal_V12 - index */;
            return _toStringReferendumIndex_V12(
                &m->nested.democracy_enact_proposal_V12.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3352: /* module 13 call 24 */
        ...
        case 0: /* democracy_cancel_proposal_V12 - prop_index */;
            return _toStringCompactu32(
                &m->nested.democracy_cancel_proposal_V12.prop_index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3584: /* module 14 call 0 */
        switch (itemIdx) {
        case 0: /* council_set_members_V12 - new_members */;
            return _toStringVecAccountId_V12(
                &m->basic.council_set_members_V12.new_members,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* council_set_members_V12 - prime */;
            return _toStringOptionAccountId_V12(
                &m->basic.council_set_members_V12.prime,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* council_set_members_V12 - old_count */;
            return _toStringMemberCount_V12(
                &m->basic.council_set_members_V12.old_count,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3585: /* module 14 call 1 */
        switch (itemIdx) {
        case 0: /* council_execute_V12 - proposal */;
            return _toStringProposal(
                &m->basic.council_execute_V12.proposal,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* council_execute_V12 - length_bound */;
            return _toStringCompactu32(
                &m->basic.council_execute_V12.length_bound,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3586: /* module 14 call 2 */
        switch (itemIdx) {
        case 0: /* council_propose_V12 - threshold */;
            return _toStringCompactu32(
                &m->basic.council_propose_V12.threshold,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* council_propose_V12 - proposal */;
            return _toStringProposal(
                &m->basic.council_propose_V12.proposal,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* council_propose_V12 - length_bound */;
            return _toStringCompactu32(
                &m->basic.council_propose_V12.length_bound,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3840: /* module 15 call 0 */
        switch (itemIdx) {
        case 0: /* technicalcommittee_set_members_V12 - new_members */;
            return _toStringVecAccountId_V12(
                &m->basic.technicalcommittee_set_members_V12.new_members,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* technicalcommittee_set_members_V12 - prime */;
            return _toStringOptionAccountId_V12(
                &m->basic.technicalcommittee_set_members_V12.prime,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* technicalcommittee_set_members_V12 - old_count */;
            return _toStringMemberCount_V12(
                &m->basic.technicalcommittee_set_members_V12.old_count,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3841: /* module 15 call 1 */
        switch (itemIdx) {
        case 0: /* technicalcommittee_execute_V12 - proposal */;
            return _toStringProposal(
                &m->basic.technicalcommittee_execute_V12.proposal,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* technicalcommittee_execute_V12 - length_bound */;
            return _toStringCompactu32(
                &m->basic.technicalcommittee_execute_V12.length_bound,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3842: /* module 15 call 2 */
        switch (itemIdx) {
        case 0: /* technicalcommittee_propose_V12 - threshold */;
            return _toStringCompactu32(
                &m->basic.technicalcommittee_propose_V12.threshold,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* technicalcommittee_propose_V12 - proposal */;
            return _toStringProposal(
                &m->basic.technicalcommittee_propose_V12.proposal,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* technicalcommittee_propose_V12 - length_bound */;
            return _toStringCompactu32(
                &m->basic.technicalcommittee_propose_V12.length_bound,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4611: /* module 18 call 3 */
        switch (itemIdx) {
        case 0: /* treasury_spend_V12 - amount */;
            return _toStringCompactBalance(
                &m->basic.treasury_spend_V12.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* treasury_spend_V12 - beneficiary */;
            return _toStringLookupasStaticLookupSource_V12(
                &m->basic.treasury_spend_V12.beneficiary,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4612: /* module 18 call 4 */
        switch (itemIdx) {
        case 0: /* treasury_remove_approval_V12 - proposal_id */;
            return _toStringCompactu32(
                &m->basic.treasury_remove_approval_V12.proposal_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6656: /* module 26 call 0 */
        switch (itemIdx) {
        case 0: /* society_bid_V12 - amount */;
            return _toStringBalanceOf(
                &m->basic.society_bid_V12.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6657: /* module 26 call 1 */
        switch (itemIdx) {
        case 0: /* society_unbid_V12 - pos */;
            return _toStringu32(
                &m->basic.society_unbid_V12.pos,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6658: /* module 26 call 2 */
        switch (itemIdx) {
        case 0: /* society_vouch_V12 - who */;
            return _toStringAccountId_V12(
                &m->basic.society_vouch_V12.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* society_vouch_V12 - amount */;
            return _toStringBalanceOf(
                &m->basic.society_vouch_V12.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* society_vouch_V12 - tip */;
            return _toStringBalanceOf(
                &m->basic.society_vouch_V12.tip,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6659: /* module 26 call 3 */
        switch (itemIdx) {
        case 0: /* society_unvouch_V12 - pos */;
            return _toStringu32(
                &m->basic.society_unvouch_V12.pos,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6660: /* module 26 call 4 */
        switch (itemIdx) {
        case 0: /* society_vote_V12 - candidate */;
            return _toStringLookupasStaticLookupSource_V12(
                &m->basic.society_vote_V12.candidate,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* society_vote_V12 - approve */;
            return _toStringbool(
                &m->basic.society_vote_V12.approve,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6661: /* module 26 call 5 */
        switch (itemIdx) {
        case 0: /* society_defender_vote_V12 - approve */;
            return _toStringbool(
                &m->basic.society_defender_vote_V12.approve,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6663: /* module 26 call 7 */
        switch (itemIdx) {
        case 0: /* society_found_V12 - founder */;
            return _toStringAccountId_V12(
                &m->basic.society_found_V12.founder,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* society_found_V12 - max_members */;
            return _toStringu32(
                &m->basic.society_found_V12.max_members,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* society_found_V12 - rules */;
            return _toStringBytes(
                &m->basic.society_found_V12.rules,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6665: /* module 26 call 9 */
        switch (itemIdx) {
        case 0: /* society_judge_suspended_member_V12 - who */;
            return _toStringAccountId_V12(
                &m->basic.society_judge_suspended_member_V12.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* society_judge_suspended_member_V12 - forgive */;
            return _toStringbool(
                &m->basic.society_judge_suspended_member_V12.forgive,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6667: /* module 26 call 11 */
        switch (itemIdx) {
        case 0: /* society_set_max_members_V12 - max */;
            return _toStringu32(
                &m->basic.society_set_max_members_V12.max,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6913: /* module 27 call 1 */
        switch (itemIdx) {
        case 0: /* recovery_set_recovered_V12 - lost */;
            return _toStringAccountId_V12(
                &m->basic.recovery_set_recovered_V12.lost,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* recovery_set_recovered_V12 - rescuer */;
            return _toStringAccountId_V12(
                &m->basic.recovery_set_recovered_V12.rescuer,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6915: /* module 27 call 3 */
        switch (itemIdx) {
        case 0: /* recovery_initiate_recovery_V12 - account */;
            return _toStringAccountId_V12(
                &m->basic.recovery_initiate_recovery_V12.account,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6916: /* module 27 call 4 */
        switch (itemIdx) {
        case 0: /* recovery_vouch_recovery_V12 - lost */;
            return _toStringAccountId_V12(
                &m->basic.recovery_vouch_recovery_V12.lost,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* recovery_vouch_recovery_V12 - rescuer */;
            return _toStringAccountId_V12(
                &m->basic.recovery_vouch_recovery_V12.rescuer,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6917: /* module 27 call 5 */
        switch (itemIdx) {
        case 0: /* recovery_claim_recovery_V12 - account */;
            return _toStringAccountId_V12(
                &m->basic.recovery_claim_recovery_V12.account,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6918: /* module 27 call 6 */
        switch (itemIdx) {
        case 0: /* recovery_close_recovery_V12 - rescuer */;
            return _toStringAccountId_V12(
                &m->basic.recovery_close_recovery_V12.rescuer,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6920: /* module 27 call 8 */
        switch (itemIdx) {
        case 0: /* recovery_cancel_recovered_V12 - account */;
            return _toStringAccountId_V12(
                &m->basic.recovery_cancel_recovered_V12.account,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7170: /* module 28 call 2 */
        switch (itemIdx) {
        case 0: /* vesting_vested_transfer_V12 - target */;
            return _toStringLookupasStaticLookupSource_V12(
                &m->basic.vesting_vested_transfer_V12.target,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* vesting_vested_transfer_V12 - schedule */;
            return _toStringVestingInfo_V12(
                &m->basic.vesting_vested_transfer_V12.schedule,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7171: /* module 28 call 3 */
        switch (itemIdx) {
        case 0: /* vesting_force_vested_transfer_V12 - source */;
            return _toStringLookupasStaticLookupSource_V12(
                &m->basic.vesting_force_vested_transfer_V12.source,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* vesting_force_vested_transfer_V12 - target */;
            return _toStringLookupasStaticLookupSource_V12(
                &m->basic.vesting_force_vested_transfer_V12.target,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* vesting_force_vested_transfer_V12 - schedule */;
            return _toStringVestingInfo_V12(
                &m->basic.vesting_force_vested_transfer_V12.schedule,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9728: /* module 38 call 0 */
        switch (itemIdx) {
        case 0: /* gilt_place_bid_V12 - amount */;
            return _toStringCompactBalance(
                &m->basic.gilt_place_bid_V12.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* gilt_place_bid_V12 - duration */;
            return _toStringu32(
                &m->basic.gilt_place_bid_V12.duration,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9729: /* module 38 call 1 */
        switch (itemIdx) {
        case 0: /* gilt_retract_bid_V12 - amount */;
            return _toStringCompactBalance(
                &m->basic.gilt_retract_bid_V12.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* gilt_retract_bid_V12 - duration */;
            return _toStringu32(
                &m->basic.gilt_retract_bid_V12.duration,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9730: /* module 38 call 2 */
        switch (itemIdx) {
        case 0: /* gilt_set_target_V12 - target */;
            return _toStringCompactu64(
                &m->basic.gilt_set_target_V12.target,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9731: /* module 38 call 3 */
        switch (itemIdx) {
        case 0: /* gilt_thaw_V12 - index */;
            return _toStringCompactu32(
                &m->basic.gilt_thaw_V12.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 10496: /* module 41 call 0 */
        switch (itemIdx) {
        case 0: /* nominationpools_join_V12 - amount */;
            return _toStringCompactu128(
                &m->basic.nominationpools_join_V12.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* nominationpools_join_V12 - pool_id */;
            return _toStringPoolId_V12(
                &m->basic.nominationpools_join_V12.pool_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 10497: /* module 41 call 1 */
        switch (itemIdx) {
        case 0: /* nominationpools_bond_extra_V12 - extra */;
            return _toStringBondExtraBalanceOfT_V12(
                &m->basic.nominationpools_bond_extra_V12.extra,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 10499: /* module 41 call 3 */
        switch (itemIdx) {
        case 0: /* nominationpools_unbond_V12 - member_account */;
            return _toStringAccountId_V12(
                &m->basic.nominationpools_unbond_V12.member_account,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* nominationpools_unbond_V12 - unbonding_points */;
            return _toStringCompactu128(
                &m->basic.nominationpools_unbond_V12.unbonding_points,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 10500: /* module 41 call 4 */
        switch (itemIdx) {
        case 0: /* nominationpools_pool_withdraw_unbonded_V12 - pool_id */;
            return _toStringPoolId_V12(
                &m->basic.nominationpools_pool_withdraw_unbonded_V12.pool_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* nominationpools_pool_withdraw_unbonded_V12 - num_slashing_spans */;
            return _toStringu32(
                &m->basic.nominationpools_pool_withdraw_unbonded_V12.num_slashing_spans,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 10501: /* module 41 call 5 */
        switch (itemIdx) {
        case 0: /* nominationpools_withdraw_unbonded_V12 - member_account */;
            return _toStringAccountId_V12(
                &m->basic.nominationpools_withdraw_unbonded_V12.member_account,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* nominationpools_withdraw_unbonded_V12 - num_slashing_spans */;
            return _toStringu32(
                &m->basic.nominationpools_withdraw_unbonded_V12.num_slashing_spans,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 10502: /* module 41 call 6 */
        switch (itemIdx) {
        case 0: /* nominationpools_create_V12 - amount */;
            return _toStringCompactu128(
                &m->basic.nominationpools_create_V12.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* nominationpools_create_V12 - root */;
            return _toStringAccountId_V12(
                &m->basic.nominationpools_create_V12.root,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* nominationpools_create_V12 - nominator */;
            return _toStringAccountId_V12(
                &m->basic.nominationpools_create_V12.nominator,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* nominationpools_create_V12 - state_toggler */;
            return _toStringAccountId_V12(
                &m->basic.nominationpools_create_V12.state_toggler,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 10503: /* module 41 call 7 */
        switch (itemIdx) {
        case 0: /* nominationpools_nominate_V12 - pool_id */;
            return _toStringPoolId_V12(
                &m->basic.nominationpools_nominate_V12.pool_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* nominationpools_nominate_V12 - validators */;
            return _toStringVecAccountId_V12(
                &m->basic.nominationpools_nominate_V12.validators,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 10504: /* module 41 call 8 */
        switch (itemIdx) {
        case 0: /* nominationpools_set_state_V12 - pool_id */;
            return _toStringPoolId_V12(
                &m->basic.nominationpools_set_state_V12.pool_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* nominationpools_set_state_V12 - state */;
            return _toStringPoolState_V12(
                &m->basic.nominationpools_set_state_V12.state,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 10505: /* module 41 call 9 */
        switch (itemIdx) {
        case 0: /* nominationpools_set_metadata_V12 - pool_id */;
            return _toStringPoolId_V12(
                &m->basic.nominationpools_set_metadata_V12.pool_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* nominationpools_set_metadata_V12 - metadata */;
            return _toStringVecu8(
                &m->basic.nominationpools_set_metadata_V12.metadata,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 10506: /* module 41 call 10 */
        switch (itemIdx) {
        case 0: /* nominationpools_set_configs_V12 - min_join_bond */;
            return _toStringConfigOpBalanceOfT_V12(
                &m->basic.nominationpools_set_configs_V12.min_join_bond,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* nominationpools_set_configs_V12 - min_create_bond */;
            return _toStringConfigOpBalanceOfT_V12(
                &m->basic.nominationpools_set_configs_V12.min_create_bond,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* nominationpools_set_configs_V12 - max_pools */;
            return _toStringConfigOpu32_V12(
                &m->basic.nominationpools_set_configs_V12.max_pools,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* nominationpools_set_configs_V12 - max_members */;
            return _toStringConfigOpu32_V12(
                &m->basic.nominationpools_set_configs_V12.max_members,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* nominationpools_set_configs_V12 - max_members_per_pool */;
            return _toStringConfigOpu32_V12(
                &m->basic.nominationpools_set_configs_V12.max_members_per_pool,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 10507: /* module 41 call 11 */
        switch (itemIdx) {
        case 0: /* nominationpools_update_roles_V12 - pool_id */;
            return _toStringPoolId_V12(
                &m->basic.nominationpools_update_roles_V12.pool_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* nominationpools_update_roles_V12 - new_root */;
            return _toStringConfigOpAccountId_V12(
                &m->basic.nominationpools_update_roles_V12.new_root,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* nominationpools_update_roles_V12 - new_nominator */;
            return _toStringConfigOpAccountId_V12(
                &m->basic.nominationpools_update_roles_V12.new_nominator,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* nominationpools_update_roles_V12 - new_state_toggler */;
            return _toStringConfigOpAccountId_V12(
                &m->basic.nominationpools_update_roles_V12.new_state_toggler,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 10508: /* module 41 call 12 */
        switch (itemIdx) {
        case 0: /* nominationpools_chill_V12 - pool_id */;
            return _toStringPoolId_V12(
                &m->basic.nominationpools_chill_V12.pool_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 13070: /* module 51 call 14 */
        switch (itemIdx) {
        case 0: /* configuration_set_dispute_period_V12 - new_ */;
            return _toStringSessionIndex_V12(
                &m->basic.configuration_set_dispute_period_V12.new_,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
