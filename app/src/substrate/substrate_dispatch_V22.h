...
#include "substrate_functions_V22.h"
#include <stddef.h>
#include <stdint.h>

parser_error_t _readMethod_V22(parser_context_t* c, uint8_t moduleIdx, uint8_t callIdx, pd_Method_V22_t* method);
...
parser_error_t _getMethod_ItemValue_V22(
    pd_Method_V22_t* m, uint8_t moduleIdx, uint8_t callIdx, uint8_t itemIdx,
