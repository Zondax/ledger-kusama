...
#define PD_CALL_TIMESTAMP_V12 2
#define PD_CALL_INDICES_V12 3
#define PD_CALL_BALANCES_V12 4
#define PD_CALL_STAKING_V12 6
#define PD_CALL_SESSION_V12 8
#define PD_CALL_GRANDPA_V12 10
#define PD_CALL_DEMOCRACY_V12 13
#define PD_CALL_COUNCIL_V12 14
#define PD_CALL_TECHNICALCOMMITTEE_V12 15
#define PD_CALL_PHRAGMENELECTION_V12 16
#define PD_CALL_TECHNICALMEMBERSHIP_V12 17
#define PD_CALL_TREASURY_V12 18
#define PD_CALL_CLAIMS_V12 19
#define PD_CALL_UTILITY_V12 24
#define PD_CALL_IDENTITY_V12 25
#define PD_CALL_SOCIETY_V12 26
#define PD_CALL_RECOVERY_V12 27
#define PD_CALL_VESTING_V12 28
#define PD_CALL_PROXY_V12 30
#define PD_CALL_MULTISIG_V12 31
#define PD_CALL_PREIMAGE_V12 32
#define PD_CALL_BOUNTIES_V12 35
#define PD_CALL_CHILDBOUNTIES_V12 40
#define PD_CALL_TIPS_V12 36
#define PD_CALL_ELECTIONPROVIDERMULTIPHASE_V12 37
#define PD_CALL_GILT_V12 38
#define PD_CALL_VOTERLIST_V12 39
#define PD_CALL_NOMINATIONPOOLS_V12 41
...
#define PD_CALL_CROWDLOAN_CREATE_V12 0
typedef struct {
    ...
    pd_Compactu32_t end;
    pd_OptionMultiSigner_V12_t verifier;
} pd_crowdloan_create_V12_t;

#define PD_CALL_CROWDLOAN_CONTRIBUTE_V12 1
typedef struct {
    pd_Compactu32_t index;
    pd_Compactu128_t amount;
    pd_OptionMultiSignature_V12_t signature;
} pd_crowdloan_contribute_V12_t;

#define PD_CALL_CROWDLOAN_WITHDRAW_V12 2
typedef struct {
    pd_AccountId_V12_t who;
    pd_Compactu32_t index;
} pd_crowdloan_withdraw_V12_t;

#define PD_CALL_CROWDLOAN_REFUND_V12 3
typedef struct {
    pd_Compactu32_t index;
} pd_crowdloan_refund_V12_t;

#define PD_CALL_CROWDLOAN_DISSOLVE_V12 4
typedef struct {
    pd_Compactu32_t index;
} pd_crowdloan_dissolve_V12_t;

#define PD_CALL_CROWDLOAN_EDIT_V12 5
typedef struct {
    pd_Compactu32_t index;
    pd_Compactu128_t cap;
    pd_Compactu32_t first_period;
    ...
    pd_Compactu32_t end;
    pd_OptionMultiSigner_V12_t verifier;
} pd_crowdloan_edit_V12_t;

#define PD_CALL_CROWDLOAN_ADD_MEMO_V12 6
typedef struct {
    pd_ParaId_V12_t index;
    pd_Vecu8_t memo;
} pd_crowdloan_add_memo_V12_t;

#define PD_CALL_CROWDLOAN_POKE_V12 7
typedef struct {
    pd_ParaId_V12_t index;
} pd_crowdloan_poke_V12_t;

#define PD_CALL_CROWDLOAN_CONTRIBUTE_ALL_V12 8
typedef struct {
    pd_Compactu32_t index;
    pd_OptionMultiSignature_V12_t signature;
} pd_crowdloan_contribute_all_V12_t;
...
#define PD_CALL_INDICES_TRANSFER_V12 1
typedef struct {
    pd_AccountId_V12_t new_;
    pd_AccountIndex_V12_t index;
} pd_indices_transfer_V12_t;
...
typedef struct {
    pd_VecAccountId_V12_t new_members;
    pd_OptionAccountId_V12_t prime;
    pd_MemberCount_V12_t old_count;
} pd_council_set_members_V12_t;

#define PD_CALL_COUNCIL_EXECUTE_V12 1
typedef struct {
    pd_Proposal_t proposal;
    pd_Compactu32_t length_bound;
} pd_council_execute_V12_t;

#define PD_CALL_COUNCIL_PROPOSE_V12 2
typedef struct {
    pd_Compactu32_t threshold;
    pd_Proposal_t proposal;
    pd_Compactu32_t length_bound;
} pd_council_propose_V12_t;
...
#define PD_CALL_TECHNICALCOMMITTEE_SET_MEMBERS_V12 0
typedef struct {
    pd_VecAccountId_V12_t new_members;
    pd_OptionAccountId_V12_t prime;
    pd_MemberCount_V12_t old_count;
} pd_technicalcommittee_set_members_V12_t;

#define PD_CALL_TECHNICALCOMMITTEE_EXECUTE_V12 1
typedef struct {
    pd_Proposal_t proposal;
    pd_Compactu32_t length_bound;
} pd_technicalcommittee_execute_V12_t;

#define PD_CALL_TECHNICALCOMMITTEE_PROPOSE_V12 2
typedef struct {
    pd_Compactu32_t threshold;
    pd_Proposal_t proposal;
    pd_Compactu32_t length_bound;
} pd_technicalcommittee_propose_V12_t;
...
#define PD_CALL_TREASURY_SPEND_V12 3
typedef struct {
    pd_CompactBalance_t amount;
    pd_LookupasStaticLookupSource_V12_t beneficiary;
} pd_treasury_spend_V12_t;

#define PD_CALL_TREASURY_REMOVE_APPROVAL_V12 4
typedef struct {
    pd_Compactu32_t proposal_id;
} pd_treasury_remove_approval_V12_t;
...
#define PD_CALL_SOCIETY_BID_V12 0
typedef struct {
    pd_BalanceOf_t amount;
} pd_society_bid_V12_t;

#define PD_CALL_SOCIETY_UNBID_V12 1
typedef struct {
    pd_u32_t pos;
} pd_society_unbid_V12_t;

#define PD_CALL_SOCIETY_VOUCH_V12 2
typedef struct {
    pd_AccountId_V12_t who;
    pd_BalanceOf_t amount;
    pd_BalanceOf_t tip;
} pd_society_vouch_V12_t;

#define PD_CALL_SOCIETY_UNVOUCH_V12 3
typedef struct {
    pd_u32_t pos;
} pd_society_unvouch_V12_t;

#define PD_CALL_SOCIETY_VOTE_V12 4
typedef struct {
    pd_LookupasStaticLookupSource_V12_t candidate;
    pd_bool_t approve;
} pd_society_vote_V12_t;

#define PD_CALL_SOCIETY_DEFENDER_VOTE_V12 5
typedef struct {
    pd_bool_t approve;
} pd_society_defender_vote_V12_t;

#define PD_CALL_SOCIETY_PAYOUT_V12 6
typedef struct {
} pd_society_payout_V12_t;

#define PD_CALL_SOCIETY_FOUND_V12 7
typedef struct {
    pd_AccountId_V12_t founder;
    pd_u32_t max_members;
    pd_Bytes_t rules;
} pd_society_found_V12_t;

#define PD_CALL_SOCIETY_UNFOUND_V12 8
typedef struct {
} pd_society_unfound_V12_t;

#define PD_CALL_SOCIETY_JUDGE_SUSPENDED_MEMBER_V12 9
typedef struct {
    pd_AccountId_V12_t who;
    pd_bool_t forgive;
} pd_society_judge_suspended_member_V12_t;

#define PD_CALL_SOCIETY_SET_MAX_MEMBERS_V12 11
typedef struct {
    pd_u32_t max;
} pd_society_set_max_members_V12_t;

#define PD_CALL_RECOVERY_SET_RECOVERED_V12 1
typedef struct {
    pd_AccountId_V12_t lost;
    pd_AccountId_V12_t rescuer;
} pd_recovery_set_recovered_V12_t;

#define PD_CALL_RECOVERY_INITIATE_RECOVERY_V12 3
typedef struct {
    pd_AccountId_V12_t account;
} pd_recovery_initiate_recovery_V12_t;

#define PD_CALL_RECOVERY_VOUCH_RECOVERY_V12 4
typedef struct {
    pd_AccountId_V12_t lost;
    pd_AccountId_V12_t rescuer;
} pd_recovery_vouch_recovery_V12_t;

#define PD_CALL_RECOVERY_CLAIM_RECOVERY_V12 5
typedef struct {
    pd_AccountId_V12_t account;
} pd_recovery_claim_recovery_V12_t;

#define PD_CALL_RECOVERY_CLOSE_RECOVERY_V12 6
typedef struct {
    pd_AccountId_V12_t rescuer;
} pd_recovery_close_recovery_V12_t;

#define PD_CALL_RECOVERY_REMOVE_RECOVERY_V12 7
typedef struct {
} pd_recovery_remove_recovery_V12_t;

#define PD_CALL_RECOVERY_CANCEL_RECOVERED_V12 8
typedef struct {
    pd_AccountId_V12_t account;
} pd_recovery_cancel_recovered_V12_t;
...
#define PD_CALL_VESTING_VESTED_TRANSFER_V12 2
typedef struct {
    pd_LookupasStaticLookupSource_V12_t target;
    pd_VestingInfo_V12_t schedule;
} pd_vesting_vested_transfer_V12_t;

#define PD_CALL_VESTING_FORCE_VESTED_TRANSFER_V12 3
typedef struct {
    pd_LookupasStaticLookupSource_V12_t source;
    pd_LookupasStaticLookupSource_V12_t target;
    pd_VestingInfo_V12_t schedule;
} pd_vesting_force_vested_transfer_V12_t;
...
#define PD_CALL_GILT_PLACE_BID_V12 0
typedef struct {
    pd_CompactBalance_t amount;
    pd_u32_t duration;
} pd_gilt_place_bid_V12_t;

#define PD_CALL_GILT_RETRACT_BID_V12 1
typedef struct {
    pd_CompactBalance_t amount;
    pd_u32_t duration;
} pd_gilt_retract_bid_V12_t;

#define PD_CALL_GILT_SET_TARGET_V12 2
typedef struct {
    pd_Compactu64_t target;
} pd_gilt_set_target_V12_t;

#define PD_CALL_GILT_THAW_V12 3
typedef struct {
    pd_Compactu32_t index;
} pd_gilt_thaw_V12_t;
...
#define PD_CALL_NOMINATIONPOOLS_JOIN_V12 0
typedef struct {
    pd_Compactu128_t amount;
    pd_PoolId_V12_t pool_id;
} pd_nominationpools_join_V12_t;

#define PD_CALL_NOMINATIONPOOLS_BOND_EXTRA_V12 1
typedef struct {
    pd_BondExtraBalanceOfT_V12_t extra;
} pd_nominationpools_bond_extra_V12_t;

#define PD_CALL_NOMINATIONPOOLS_CLAIM_PAYOUT_V12 2
typedef struct {
} pd_nominationpools_claim_payout_V12_t;

#define PD_CALL_NOMINATIONPOOLS_UNBOND_V12 3
typedef struct {
    pd_AccountId_V12_t member_account;
    pd_Compactu128_t unbonding_points;
} pd_nominationpools_unbond_V12_t;

#define PD_CALL_NOMINATIONPOOLS_POOL_WITHDRAW_UNBONDED_V12 4
typedef struct {
    pd_PoolId_V12_t pool_id;
    pd_u32_t num_slashing_spans;
} pd_nominationpools_pool_withdraw_unbonded_V12_t;

#define PD_CALL_NOMINATIONPOOLS_WITHDRAW_UNBONDED_V12 5
typedef struct {
    pd_AccountId_V12_t member_account;
    pd_u32_t num_slashing_spans;
} pd_nominationpools_withdraw_unbonded_V12_t;

#define PD_CALL_NOMINATIONPOOLS_CREATE_V12 6
typedef struct {
    pd_Compactu128_t amount;
    pd_AccountId_V12_t root;
    pd_AccountId_V12_t nominator;
    pd_AccountId_V12_t state_toggler;
} pd_nominationpools_create_V12_t;

#define PD_CALL_NOMINATIONPOOLS_NOMINATE_V12 7
typedef struct {
    pd_PoolId_V12_t pool_id;
    pd_VecAccountId_V12_t validators;
} pd_nominationpools_nominate_V12_t;

#define PD_CALL_NOMINATIONPOOLS_SET_STATE_V12 8
typedef struct {
    pd_PoolId_V12_t pool_id;
    pd_PoolState_V12_t state;
} pd_nominationpools_set_state_V12_t;

#define PD_CALL_NOMINATIONPOOLS_SET_METADATA_V12 9
typedef struct {
    pd_PoolId_V12_t pool_id;
    pd_Vecu8_t metadata;
} pd_nominationpools_set_metadata_V12_t;

#define PD_CALL_NOMINATIONPOOLS_SET_CONFIGS_V12 10
typedef struct {
    pd_ConfigOpBalanceOfT_V12_t min_join_bond;
    pd_ConfigOpBalanceOfT_V12_t min_create_bond;
    pd_ConfigOpu32_V12_t max_pools;
    pd_ConfigOpu32_V12_t max_members;
    pd_ConfigOpu32_V12_t max_members_per_pool;
} pd_nominationpools_set_configs_V12_t;

#define PD_CALL_NOMINATIONPOOLS_UPDATE_ROLES_V12 11
typedef struct {
    pd_PoolId_V12_t pool_id;
    pd_ConfigOpAccountId_V12_t new_root;
    pd_ConfigOpAccountId_V12_t new_nominator;
    pd_ConfigOpAccountId_V12_t new_state_toggler;
} pd_nominationpools_update_roles_V12_t;

#define PD_CALL_NOMINATIONPOOLS_CHILL_V12 12
typedef struct {
    pd_PoolId_V12_t pool_id;
} pd_nominationpools_chill_V12_t;
...
#define PD_CALL_CONFIGURATION_SET_DISPUTE_PERIOD_V12 14
typedef struct {
    pd_SessionIndex_V12_t new_;
} pd_configuration_set_dispute_period_V12_t;
...
typedef union {
    ...
    pd_crowdloan_create_V12_t crowdloan_create_V12;
    pd_crowdloan_contribute_V12_t crowdloan_contribute_V12;
    pd_crowdloan_withdraw_V12_t crowdloan_withdraw_V12;
    pd_crowdloan_refund_V12_t crowdloan_refund_V12;
    pd_crowdloan_dissolve_V12_t crowdloan_dissolve_V12;
    pd_crowdloan_edit_V12_t crowdloan_edit_V12;
    pd_crowdloan_add_memo_V12_t crowdloan_add_memo_V12;
    pd_crowdloan_poke_V12_t crowdloan_poke_V12;
    pd_crowdloan_contribute_all_V12_t crowdloan_contribute_all_V12;
#ifdef SUBSTRATE_PARSER_FULL
    pd_timestamp_set_V12_t timestamp_set_V12;
    pd_indices_claim_V12_t indices_claim_V12;
    pd_indices_transfer_V12_t indices_transfer_V12;
    ...
    pd_technicalcommittee_set_members_V12_t technicalcommittee_set_members_V12;
    pd_technicalcommittee_execute_V12_t technicalcommittee_execute_V12;
    pd_technicalcommittee_propose_V12_t technicalcommittee_propose_V12;
    ...
    pd_treasury_spend_V12_t treasury_spend_V12;
    pd_treasury_remove_approval_V12_t treasury_remove_approval_V12;
    ...
    pd_society_bid_V12_t society_bid_V12;
    pd_society_unbid_V12_t society_unbid_V12;
    pd_society_vouch_V12_t society_vouch_V12;
    pd_society_unvouch_V12_t society_unvouch_V12;
    pd_society_vote_V12_t society_vote_V12;
    pd_society_defender_vote_V12_t society_defender_vote_V12;
    pd_society_payout_V12_t society_payout_V12;
    pd_society_found_V12_t society_found_V12;
    pd_society_unfound_V12_t society_unfound_V12;
    pd_society_judge_suspended_member_V12_t society_judge_suspended_member_V12;
    pd_society_set_max_members_V12_t society_set_max_members_V12;
    pd_recovery_set_recovered_V12_t recovery_set_recovered_V12;
    pd_recovery_initiate_recovery_V12_t recovery_initiate_recovery_V12;
    pd_recovery_vouch_recovery_V12_t recovery_vouch_recovery_V12;
    pd_recovery_claim_recovery_V12_t recovery_claim_recovery_V12;
    pd_recovery_close_recovery_V12_t recovery_close_recovery_V12;
    pd_recovery_remove_recovery_V12_t recovery_remove_recovery_V12;
    pd_recovery_cancel_recovered_V12_t recovery_cancel_recovered_V12;
    pd_vesting_vest_V12_t vesting_vest_V12;
    pd_vesting_vest_other_V12_t vesting_vest_other_V12;
    pd_vesting_vested_transfer_V12_t vesting_vested_transfer_V12;
    pd_vesting_force_vested_transfer_V12_t vesting_force_vested_transfer_V12;
    ...
    pd_gilt_place_bid_V12_t gilt_place_bid_V12;
    pd_gilt_retract_bid_V12_t gilt_retract_bid_V12;
    pd_gilt_set_target_V12_t gilt_set_target_V12;
    pd_gilt_thaw_V12_t gilt_thaw_V12;
    pd_voterlist_rebag_V12_t voterlist_rebag_V12;
    pd_voterlist_put_in_front_of_V12_t voterlist_put_in_front_of_V12;
    pd_nominationpools_join_V12_t nominationpools_join_V12;
    pd_nominationpools_bond_extra_V12_t nominationpools_bond_extra_V12;
    pd_nominationpools_claim_payout_V12_t nominationpools_claim_payout_V12;
    pd_nominationpools_unbond_V12_t nominationpools_unbond_V12;
    pd_nominationpools_pool_withdraw_unbonded_V12_t nominationpools_pool_withdraw_unbonded_V12;
    pd_nominationpools_withdraw_unbonded_V12_t nominationpools_withdraw_unbonded_V12;
    pd_nominationpools_create_V12_t nominationpools_create_V12;
    pd_nominationpools_nominate_V12_t nominationpools_nominate_V12;
    pd_nominationpools_set_state_V12_t nominationpools_set_state_V12;
    pd_nominationpools_set_metadata_V12_t nominationpools_set_metadata_V12;
    pd_nominationpools_set_configs_V12_t nominationpools_set_configs_V12;
    pd_nominationpools_update_roles_V12_t nominationpools_update_roles_V12;
    pd_nominationpools_chill_V12_t nominationpools_chill_V12;
    ...
    pd_configuration_set_dispute_period_V12_t configuration_set_dispute_period_V12;
