...
#define PD_CALL_TIMESTAMP_V13 2
#define PD_CALL_INDICES_V13 3
#define PD_CALL_BALANCES_V13 4
#define PD_CALL_STAKING_V13 6
#define PD_CALL_SESSION_V13 8
#define PD_CALL_GRANDPA_V13 10
#define PD_CALL_DEMOCRACY_V13 13
#define PD_CALL_COUNCIL_V13 14
#define PD_CALL_TECHNICALCOMMITTEE_V13 15
#define PD_CALL_PHRAGMENELECTION_V13 16
#define PD_CALL_TECHNICALMEMBERSHIP_V13 17
#define PD_CALL_TREASURY_V13 18
#define PD_CALL_CLAIMS_V13 19
#define PD_CALL_UTILITY_V13 24
#define PD_CALL_IDENTITY_V13 25
#define PD_CALL_SOCIETY_V13 26
#define PD_CALL_RECOVERY_V13 27
#define PD_CALL_VESTING_V13 28
#define PD_CALL_PROXY_V13 30
#define PD_CALL_MULTISIG_V13 31
#define PD_CALL_PREIMAGE_V13 32
#define PD_CALL_BOUNTIES_V13 35
#define PD_CALL_CHILDBOUNTIES_V13 40
#define PD_CALL_TIPS_V13 36
#define PD_CALL_ELECTIONPROVIDERMULTIPHASE_V13 37
#define PD_CALL_GILT_V13 38
#define PD_CALL_VOTERLIST_V13 39
#define PD_CALL_NOMINATIONPOOLS_V13 41
...
typedef struct {
    pd_AccountIdLookupOfT_V13_t dest;
    pd_bool_t keep_alive;
} pd_balances_transfer_all_V13_t;

#define PD_CALL_STAKING_BOND_V13 0
typedef struct {
    pd_AccountIdLookupOfT_V13_t controller;
...
typedef struct {
    pd_VecAccountIdLookupOfT_V13_t targets;
...
typedef struct {
    pd_AccountIdLookupOfT_V13_t new_;
    pd_AccountIndex_V13_t index;
...
typedef struct {
    pd_AccountIdLookupOfT_V13_t who;
    pd_Balance_t amount;
...
typedef struct {
    pd_VecAccountIdLookupOfT_V13_t who;
...
typedef struct {
    pd_AccountIdLookupOfT_V13_t remove;
    pd_AccountIdLookupOfT_V13_t add;
...
typedef struct {
    pd_CompactBalance_t amount;
    pd_AccountIdLookupOfT_V13_t beneficiary;
...
typedef struct {
    pd_AccountIdLookupOfT_V13_t account;
...
#define PD_CALL_SOCIETY_BID_V13 0
typedef struct {
    pd_BalanceOf_t amount;
} pd_society_bid_V13_t;

#define PD_CALL_SOCIETY_UNBID_V13 1
typedef struct {
    pd_u32_t pos;
} pd_society_unbid_V13_t;

#define PD_CALL_SOCIETY_VOUCH_V13 2
typedef struct {
    pd_AccountIdLookupOfT_V13_t who;
    pd_BalanceOf_t amount;
    pd_BalanceOf_t tip;
} pd_society_vouch_V13_t;

#define PD_CALL_SOCIETY_UNVOUCH_V13 3
typedef struct {
    pd_u32_t pos;
} pd_society_unvouch_V13_t;

#define PD_CALL_SOCIETY_VOTE_V13 4
typedef struct {
    pd_AccountIdLookupOfT_V13_t candidate;
    pd_bool_t approve;
} pd_society_vote_V13_t;

#define PD_CALL_SOCIETY_DEFENDER_VOTE_V13 5
typedef struct {
    pd_bool_t approve;
} pd_society_defender_vote_V13_t;

#define PD_CALL_SOCIETY_PAYOUT_V13 6
typedef struct {
} pd_society_payout_V13_t;

#define PD_CALL_SOCIETY_FOUND_V13 7
typedef struct {
    pd_AccountIdLookupOfT_V13_t founder;
    pd_u32_t max_members;
    pd_Bytes_t rules;
} pd_society_found_V13_t;

#define PD_CALL_SOCIETY_UNFOUND_V13 8
typedef struct {
} pd_society_unfound_V13_t;

#define PD_CALL_SOCIETY_JUDGE_SUSPENDED_MEMBER_V13 9
typedef struct {
    pd_AccountIdLookupOfT_V13_t who;
    pd_bool_t forgive;
} pd_society_judge_suspended_member_V13_t;

#define PD_CALL_SOCIETY_SET_MAX_MEMBERS_V13 11
typedef struct {
    pd_u32_t max;
} pd_society_set_max_members_V13_t;

#define PD_CALL_RECOVERY_SET_RECOVERED_V13 1
typedef struct {
    pd_AccountIdLookupOfT_V13_t lost;
    pd_AccountIdLookupOfT_V13_t rescuer;
} pd_recovery_set_recovered_V13_t;

#define PD_CALL_RECOVERY_INITIATE_RECOVERY_V13 3
typedef struct {
    pd_AccountIdLookupOfT_V13_t account;
} pd_recovery_initiate_recovery_V13_t;

#define PD_CALL_RECOVERY_VOUCH_RECOVERY_V13 4
typedef struct {
    pd_AccountIdLookupOfT_V13_t lost;
    pd_AccountIdLookupOfT_V13_t rescuer;
} pd_recovery_vouch_recovery_V13_t;

#define PD_CALL_RECOVERY_CLAIM_RECOVERY_V13 5
typedef struct {
    pd_AccountIdLookupOfT_V13_t account;
} pd_recovery_claim_recovery_V13_t;

#define PD_CALL_RECOVERY_CLOSE_RECOVERY_V13 6
typedef struct {
    pd_AccountIdLookupOfT_V13_t rescuer;
} pd_recovery_close_recovery_V13_t;

#define PD_CALL_RECOVERY_REMOVE_RECOVERY_V13 7
typedef struct {
} pd_recovery_remove_recovery_V13_t;

#define PD_CALL_RECOVERY_CANCEL_RECOVERED_V13 8
typedef struct {
    pd_AccountIdLookupOfT_V13_t account;
} pd_recovery_cancel_recovered_V13_t;
...
typedef struct {
    pd_AccountIdLookupOfT_V13_t source;
    pd_AccountIdLookupOfT_V13_t target;
    pd_VestingInfo_V13_t schedule;
...
typedef struct {
    pd_AccountIdLookupOfT_V13_t delegate;
...
typedef struct {
    pd_AccountIdLookupOfT_V13_t spawner;
    pd_ProxyType_V13_t proxy_type;
    pd_u16_t index;
...
typedef struct {
    pd_AccountIdLookupOfT_V13_t delegate;
    pd_AccountIdLookupOfT_V13_t real;
...
typedef struct {
    pd_Compactu32_t bounty_id;
    pd_AccountIdLookupOfT_V13_t curator;
...
#define PD_CALL_GILT_PLACE_BID_V13 0
typedef struct {
    pd_CompactBalance_t amount;
    pd_u32_t duration;
} pd_gilt_place_bid_V13_t;

#define PD_CALL_GILT_RETRACT_BID_V13 1
typedef struct {
    pd_CompactBalance_t amount;
    pd_u32_t duration;
} pd_gilt_retract_bid_V13_t;

#define PD_CALL_GILT_SET_TARGET_V13 2
typedef struct {
    pd_Compactu64_t target;
} pd_gilt_set_target_V13_t;

#define PD_CALL_GILT_THAW_V13 3
typedef struct {
    pd_Compactu32_t index;
} pd_gilt_thaw_V13_t;
...
typedef struct {
    pd_AccountIdLookupOfT_V13_t dislocated;
} pd_voterlist_rebag_V13_t;

#define PD_CALL_VOTERLIST_PUT_IN_FRONT_OF_V13 1
typedef struct {
    pd_AccountIdLookupOfT_V13_t lighter;
...
typedef struct {
    pd_AccountIdLookupOfT_V13_t member_account;
...
typedef struct {
    pd_Compactu128_t amount;
    pd_AccountIdLookupOfT_V13_t root;
    pd_AccountIdLookupOfT_V13_t nominator;
    pd_AccountIdLookupOfT_V13_t state_toggler;
...
#define PD_CALL_CONFIGURATION_SET_DISPUTE_PERIOD_V13 14
typedef struct {
    pd_SessionIndex_V13_t new_;
} pd_configuration_set_dispute_period_V13_t;
...
typedef union {
    ...
    pd_society_bid_V13_t society_bid_V13;
    pd_society_unbid_V13_t society_unbid_V13;
    pd_society_vouch_V13_t society_vouch_V13;
    pd_society_unvouch_V13_t society_unvouch_V13;
    pd_society_vote_V13_t society_vote_V13;
    pd_society_defender_vote_V13_t society_defender_vote_V13;
    pd_society_payout_V13_t society_payout_V13;
    pd_society_found_V13_t society_found_V13;
    pd_society_unfound_V13_t society_unfound_V13;
    pd_society_judge_suspended_member_V13_t society_judge_suspended_member_V13;
    pd_society_set_max_members_V13_t society_set_max_members_V13;
    pd_recovery_set_recovered_V13_t recovery_set_recovered_V13;
    pd_recovery_initiate_recovery_V13_t recovery_initiate_recovery_V13;
    pd_recovery_vouch_recovery_V13_t recovery_vouch_recovery_V13;
    pd_recovery_claim_recovery_V13_t recovery_claim_recovery_V13;
    pd_recovery_close_recovery_V13_t recovery_close_recovery_V13;
    pd_recovery_remove_recovery_V13_t recovery_remove_recovery_V13;
    pd_recovery_cancel_recovered_V13_t recovery_cancel_recovered_V13;
    ...
    pd_gilt_place_bid_V13_t gilt_place_bid_V13;
    pd_gilt_retract_bid_V13_t gilt_retract_bid_V13;
    pd_gilt_set_target_V13_t gilt_set_target_V13;
    pd_gilt_thaw_V13_t gilt_thaw_V13;
    ...
    pd_configuration_set_dispute_period_V13_t configuration_set_dispute_period_V13;
...
typedef struct {
    pd_AccountIdLookupOfT_V13_t to;
