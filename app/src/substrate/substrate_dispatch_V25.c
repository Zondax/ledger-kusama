...
__Z_INLINE parser_error_t _readMethod_fellowshipcollective_add_member_V25(
    parser_context_t* c, pd_fellowshipcollective_add_member_V25_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->who))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_fellowshipcollective_promote_member_V25(
    parser_context_t* c, pd_fellowshipcollective_promote_member_V25_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->who))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_fellowshipcollective_demote_member_V25(
    parser_context_t* c, pd_fellowshipcollective_demote_member_V25_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->who))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_fellowshipcollective_remove_member_V25(
    parser_context_t* c, pd_fellowshipcollective_remove_member_V25_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->who))
...
__Z_INLINE parser_error_t _readMethod_fellowshipcollective_vote_V25(
    parser_context_t* c, pd_fellowshipcollective_vote_V25_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_fellowshipcollective_cleanup_poll_V25(
    parser_context_t* c, pd_fellowshipcollective_cleanup_poll_V25_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_fellowshipreferenda_submit_V25(
    parser_context_t* c, pd_fellowshipreferenda_submit_V25_t* m)
{
    CHECK_ERROR(_readBoxPalletsOrigin(c, &m->proposal_origin))
    CHECK_ERROR(_readBoundedCallOfT(c, &m->proposal))
    CHECK_ERROR(_readDispatchTimeBlockNumber(c, &m->enactment_moment))
...
__Z_INLINE parser_error_t _readMethod_fellowshipreferenda_place_decision_deposit_V25(
    parser_context_t* c, pd_fellowshipreferenda_place_decision_deposit_V25_t* m)
{
    CHECK_ERROR(_readReferendumIndex(c, &m->index))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_fellowshipreferenda_refund_decision_deposit_V25(
    parser_context_t* c, pd_fellowshipreferenda_refund_decision_deposit_V25_t* m)
{
    CHECK_ERROR(_readReferendumIndex(c, &m->index))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_fellowshipreferenda_cancel_V25(
    parser_context_t* c, pd_fellowshipreferenda_cancel_V25_t* m)
{
    CHECK_ERROR(_readReferendumIndex(c, &m->index))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_fellowshipreferenda_kill_V25(
    parser_context_t* c, pd_fellowshipreferenda_kill_V25_t* m)
{
    CHECK_ERROR(_readReferendumIndex(c, &m->index))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_fellowshipreferenda_nudge_referendum_V25(
    parser_context_t* c, pd_fellowshipreferenda_nudge_referendum_V25_t* m)
{
    CHECK_ERROR(_readReferendumIndex(c, &m->index))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_fellowshipreferenda_one_fewer_deciding_V25(
    parser_context_t* c, pd_fellowshipreferenda_one_fewer_deciding_V25_t* m)
{
    CHECK_ERROR(_readTrackIdOf(c, &m->track))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_fellowshipreferenda_refund_submission_deposit_V25(
    parser_context_t* c, pd_fellowshipreferenda_refund_submission_deposit_V25_t* m)
{
    CHECK_ERROR(_readReferendumIndex(c, &m->index))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_fellowshipreferenda_set_metadata_V25(
    parser_context_t* c, pd_fellowshipreferenda_set_metadata_V25_t* m)
{
    CHECK_ERROR(_readReferendumIndex(c, &m->index))
    CHECK_ERROR(_readOptionHash(c, &m->maybe_hash))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_society_unbid_V25(
    parser_context_t* c, pd_society_unbid_V25_t* m)
{
    UNUSED(c);
    UNUSED(m);
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_society_vouch_V25(
    parser_context_t* c, pd_society_vouch_V25_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->who))
    CHECK_ERROR(_readBalanceOf(c, &m->amount))
...
__Z_INLINE parser_error_t _readMethod_society_unvouch_V25(
    parser_context_t* c, pd_society_unvouch_V25_t* m)
{
    UNUSED(c);
    UNUSED(m);
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_society_vote_V25(
    parser_context_t* c, pd_society_vote_V25_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_society_defender_vote_V25(
    parser_context_t* c, pd_society_defender_vote_V25_t* m)
{
    CHECK_ERROR(_readbool(c, &m->approve))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_society_payout_V25(
    parser_context_t* c, pd_society_payout_V25_t* m)
{
    UNUSED(c);
    UNUSED(m);
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_society_waive_repay_V25(
    parser_context_t* c, pd_society_waive_repay_V25_t* m)
{
    CHECK_ERROR(_readBalanceOf(c, &m->amount))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_society_found_society_V25(
    parser_context_t* c, pd_society_found_society_V25_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_society_dissolve_V25(
    parser_context_t* c, pd_society_dissolve_V25_t* m)
{
    UNUSED(c);
    UNUSED(m);
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_society_judge_suspended_member_V25(
    parser_context_t* c, pd_society_judge_suspended_member_V25_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->who))
...
__Z_INLINE parser_error_t _readMethod_society_set_parameters_V25(
    parser_context_t* c, pd_society_set_parameters_V25_t* m)
{
    CHECK_ERROR(_readu32(c, &m->max_members))
    CHECK_ERROR(_readu32(c, &m->max_intake))
    CHECK_ERROR(_readu32(c, &m->max_strikes))
...
__Z_INLINE parser_error_t _readMethod_society_punish_skeptic_V25(
    parser_context_t* c, pd_society_punish_skeptic_V25_t* m)
{
    UNUSED(c);
    UNUSED(m);
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_society_claim_membership_V25(
    parser_context_t* c, pd_society_claim_membership_V25_t* m)
{
    UNUSED(c);
    UNUSED(m);
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_society_bestow_membership_V25(
    parser_context_t* c, pd_society_bestow_membership_V25_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->candidate))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_society_kick_candidate_V25(
    parser_context_t* c, pd_society_kick_candidate_V25_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->candidate))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_society_resign_candidacy_V25(
    parser_context_t* c, pd_society_resign_candidacy_V25_t* m)
{
    UNUSED(c);
    UNUSED(m);
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_society_drop_candidate_V25(
    parser_context_t* c, pd_society_drop_candidate_V25_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->candidate))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_society_cleanup_candidacy_V25(
    parser_context_t* c, pd_society_cleanup_candidacy_V25_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->candidate))
    CHECK_ERROR(_readu32(c, &m->max))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_society_cleanup_challenge_V25(
    parser_context_t* c, pd_society_cleanup_challenge_V25_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_recovery_set_recovered_V25(
    parser_context_t* c, pd_recovery_set_recovered_V25_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_recovery_initiate_recovery_V25(
    parser_context_t* c, pd_recovery_initiate_recovery_V25_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->account))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_recovery_vouch_recovery_V25(
    parser_context_t* c, pd_recovery_vouch_recovery_V25_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->lost))
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->rescuer))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_recovery_claim_recovery_V25(
    parser_context_t* c, pd_recovery_claim_recovery_V25_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->account))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_recovery_close_recovery_V25(
    parser_context_t* c, pd_recovery_close_recovery_V25_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->rescuer))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_recovery_remove_recovery_V25(
    parser_context_t* c, pd_recovery_remove_recovery_V25_t* m)
{
    UNUSED(c);
    UNUSED(m);
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_recovery_cancel_recovered_V25(
    parser_context_t* c, pd_recovery_cancel_recovered_V25_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->account))
    return parser_ok;
}
...
__Z_INLINE parser_error_t _readMethod_nis_place_bid_V25(
    parser_context_t* c, pd_nis_place_bid_V25_t* m)
{
    CHECK_ERROR(_readCompactu128(c, &m->amount))
...
__Z_INLINE parser_error_t _readMethod_nis_retract_bid_V25(
    parser_context_t* c, pd_nis_retract_bid_V25_t* m)
{
    CHECK_ERROR(_readCompactu128(c, &m->amount))
    CHECK_ERROR(_readu32(c, &m->duration))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_nis_fund_deficit_V25(
    parser_context_t* c, pd_nis_fund_deficit_V25_t* m)
{
    UNUSED(c);
    UNUSED(m);
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_nis_thaw_private_V25(
    parser_context_t* c, pd_nis_thaw_private_V25_t* m)
{
    CHECK_ERROR(_readCompactu32(c, &m->index))
...
__Z_INLINE parser_error_t _readMethod_nis_thaw_communal_V25(
    parser_context_t* c, pd_nis_thaw_communal_V25_t* m)
{
    CHECK_ERROR(_readCompactu32(c, &m->index))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_nis_communify_V25(
    parser_context_t* c, pd_nis_communify_V25_t* m)
{
    CHECK_ERROR(_readCompactu32(c, &m->index))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_nis_privatize_V25(
    parser_context_t* c, pd_nis_privatize_V25_t* m)
{
    CHECK_ERROR(_readCompactu32(c, &m->index))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_niscounterpartbalances_transfer_allow_death_V25(
    parser_context_t* c, pd_niscounterpartbalances_transfer_allow_death_V25_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->dest))
    CHECK_ERROR(_readCompactu128(c, &m->amount))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_niscounterpartbalances_force_transfer_V25(
    parser_context_t* c, pd_niscounterpartbalances_force_transfer_V25_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->source))
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->dest))
    CHECK_ERROR(_readCompactu128(c, &m->amount))
...
__Z_INLINE parser_error_t _readMethod_niscounterpartbalances_transfer_keep_alive_V25(
    parser_context_t* c, pd_niscounterpartbalances_transfer_keep_alive_V25_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->dest))
    CHECK_ERROR(_readCompactu128(c, &m->amount))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_niscounterpartbalances_transfer_all_V25(
    parser_context_t* c, pd_niscounterpartbalances_transfer_all_V25_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->dest))
    CHECK_ERROR(_readbool(c, &m->keep_alive))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_niscounterpartbalances_force_unreserve_V25(
    parser_context_t* c, pd_niscounterpartbalances_force_unreserve_V25_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->who))
    CHECK_ERROR(_readBalance(c, &m->amount))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_niscounterpartbalances_upgrade_accounts_V25(
    parser_context_t* c, pd_niscounterpartbalances_upgrade_accounts_V25_t* m)
{
    CHECK_ERROR(_readVecAccountId(c, &m->who))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_niscounterpartbalances_force_set_balance_V25(
    parser_context_t* c, pd_niscounterpartbalances_force_set_balance_V25_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->who))
...
__Z_INLINE parser_error_t _readMethod_configuration_set_dispute_period_V25(
    parser_context_t* c, pd_configuration_set_dispute_period_V25_t* m)
{
    ...
    pd_Method_V25_t* method)
{
    ...
    case 5632: /* module 22 call 0 */
        CHECK_ERROR(_readMethod_fellowshipcollective_add_member_V25(c, &method->basic.fellowshipcollective_add_member_V25))
        break;
    case 5633: /* module 22 call 1 */
        CHECK_ERROR(_readMethod_fellowshipcollective_promote_member_V25(c, &method->basic.fellowshipcollective_promote_member_V25))
        break;
    case 5634: /* module 22 call 2 */
        CHECK_ERROR(_readMethod_fellowshipcollective_demote_member_V25(c, &method->basic.fellowshipcollective_demote_member_V25))
        break;
    case 5635: /* module 22 call 3 */
        CHECK_ERROR(_readMethod_fellowshipcollective_remove_member_V25(c, &method->basic.fellowshipcollective_remove_member_V25))
        break;
    case 5636: /* module 22 call 4 */
        CHECK_ERROR(_readMethod_fellowshipcollective_vote_V25(c, &method->basic.fellowshipcollective_vote_V25))
        break;
    case 5637: /* module 22 call 5 */
        CHECK_ERROR(_readMethod_fellowshipcollective_cleanup_poll_V25(c, &method->basic.fellowshipcollective_cleanup_poll_V25))
        break;
    case 5888: /* module 23 call 0 */
        CHECK_ERROR(_readMethod_fellowshipreferenda_submit_V25(c, &method->basic.fellowshipreferenda_submit_V25))
        break;
    case 5889: /* module 23 call 1 */
        CHECK_ERROR(_readMethod_fellowshipreferenda_place_decision_deposit_V25(c, &method->basic.fellowshipreferenda_place_decision_deposit_V25))
        break;
    case 5890: /* module 23 call 2 */
        CHECK_ERROR(_readMethod_fellowshipreferenda_refund_decision_deposit_V25(c, &method->basic.fellowshipreferenda_refund_decision_deposit_V25))
        break;
    case 5891: /* module 23 call 3 */
        CHECK_ERROR(_readMethod_fellowshipreferenda_cancel_V25(c, &method->basic.fellowshipreferenda_cancel_V25))
        break;
    case 5892: /* module 23 call 4 */
        CHECK_ERROR(_readMethod_fellowshipreferenda_kill_V25(c, &method->basic.fellowshipreferenda_kill_V25))
        break;
    case 5893: /* module 23 call 5 */
        CHECK_ERROR(_readMethod_fellowshipreferenda_nudge_referendum_V25(c, &method->basic.fellowshipreferenda_nudge_referendum_V25))
        break;
    case 5894: /* module 23 call 6 */
        CHECK_ERROR(_readMethod_fellowshipreferenda_one_fewer_deciding_V25(c, &method->basic.fellowshipreferenda_one_fewer_deciding_V25))
        break;
    case 5895: /* module 23 call 7 */
        CHECK_ERROR(_readMethod_fellowshipreferenda_refund_submission_deposit_V25(c, &method->basic.fellowshipreferenda_refund_submission_deposit_V25))
        break;
    case 5896: /* module 23 call 8 */
        CHECK_ERROR(_readMethod_fellowshipreferenda_set_metadata_V25(c, &method->basic.fellowshipreferenda_set_metadata_V25))
        break;
    ...
    case 6657: /* module 26 call 1 */
        CHECK_ERROR(_readMethod_society_unbid_V25(c, &method->basic.society_unbid_V25))
        break;
    case 6658: /* module 26 call 2 */
        CHECK_ERROR(_readMethod_society_vouch_V25(c, &method->basic.society_vouch_V25))
        break;
    case 6659: /* module 26 call 3 */
        CHECK_ERROR(_readMethod_society_unvouch_V25(c, &method->basic.society_unvouch_V25))
        break;
    case 6660: /* module 26 call 4 */
        CHECK_ERROR(_readMethod_society_vote_V25(c, &method->basic.society_vote_V25))
        break;
    case 6661: /* module 26 call 5 */
        CHECK_ERROR(_readMethod_society_defender_vote_V25(c, &method->basic.society_defender_vote_V25))
        break;
    case 6662: /* module 26 call 6 */
        CHECK_ERROR(_readMethod_society_payout_V25(c, &method->basic.society_payout_V25))
        break;
    case 6663: /* module 26 call 7 */
        CHECK_ERROR(_readMethod_society_waive_repay_V25(c, &method->basic.society_waive_repay_V25))
        break;
    case 6664: /* module 26 call 8 */
        CHECK_ERROR(_readMethod_society_found_society_V25(c, &method->basic.society_found_society_V25))
        break;
    case 6665: /* module 26 call 9 */
        CHECK_ERROR(_readMethod_society_dissolve_V25(c, &method->basic.society_dissolve_V25))
        break;
    case 6666: /* module 26 call 10 */
        CHECK_ERROR(_readMethod_society_judge_suspended_member_V25(c, &method->basic.society_judge_suspended_member_V25))
        break;
    case 6667: /* module 26 call 11 */
        CHECK_ERROR(_readMethod_society_set_parameters_V25(c, &method->basic.society_set_parameters_V25))
        break;
    case 6668: /* module 26 call 12 */
        CHECK_ERROR(_readMethod_society_punish_skeptic_V25(c, &method->basic.society_punish_skeptic_V25))
        break;
    case 6669: /* module 26 call 13 */
        CHECK_ERROR(_readMethod_society_claim_membership_V25(c, &method->basic.society_claim_membership_V25))
        break;
    case 6670: /* module 26 call 14 */
        CHECK_ERROR(_readMethod_society_bestow_membership_V25(c, &method->basic.society_bestow_membership_V25))
        break;
    case 6671: /* module 26 call 15 */
        CHECK_ERROR(_readMethod_society_kick_candidate_V25(c, &method->basic.society_kick_candidate_V25))
        break;
    case 6672: /* module 26 call 16 */
        CHECK_ERROR(_readMethod_society_resign_candidacy_V25(c, &method->basic.society_resign_candidacy_V25))
        break;
    case 6673: /* module 26 call 17 */
        CHECK_ERROR(_readMethod_society_drop_candidate_V25(c, &method->basic.society_drop_candidate_V25))
        break;
    case 6674: /* module 26 call 18 */
        CHECK_ERROR(_readMethod_society_cleanup_candidacy_V25(c, &method->basic.society_cleanup_candidacy_V25))
        break;
    case 6675: /* module 26 call 19 */
        CHECK_ERROR(_readMethod_society_cleanup_challenge_V25(c, &method->basic.society_cleanup_challenge_V25))
        break;
    case 6913: /* module 27 call 1 */
        CHECK_ERROR(_readMethod_recovery_set_recovered_V25(c, &method->basic.recovery_set_recovered_V25))
        break;
    case 6915: /* module 27 call 3 */
        CHECK_ERROR(_readMethod_recovery_initiate_recovery_V25(c, &method->basic.recovery_initiate_recovery_V25))
        break;
    case 6916: /* module 27 call 4 */
        CHECK_ERROR(_readMethod_recovery_vouch_recovery_V25(c, &method->basic.recovery_vouch_recovery_V25))
        break;
    case 6917: /* module 27 call 5 */
        CHECK_ERROR(_readMethod_recovery_claim_recovery_V25(c, &method->basic.recovery_claim_recovery_V25))
        break;
    case 6918: /* module 27 call 6 */
        CHECK_ERROR(_readMethod_recovery_close_recovery_V25(c, &method->basic.recovery_close_recovery_V25))
        break;
    case 6919: /* module 27 call 7 */
        CHECK_ERROR(_readMethod_recovery_remove_recovery_V25(c, &method->basic.recovery_remove_recovery_V25))
        break;
    case 6920: /* module 27 call 8 */
        CHECK_ERROR(_readMethod_recovery_cancel_recovered_V25(c, &method->basic.recovery_cancel_recovered_V25))
        break;
    ...
    case 9728: /* module 38 call 0 */
        CHECK_ERROR(_readMethod_nis_place_bid_V25(c, &method->basic.nis_place_bid_V25))
        break;
    case 9729: /* module 38 call 1 */
        CHECK_ERROR(_readMethod_nis_retract_bid_V25(c, &method->basic.nis_retract_bid_V25))
        break;
    case 9730: /* module 38 call 2 */
        CHECK_ERROR(_readMethod_nis_fund_deficit_V25(c, &method->basic.nis_fund_deficit_V25))
        break;
    case 9731: /* module 38 call 3 */
        CHECK_ERROR(_readMethod_nis_thaw_private_V25(c, &method->basic.nis_thaw_private_V25))
        break;
    case 9732: /* module 38 call 4 */
        CHECK_ERROR(_readMethod_nis_thaw_communal_V25(c, &method->basic.nis_thaw_communal_V25))
        break;
    case 9733: /* module 38 call 5 */
        CHECK_ERROR(_readMethod_nis_communify_V25(c, &method->basic.nis_communify_V25))
        break;
    case 9734: /* module 38 call 6 */
        CHECK_ERROR(_readMethod_nis_privatize_V25(c, &method->basic.nis_privatize_V25))
        break;
    case 11520: /* module 45 call 0 */
        CHECK_ERROR(_readMethod_niscounterpartbalances_transfer_allow_death_V25(c, &method->basic.niscounterpartbalances_transfer_allow_death_V25))
        break;
    case 11522: /* module 45 call 2 */
        CHECK_ERROR(_readMethod_niscounterpartbalances_force_transfer_V25(c, &method->basic.niscounterpartbalances_force_transfer_V25))
        break;
    case 11523: /* module 45 call 3 */
        CHECK_ERROR(_readMethod_niscounterpartbalances_transfer_keep_alive_V25(c, &method->basic.niscounterpartbalances_transfer_keep_alive_V25))
        break;
    case 11524: /* module 45 call 4 */
        CHECK_ERROR(_readMethod_niscounterpartbalances_transfer_all_V25(c, &method->basic.niscounterpartbalances_transfer_all_V25))
        break;
    case 11525: /* module 45 call 5 */
        CHECK_ERROR(_readMethod_niscounterpartbalances_force_unreserve_V25(c, &method->basic.niscounterpartbalances_force_unreserve_V25))
        break;
    case 11526: /* module 45 call 6 */
        CHECK_ERROR(_readMethod_niscounterpartbalances_upgrade_accounts_V25(c, &method->basic.niscounterpartbalances_upgrade_accounts_V25))
        break;
    case 11528: /* module 45 call 8 */
        CHECK_ERROR(_readMethod_niscounterpartbalances_force_set_balance_V25(c, &method->basic.niscounterpartbalances_force_set_balance_V25))
        break;
    ...
    case 13070: /* module 51 call 14 */
        CHECK_ERROR(_readMethod_configuration_set_dispute_period_V25(c, &method->basic.configuration_set_dispute_period_V25))
        break;
    ...
    uint8_t pageIdx, uint8_t* pageCount)
{
    ...
    case 5632: /* module 22 call 0 */
        switch (itemIdx) {
        case 0: /* fellowshipcollective_add_member_V25 - who */;
            return _toStringAccountIdLookupOfT(
                &m->basic.fellowshipcollective_add_member_V25.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5633: /* module 22 call 1 */
        switch (itemIdx) {
        case 0: /* fellowshipcollective_promote_member_V25 - who */;
            return _toStringAccountIdLookupOfT(
                &m->basic.fellowshipcollective_promote_member_V25.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5634: /* module 22 call 2 */
        switch (itemIdx) {
        case 0: /* fellowshipcollective_demote_member_V25 - who */;
            return _toStringAccountIdLookupOfT(
                &m->basic.fellowshipcollective_demote_member_V25.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5635: /* module 22 call 3 */
        switch (itemIdx) {
        case 0: /* fellowshipcollective_remove_member_V25 - who */;
            return _toStringAccountIdLookupOfT(
                &m->basic.fellowshipcollective_remove_member_V25.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* fellowshipcollective_remove_member_V25 - min_rank */;
            return _toStringRank(
                &m->basic.fellowshipcollective_remove_member_V25.min_rank,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5636: /* module 22 call 4 */
        switch (itemIdx) {
        case 0: /* fellowshipcollective_vote_V25 - poll */;
            return _toStringPollIndexOf(
                &m->basic.fellowshipcollective_vote_V25.poll,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* fellowshipcollective_vote_V25 - aye */;
            return _toStringbool(
                &m->basic.fellowshipcollective_vote_V25.aye,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5637: /* module 22 call 5 */
        switch (itemIdx) {
        case 0: /* fellowshipcollective_cleanup_poll_V25 - poll_index */;
            return _toStringPollIndexOf(
                &m->basic.fellowshipcollective_cleanup_poll_V25.poll_index,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* fellowshipcollective_cleanup_poll_V25 - max */;
            return _toStringu32(
                &m->basic.fellowshipcollective_cleanup_poll_V25.max,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5888: /* module 23 call 0 */
        switch (itemIdx) {
        case 0: /* fellowshipreferenda_submit_V25 - proposal_origin */;
            return _toStringBoxPalletsOrigin(
                &m->basic.fellowshipreferenda_submit_V25.proposal_origin,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* fellowshipreferenda_submit_V25 - proposal */;
            return _toStringBoundedCallOfT(
                &m->basic.fellowshipreferenda_submit_V25.proposal,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* fellowshipreferenda_submit_V25 - enactment_moment */;
            return _toStringDispatchTimeBlockNumber(
                &m->basic.fellowshipreferenda_submit_V25.enactment_moment,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5889: /* module 23 call 1 */
        switch (itemIdx) {
        case 0: /* fellowshipreferenda_place_decision_deposit_V25 - index */;
            return _toStringReferendumIndex(
                &m->basic.fellowshipreferenda_place_decision_deposit_V25.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5890: /* module 23 call 2 */
        switch (itemIdx) {
        case 0: /* fellowshipreferenda_refund_decision_deposit_V25 - index */;
            return _toStringReferendumIndex(
                &m->basic.fellowshipreferenda_refund_decision_deposit_V25.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5891: /* module 23 call 3 */
        switch (itemIdx) {
        case 0: /* fellowshipreferenda_cancel_V25 - index */;
            return _toStringReferendumIndex(
                &m->basic.fellowshipreferenda_cancel_V25.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5892: /* module 23 call 4 */
        switch (itemIdx) {
        case 0: /* fellowshipreferenda_kill_V25 - index */;
            return _toStringReferendumIndex(
                &m->basic.fellowshipreferenda_kill_V25.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5893: /* module 23 call 5 */
        switch (itemIdx) {
        case 0: /* fellowshipreferenda_nudge_referendum_V25 - index */;
            return _toStringReferendumIndex(
                &m->basic.fellowshipreferenda_nudge_referendum_V25.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5894: /* module 23 call 6 */
        switch (itemIdx) {
        case 0: /* fellowshipreferenda_one_fewer_deciding_V25 - track */;
            return _toStringTrackIdOf(
                &m->basic.fellowshipreferenda_one_fewer_deciding_V25.track,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5895: /* module 23 call 7 */
        switch (itemIdx) {
        case 0: /* fellowshipreferenda_refund_submission_deposit_V25 - index */;
            return _toStringReferendumIndex(
                &m->basic.fellowshipreferenda_refund_submission_deposit_V25.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5896: /* module 23 call 8 */
        switch (itemIdx) {
        case 0: /* fellowshipreferenda_set_metadata_V25 - index */;
            return _toStringReferendumIndex(
                &m->basic.fellowshipreferenda_set_metadata_V25.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* fellowshipreferenda_set_metadata_V25 - maybe_hash */;
            return _toStringOptionHash(
                &m->basic.fellowshipreferenda_set_metadata_V25.maybe_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6656: /* module 26 call 0 */
        ...
        case 0: /* society_bid_V25 - amount */;
            return _toStringBalanceOf(
                &m->basic.society_bid_V25.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6658: /* module 26 call 2 */
        switch (itemIdx) {
        case 0: /* society_vouch_V25 - who */;
            return _toStringAccountIdLookupOfT(
                &m->basic.society_vouch_V25.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* society_vouch_V25 - amount */;
            return _toStringBalanceOf(
                &m->basic.society_vouch_V25.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* society_vouch_V25 - tip */;
            return _toStringBalanceOf(
                &m->basic.society_vouch_V25.tip,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6660: /* module 26 call 4 */
        switch (itemIdx) {
        case 0: /* society_vote_V25 - candidate */;
            return _toStringAccountIdLookupOfT(
                &m->basic.society_vote_V25.candidate,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* society_vote_V25 - approve */;
            return _toStringbool(
                &m->basic.society_vote_V25.approve,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6661: /* module 26 call 5 */
        switch (itemIdx) {
        case 0: /* society_defender_vote_V25 - approve */;
            return _toStringbool(
                &m->basic.society_defender_vote_V25.approve,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6663: /* module 26 call 7 */
        switch (itemIdx) {
        case 0: /* society_waive_repay_V25 - amount */;
            return _toStringBalanceOf(
                &m->basic.society_waive_repay_V25.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6664: /* module 26 call 8 */
        switch (itemIdx) {
        case 0: /* society_found_society_V25 - founder */;
            return _toStringAccountIdLookupOfT(
                &m->basic.society_found_society_V25.founder,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* society_found_society_V25 - max_members */;
            return _toStringu32(
                &m->basic.society_found_society_V25.max_members,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* society_found_society_V25 - max_intake */;
            return _toStringu32(
                &m->basic.society_found_society_V25.max_intake,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* society_found_society_V25 - max_strikes */;
            return _toStringu32(
                &m->basic.society_found_society_V25.max_strikes,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* society_found_society_V25 - candidate_deposit */;
            return _toStringBalanceOf(
                &m->basic.society_found_society_V25.candidate_deposit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* society_found_society_V25 - rules */;
            return _toStringVecu8(
                &m->basic.society_found_society_V25.rules,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6666: /* module 26 call 10 */
        switch (itemIdx) {
        case 0: /* society_judge_suspended_member_V25 - who */;
            return _toStringAccountIdLookupOfT(
                &m->basic.society_judge_suspended_member_V25.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* society_judge_suspended_member_V25 - forgive */;
            return _toStringbool(
                &m->basic.society_judge_suspended_member_V25.forgive,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6667: /* module 26 call 11 */
        switch (itemIdx) {
        case 0: /* society_set_parameters_V25 - max_members */;
            return _toStringu32(
                &m->basic.society_set_parameters_V25.max_members,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* society_set_parameters_V25 - max_intake */;
            return _toStringu32(
                &m->basic.society_set_parameters_V25.max_intake,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* society_set_parameters_V25 - max_strikes */;
            return _toStringu32(
                &m->basic.society_set_parameters_V25.max_strikes,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* society_set_parameters_V25 - candidate_deposit */;
            return _toStringBalanceOf(
                &m->basic.society_set_parameters_V25.candidate_deposit,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6670: /* module 26 call 14 */
        switch (itemIdx) {
        case 0: /* society_bestow_membership_V25 - candidate */;
            return _toStringAccountId(
                &m->basic.society_bestow_membership_V25.candidate,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6671: /* module 26 call 15 */
        switch (itemIdx) {
        case 0: /* society_kick_candidate_V25 - candidate */;
            return _toStringAccountId(
                &m->basic.society_kick_candidate_V25.candidate,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6673: /* module 26 call 17 */
        switch (itemIdx) {
        case 0: /* society_drop_candidate_V25 - candidate */;
            return _toStringAccountId(
                &m->basic.society_drop_candidate_V25.candidate,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6674: /* module 26 call 18 */
        switch (itemIdx) {
        case 0: /* society_cleanup_candidacy_V25 - candidate */;
            return _toStringAccountId(
                &m->basic.society_cleanup_candidacy_V25.candidate,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* society_cleanup_candidacy_V25 - max */;
            return _toStringu32(
                &m->basic.society_cleanup_candidacy_V25.max,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6675: /* module 26 call 19 */
        switch (itemIdx) {
        case 0: /* society_cleanup_challenge_V25 - challenge_round */;
            return _toStringRoundIndex(
                &m->basic.society_cleanup_challenge_V25.challenge_round,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* society_cleanup_challenge_V25 - max */;
            return _toStringu32(
                &m->basic.society_cleanup_challenge_V25.max,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6913: /* module 27 call 1 */
        switch (itemIdx) {
        case 0: /* recovery_set_recovered_V25 - lost */;
            return _toStringAccountIdLookupOfT(
                &m->basic.recovery_set_recovered_V25.lost,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* recovery_set_recovered_V25 - rescuer */;
            return _toStringAccountIdLookupOfT(
                &m->basic.recovery_set_recovered_V25.rescuer,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6915: /* module 27 call 3 */
        switch (itemIdx) {
        case 0: /* recovery_initiate_recovery_V25 - account */;
            return _toStringAccountIdLookupOfT(
                &m->basic.recovery_initiate_recovery_V25.account,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6916: /* module 27 call 4 */
        switch (itemIdx) {
        case 0: /* recovery_vouch_recovery_V25 - lost */;
            return _toStringAccountIdLookupOfT(
                &m->basic.recovery_vouch_recovery_V25.lost,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* recovery_vouch_recovery_V25 - rescuer */;
            return _toStringAccountIdLookupOfT(
                &m->basic.recovery_vouch_recovery_V25.rescuer,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6917: /* module 27 call 5 */
        switch (itemIdx) {
        case 0: /* recovery_claim_recovery_V25 - account */;
            return _toStringAccountIdLookupOfT(
                &m->basic.recovery_claim_recovery_V25.account,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6918: /* module 27 call 6 */
        switch (itemIdx) {
        case 0: /* recovery_close_recovery_V25 - rescuer */;
            return _toStringAccountIdLookupOfT(
                &m->basic.recovery_close_recovery_V25.rescuer,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6920: /* module 27 call 8 */
        switch (itemIdx) {
        case 0: /* recovery_cancel_recovered_V25 - account */;
            return _toStringAccountIdLookupOfT(
                &m->basic.recovery_cancel_recovered_V25.account,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9728: /* module 38 call 0 */
        switch (itemIdx) {
        case 0: /* nis_place_bid_V25 - amount */;
            return _toStringCompactu128(
                &m->basic.nis_place_bid_V25.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* nis_place_bid_V25 - duration */;
            return _toStringu32(
                &m->basic.nis_place_bid_V25.duration,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9729: /* module 38 call 1 */
        switch (itemIdx) {
        case 0: /* nis_retract_bid_V25 - amount */;
            return _toStringCompactu128(
                &m->basic.nis_retract_bid_V25.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* nis_retract_bid_V25 - duration */;
            return _toStringu32(
                &m->basic.nis_retract_bid_V25.duration,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9731: /* module 38 call 3 */
        switch (itemIdx) {
        case 0: /* nis_thaw_private_V25 - index */;
            return _toStringCompactu32(
                &m->basic.nis_thaw_private_V25.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* nis_thaw_private_V25 - maybe_proportion */;
            return _toStringOptionPerquintill(
                &m->basic.nis_thaw_private_V25.maybe_proportion,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9732: /* module 38 call 4 */
        switch (itemIdx) {
        case 0: /* nis_thaw_communal_V25 - index */;
            return _toStringCompactu32(
                &m->basic.nis_thaw_communal_V25.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9733: /* module 38 call 5 */
        switch (itemIdx) {
        case 0: /* nis_communify_V25 - index */;
            return _toStringCompactu32(
                &m->basic.nis_communify_V25.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9734: /* module 38 call 6 */
        switch (itemIdx) {
        case 0: /* nis_privatize_V25 - index */;
            return _toStringCompactu32(
                &m->basic.nis_privatize_V25.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11520: /* module 45 call 0 */
        switch (itemIdx) {
        case 0: /* niscounterpartbalances_transfer_allow_death_V25 - dest */;
            return _toStringAccountIdLookupOfT(
                &m->basic.niscounterpartbalances_transfer_allow_death_V25.dest,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* niscounterpartbalances_transfer_allow_death_V25 - amount */;
            return _toStringCompactu128(
                &m->basic.niscounterpartbalances_transfer_allow_death_V25.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11522: /* module 45 call 2 */
        switch (itemIdx) {
        case 0: /* niscounterpartbalances_force_transfer_V25 - source */;
            return _toStringAccountIdLookupOfT(
                &m->basic.niscounterpartbalances_force_transfer_V25.source,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* niscounterpartbalances_force_transfer_V25 - dest */;
            return _toStringAccountIdLookupOfT(
                &m->basic.niscounterpartbalances_force_transfer_V25.dest,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* niscounterpartbalances_force_transfer_V25 - amount */;
            return _toStringCompactu128(
                &m->basic.niscounterpartbalances_force_transfer_V25.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11523: /* module 45 call 3 */
        switch (itemIdx) {
        case 0: /* niscounterpartbalances_transfer_keep_alive_V25 - dest */;
            return _toStringAccountIdLookupOfT(
                &m->basic.niscounterpartbalances_transfer_keep_alive_V25.dest,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* niscounterpartbalances_transfer_keep_alive_V25 - amount */;
            return _toStringCompactu128(
                &m->basic.niscounterpartbalances_transfer_keep_alive_V25.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11524: /* module 45 call 4 */
        switch (itemIdx) {
        case 0: /* niscounterpartbalances_transfer_all_V25 - dest */;
            return _toStringAccountIdLookupOfT(
                &m->basic.niscounterpartbalances_transfer_all_V25.dest,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* niscounterpartbalances_transfer_all_V25 - keep_alive */;
            return _toStringbool(
                &m->basic.niscounterpartbalances_transfer_all_V25.keep_alive,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11525: /* module 45 call 5 */
        switch (itemIdx) {
        case 0: /* niscounterpartbalances_force_unreserve_V25 - who */;
            return _toStringAccountIdLookupOfT(
                &m->basic.niscounterpartbalances_force_unreserve_V25.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* niscounterpartbalances_force_unreserve_V25 - amount */;
            return _toStringBalance(
                &m->basic.niscounterpartbalances_force_unreserve_V25.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11526: /* module 45 call 6 */
        switch (itemIdx) {
        case 0: /* niscounterpartbalances_upgrade_accounts_V25 - who */;
            return _toStringVecAccountId(
                &m->basic.niscounterpartbalances_upgrade_accounts_V25.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11528: /* module 45 call 8 */
        switch (itemIdx) {
        case 0: /* niscounterpartbalances_force_set_balance_V25 - who */;
            return _toStringAccountIdLookupOfT(
                &m->basic.niscounterpartbalances_force_set_balance_V25.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* niscounterpartbalances_force_set_balance_V25 - new_free */;
            return _toStringCompactu128(
                &m->basic.niscounterpartbalances_force_set_balance_V25.new_free,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 13070: /* module 51 call 14 */
        switch (itemIdx) {
        case 0: /* configuration_set_dispute_period_V25 - new_ */;
            return _toStringSessionIndex(
                &m->basic.configuration_set_dispute_period_V25.new_,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
...
bool _getMethod_IsNestingSupported_V25(uint8_t moduleIdx, uint8_t callIdx)
{
    ...
    case 8196: // Preimage:Ensure updated
    ...
    case 10517: // NominationPools:Adjust pool deposit
