...
#define PD_CALL_TIMESTAMP_V19 2
#define PD_CALL_INDICES_V19 3
#define PD_CALL_BALANCES_V19 4
#define PD_CALL_STAKING_V19 6
#define PD_CALL_SESSION_V19 8
#define PD_CALL_DEMOCRACY_V19 13
#define PD_CALL_COUNCIL_V19 14
#define PD_CALL_TECHNICALCOMMITTEE_V19 15
#define PD_CALL_PHRAGMENELECTION_V19 16
#define PD_CALL_TECHNICALMEMBERSHIP_V19 17
#define PD_CALL_TREASURY_V19 18
#define PD_CALL_CONVICTIONVOTING_V19 20
#define PD_CALL_REFERENDA_V19 21
#define PD_CALL_FELLOWSHIPCOLLECTIVE_V19 22
#define PD_CALL_FELLOWSHIPREFERENDA_V19 23
#define PD_CALL_WHITELIST_V19 44
#define PD_CALL_CLAIMS_V19 19
#define PD_CALL_UTILITY_V19 24
#define PD_CALL_IDENTITY_V19 25
#define PD_CALL_SOCIETY_V19 26
#define PD_CALL_RECOVERY_V19 27
#define PD_CALL_VESTING_V19 28
#define PD_CALL_PROXY_V19 30
#define PD_CALL_MULTISIG_V19 31
#define PD_CALL_PREIMAGE_V19 32
#define PD_CALL_BOUNTIES_V19 35
#define PD_CALL_CHILDBOUNTIES_V19 40
#define PD_CALL_TIPS_V19 36
#define PD_CALL_NIS_V19 38
#define PD_CALL_NISCOUNTERPARTBALANCES_V19 45
#define PD_CALL_VOTERLIST_V19 39
#define PD_CALL_NOMINATIONPOOLS_V19 41
#define PD_CALL_FASTUNSTAKE_V19 42
...
#define PD_CALL_STAKING_SET_MIN_COMMISSION_V19 25
typedef struct {
    pd_Perbill_t new_;
} pd_staking_set_min_commission_V19_t;
...
#define PD_CALL_CONVICTIONVOTING_VOTE_V19 0
typedef struct {
    pd_Compactu32_t poll_index;
    pd_AccountVote_t vote;
} pd_convictionvoting_vote_V19_t;

#define PD_CALL_CONVICTIONVOTING_DELEGATE_V19 1
typedef struct {
    pd_ClassOf_t class_;
    pd_AccountIdLookupOfT_t to;
    pd_Conviction_t conviction;
    pd_BalanceOf_t balance;
} pd_convictionvoting_delegate_V19_t;

#define PD_CALL_CONVICTIONVOTING_UNDELEGATE_V19 2
typedef struct {
    pd_ClassOf_t class_;
} pd_convictionvoting_undelegate_V19_t;

#define PD_CALL_CONVICTIONVOTING_UNLOCK_V19 3
typedef struct {
    pd_ClassOf_t class_;
    pd_AccountIdLookupOfT_t target;
} pd_convictionvoting_unlock_V19_t;

#define PD_CALL_CONVICTIONVOTING_REMOVE_VOTE_V19 4
typedef struct {
    pd_OptionClassOf_t class_;
    pd_PollIndexOf_t index;
} pd_convictionvoting_remove_vote_V19_t;

#define PD_CALL_CONVICTIONVOTING_REMOVE_OTHER_VOTE_V19 5
typedef struct {
    pd_AccountIdLookupOfT_t target;
    pd_ClassOf_t class_;
    pd_PollIndexOf_t index;
} pd_convictionvoting_remove_other_vote_V19_t;

#define PD_CALL_REFERENDA_PLACE_DECISION_DEPOSIT_V19 1
typedef struct {
    pd_ReferendumIndex_t index;
} pd_referenda_place_decision_deposit_V19_t;

#define PD_CALL_REFERENDA_REFUND_DECISION_DEPOSIT_V19 2
typedef struct {
    pd_ReferendumIndex_t index;
} pd_referenda_refund_decision_deposit_V19_t;

#define PD_CALL_REFERENDA_CANCEL_V19 3
typedef struct {
    pd_ReferendumIndex_t index;
} pd_referenda_cancel_V19_t;

#define PD_CALL_REFERENDA_KILL_V19 4
typedef struct {
    pd_ReferendumIndex_t index;
} pd_referenda_kill_V19_t;

#define PD_CALL_REFERENDA_NUDGE_REFERENDUM_V19 5
typedef struct {
    pd_ReferendumIndex_t index;
} pd_referenda_nudge_referendum_V19_t;

#define PD_CALL_REFERENDA_ONE_FEWER_DECIDING_V19 6
typedef struct {
    pd_TrackIdOf_t track;
} pd_referenda_one_fewer_deciding_V19_t;

#define PD_CALL_REFERENDA_REFUND_SUBMISSION_DEPOSIT_V19 7
typedef struct {
    pd_ReferendumIndex_t index;
} pd_referenda_refund_submission_deposit_V19_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_ADD_MEMBER_V19 0
typedef struct {
    pd_AccountIdLookupOfT_t who;
} pd_fellowshipcollective_add_member_V19_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_PROMOTE_MEMBER_V19 1
typedef struct {
    pd_AccountIdLookupOfT_t who;
} pd_fellowshipcollective_promote_member_V19_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_DEMOTE_MEMBER_V19 2
typedef struct {
    pd_AccountIdLookupOfT_t who;
} pd_fellowshipcollective_demote_member_V19_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_REMOVE_MEMBER_V19 3
typedef struct {
    pd_AccountIdLookupOfT_t who;
    pd_Rank_t min_rank;
} pd_fellowshipcollective_remove_member_V19_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_VOTE_V19 4
typedef struct {
    pd_PollIndexOf_t poll;
    pd_bool_t aye;
} pd_fellowshipcollective_vote_V19_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_CLEANUP_POLL_V19 5
typedef struct {
    pd_PollIndexOf_t poll_index;
    pd_u32_t max;
} pd_fellowshipcollective_cleanup_poll_V19_t;

#define PD_CALL_FELLOWSHIPREFERENDA_PLACE_DECISION_DEPOSIT_V19 1
typedef struct {
    pd_ReferendumIndex_t index;
} pd_fellowshipreferenda_place_decision_deposit_V19_t;

#define PD_CALL_FELLOWSHIPREFERENDA_REFUND_DECISION_DEPOSIT_V19 2
typedef struct {
    pd_ReferendumIndex_t index;
} pd_fellowshipreferenda_refund_decision_deposit_V19_t;

#define PD_CALL_FELLOWSHIPREFERENDA_CANCEL_V19 3
typedef struct {
    pd_ReferendumIndex_t index;
} pd_fellowshipreferenda_cancel_V19_t;

#define PD_CALL_FELLOWSHIPREFERENDA_KILL_V19 4
typedef struct {
    pd_ReferendumIndex_t index;
} pd_fellowshipreferenda_kill_V19_t;

#define PD_CALL_FELLOWSHIPREFERENDA_NUDGE_REFERENDUM_V19 5
typedef struct {
    pd_ReferendumIndex_t index;
} pd_fellowshipreferenda_nudge_referendum_V19_t;

#define PD_CALL_FELLOWSHIPREFERENDA_ONE_FEWER_DECIDING_V19 6
typedef struct {
    pd_TrackIdOf_t track;
} pd_fellowshipreferenda_one_fewer_deciding_V19_t;

#define PD_CALL_FELLOWSHIPREFERENDA_REFUND_SUBMISSION_DEPOSIT_V19 7
typedef struct {
    pd_ReferendumIndex_t index;
} pd_fellowshipreferenda_refund_submission_deposit_V19_t;

#define PD_CALL_WHITELIST_WHITELIST_CALL_V19 0
typedef struct {
    pd_PreimageHash_t call_hash;
} pd_whitelist_whitelist_call_V19_t;

#define PD_CALL_WHITELIST_REMOVE_WHITELISTED_CALL_V19 1
typedef struct {
    pd_PreimageHash_t call_hash;
} pd_whitelist_remove_whitelisted_call_V19_t;

#define PD_CALL_WHITELIST_DISPATCH_WHITELISTED_CALL_V19 2
typedef struct {
    pd_PreimageHash_t call_hash;
    pd_u32_t call_encoded_len;
    pd_Weight_t call_weight_witness;
} pd_whitelist_dispatch_whitelisted_call_V19_t;

#define PD_CALL_WHITELIST_DISPATCH_WHITELISTED_CALL_WITH_PREIMAGE_V19 3
typedef struct {
    pd_Call_t call;
} pd_whitelist_dispatch_whitelisted_call_with_preimage_V19_t;
...
#define PD_CALL_SOCIETY_BID_V19 0
typedef struct {
    pd_BalanceOf_t amount;
} pd_society_bid_V19_t;

#define PD_CALL_SOCIETY_UNBID_V19 1
typedef struct {
    pd_u32_t pos;
} pd_society_unbid_V19_t;

#define PD_CALL_SOCIETY_VOUCH_V19 2
typedef struct {
    pd_AccountIdLookupOfT_t who;
    pd_BalanceOf_t amount;
    pd_BalanceOf_t tip;
} pd_society_vouch_V19_t;

#define PD_CALL_SOCIETY_UNVOUCH_V19 3
typedef struct {
    pd_u32_t pos;
} pd_society_unvouch_V19_t;

#define PD_CALL_SOCIETY_VOTE_V19 4
typedef struct {
    pd_AccountIdLookupOfT_t candidate;
    pd_bool_t approve;
} pd_society_vote_V19_t;

#define PD_CALL_SOCIETY_DEFENDER_VOTE_V19 5
typedef struct {
    pd_bool_t approve;
} pd_society_defender_vote_V19_t;

#define PD_CALL_SOCIETY_PAYOUT_V19 6
typedef struct {
} pd_society_payout_V19_t;

#define PD_CALL_SOCIETY_FOUND_V19 7
typedef struct {
    pd_AccountIdLookupOfT_t founder;
    pd_u32_t max_members;
    pd_Bytes_t rules;
} pd_society_found_V19_t;

#define PD_CALL_SOCIETY_UNFOUND_V19 8
typedef struct {
} pd_society_unfound_V19_t;

#define PD_CALL_SOCIETY_JUDGE_SUSPENDED_MEMBER_V19 9
typedef struct {
    pd_AccountIdLookupOfT_t who;
    pd_bool_t forgive;
} pd_society_judge_suspended_member_V19_t;

#define PD_CALL_SOCIETY_SET_MAX_MEMBERS_V19 11
typedef struct {
    pd_u32_t max;
} pd_society_set_max_members_V19_t;

#define PD_CALL_RECOVERY_SET_RECOVERED_V19 1
typedef struct {
    pd_AccountIdLookupOfT_t lost;
    pd_AccountIdLookupOfT_t rescuer;
} pd_recovery_set_recovered_V19_t;

#define PD_CALL_RECOVERY_INITIATE_RECOVERY_V19 3
typedef struct {
    pd_AccountIdLookupOfT_t account;
} pd_recovery_initiate_recovery_V19_t;

#define PD_CALL_RECOVERY_VOUCH_RECOVERY_V19 4
typedef struct {
    pd_AccountIdLookupOfT_t lost;
    pd_AccountIdLookupOfT_t rescuer;
} pd_recovery_vouch_recovery_V19_t;

#define PD_CALL_RECOVERY_CLAIM_RECOVERY_V19 5
typedef struct {
    pd_AccountIdLookupOfT_t account;
} pd_recovery_claim_recovery_V19_t;

#define PD_CALL_RECOVERY_CLOSE_RECOVERY_V19 6
typedef struct {
    pd_AccountIdLookupOfT_t rescuer;
} pd_recovery_close_recovery_V19_t;

#define PD_CALL_RECOVERY_REMOVE_RECOVERY_V19 7
typedef struct {
} pd_recovery_remove_recovery_V19_t;

#define PD_CALL_RECOVERY_CANCEL_RECOVERED_V19 8
typedef struct {
    pd_AccountIdLookupOfT_t account;
} pd_recovery_cancel_recovered_V19_t;
...
#define PD_CALL_NIS_PLACE_BID_V19 0
typedef struct {
    pd_Compactu128_t amount;
    pd_u32_t duration;
} pd_nis_place_bid_V19_t;

#define PD_CALL_NIS_RETRACT_BID_V19 1
typedef struct {
    pd_Compactu128_t amount;
    pd_u32_t duration;
} pd_nis_retract_bid_V19_t;

#define PD_CALL_NIS_FUND_DEFICIT_V19 2
typedef struct {
} pd_nis_fund_deficit_V19_t;

#define PD_CALL_NIS_THAW_V19 3
typedef struct {
    pd_Compactu32_t index;
    pd_Optionu128_t portion;
} pd_nis_thaw_V19_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_TRANSFER_V19 0
typedef struct {
    pd_AccountIdLookupOfT_t dest;
    pd_Compactu128_t amount;
} pd_niscounterpartbalances_transfer_V19_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_SET_BALANCE_V19 1
typedef struct {
    pd_AccountIdLookupOfT_t who;
    pd_Compactu128_t new_free;
    pd_Compactu128_t new_reserved;
} pd_niscounterpartbalances_set_balance_V19_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_FORCE_TRANSFER_V19 2
typedef struct {
    pd_AccountIdLookupOfT_t source;
    pd_AccountIdLookupOfT_t dest;
    pd_Compactu128_t amount;
} pd_niscounterpartbalances_force_transfer_V19_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_TRANSFER_KEEP_ALIVE_V19 3
typedef struct {
    pd_AccountIdLookupOfT_t dest;
    pd_Compactu128_t amount;
} pd_niscounterpartbalances_transfer_keep_alive_V19_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_TRANSFER_ALL_V19 4
typedef struct {
    pd_AccountIdLookupOfT_t dest;
    pd_bool_t keep_alive;
} pd_niscounterpartbalances_transfer_all_V19_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_FORCE_UNRESERVE_V19 5
typedef struct {
    pd_AccountIdLookupOfT_t who;
    pd_Balance_t amount;
} pd_niscounterpartbalances_force_unreserve_V19_t;
...
#define PD_CALL_CONFIGURATION_SET_DISPUTE_PERIOD_V19 14
typedef struct {
    pd_SessionIndex_t new_;
} pd_configuration_set_dispute_period_V19_t;
...
typedef union {
    ...
    pd_staking_set_min_commission_V19_t staking_set_min_commission_V19;
    ...
    pd_convictionvoting_vote_V19_t convictionvoting_vote_V19;
    pd_convictionvoting_delegate_V19_t convictionvoting_delegate_V19;
    pd_convictionvoting_undelegate_V19_t convictionvoting_undelegate_V19;
    pd_convictionvoting_unlock_V19_t convictionvoting_unlock_V19;
    pd_convictionvoting_remove_vote_V19_t convictionvoting_remove_vote_V19;
    pd_convictionvoting_remove_other_vote_V19_t convictionvoting_remove_other_vote_V19;
    pd_referenda_place_decision_deposit_V19_t referenda_place_decision_deposit_V19;
    pd_referenda_refund_decision_deposit_V19_t referenda_refund_decision_deposit_V19;
    pd_referenda_cancel_V19_t referenda_cancel_V19;
    pd_referenda_kill_V19_t referenda_kill_V19;
    pd_referenda_nudge_referendum_V19_t referenda_nudge_referendum_V19;
    pd_referenda_one_fewer_deciding_V19_t referenda_one_fewer_deciding_V19;
    pd_referenda_refund_submission_deposit_V19_t referenda_refund_submission_deposit_V19;
    pd_fellowshipcollective_add_member_V19_t fellowshipcollective_add_member_V19;
    pd_fellowshipcollective_promote_member_V19_t fellowshipcollective_promote_member_V19;
    pd_fellowshipcollective_demote_member_V19_t fellowshipcollective_demote_member_V19;
    pd_fellowshipcollective_remove_member_V19_t fellowshipcollective_remove_member_V19;
    pd_fellowshipcollective_vote_V19_t fellowshipcollective_vote_V19;
    pd_fellowshipcollective_cleanup_poll_V19_t fellowshipcollective_cleanup_poll_V19;
    pd_fellowshipreferenda_place_decision_deposit_V19_t fellowshipreferenda_place_decision_deposit_V19;
    pd_fellowshipreferenda_refund_decision_deposit_V19_t fellowshipreferenda_refund_decision_deposit_V19;
    pd_fellowshipreferenda_cancel_V19_t fellowshipreferenda_cancel_V19;
    pd_fellowshipreferenda_kill_V19_t fellowshipreferenda_kill_V19;
    pd_fellowshipreferenda_nudge_referendum_V19_t fellowshipreferenda_nudge_referendum_V19;
    pd_fellowshipreferenda_one_fewer_deciding_V19_t fellowshipreferenda_one_fewer_deciding_V19;
    pd_fellowshipreferenda_refund_submission_deposit_V19_t fellowshipreferenda_refund_submission_deposit_V19;
    pd_whitelist_whitelist_call_V19_t whitelist_whitelist_call_V19;
    pd_whitelist_remove_whitelisted_call_V19_t whitelist_remove_whitelisted_call_V19;
    pd_whitelist_dispatch_whitelisted_call_V19_t whitelist_dispatch_whitelisted_call_V19;
    pd_whitelist_dispatch_whitelisted_call_with_preimage_V19_t whitelist_dispatch_whitelisted_call_with_preimage_V19;
    ...
    pd_society_bid_V19_t society_bid_V19;
    pd_society_unbid_V19_t society_unbid_V19;
    pd_society_vouch_V19_t society_vouch_V19;
    pd_society_unvouch_V19_t society_unvouch_V19;
    pd_society_vote_V19_t society_vote_V19;
    pd_society_defender_vote_V19_t society_defender_vote_V19;
    pd_society_payout_V19_t society_payout_V19;
    pd_society_found_V19_t society_found_V19;
    pd_society_unfound_V19_t society_unfound_V19;
    pd_society_judge_suspended_member_V19_t society_judge_suspended_member_V19;
    pd_society_set_max_members_V19_t society_set_max_members_V19;
    pd_recovery_set_recovered_V19_t recovery_set_recovered_V19;
    pd_recovery_initiate_recovery_V19_t recovery_initiate_recovery_V19;
    pd_recovery_vouch_recovery_V19_t recovery_vouch_recovery_V19;
    pd_recovery_claim_recovery_V19_t recovery_claim_recovery_V19;
    pd_recovery_close_recovery_V19_t recovery_close_recovery_V19;
    pd_recovery_remove_recovery_V19_t recovery_remove_recovery_V19;
    pd_recovery_cancel_recovered_V19_t recovery_cancel_recovered_V19;
    ...
    pd_nis_place_bid_V19_t nis_place_bid_V19;
    pd_nis_retract_bid_V19_t nis_retract_bid_V19;
    pd_nis_fund_deficit_V19_t nis_fund_deficit_V19;
    pd_nis_thaw_V19_t nis_thaw_V19;
    pd_niscounterpartbalances_transfer_V19_t niscounterpartbalances_transfer_V19;
    pd_niscounterpartbalances_set_balance_V19_t niscounterpartbalances_set_balance_V19;
    pd_niscounterpartbalances_force_transfer_V19_t niscounterpartbalances_force_transfer_V19;
    pd_niscounterpartbalances_transfer_keep_alive_V19_t niscounterpartbalances_transfer_keep_alive_V19;
    pd_niscounterpartbalances_transfer_all_V19_t niscounterpartbalances_transfer_all_V19;
    pd_niscounterpartbalances_force_unreserve_V19_t niscounterpartbalances_force_unreserve_V19;
    ...
    pd_configuration_set_dispute_period_V19_t configuration_set_dispute_period_V19;
