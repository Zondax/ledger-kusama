...
#define PD_CALL_TIMESTAMP_V9 2
#define PD_CALL_INDICES_V9 3
#define PD_CALL_BALANCES_V9 4
#define PD_CALL_STAKING_V9 6
#define PD_CALL_SESSION_V9 8
#define PD_CALL_GRANDPA_V9 10
#define PD_CALL_DEMOCRACY_V9 13
#define PD_CALL_COUNCIL_V9 14
#define PD_CALL_TECHNICALCOMMITTEE_V9 15
#define PD_CALL_PHRAGMENELECTION_V9 16
#define PD_CALL_TECHNICALMEMBERSHIP_V9 17
#define PD_CALL_TREASURY_V9 18
#define PD_CALL_CLAIMS_V9 19
#define PD_CALL_UTILITY_V9 24
#define PD_CALL_IDENTITY_V9 25
#define PD_CALL_SOCIETY_V9 26
#define PD_CALL_RECOVERY_V9 27
#define PD_CALL_VESTING_V9 28
#define PD_CALL_PROXY_V9 30
#define PD_CALL_MULTISIG_V9 31
#define PD_CALL_PREIMAGE_V9 32
#define PD_CALL_BOUNTIES_V9 35
#define PD_CALL_TIPS_V9 36
#define PD_CALL_GILT_V9 38
#define PD_CALL_BAGSLIST_V9 39
...
#define PD_CALL_SOCIETY_BID_V9 0
typedef struct {
    pd_Balance_t amount;
} pd_society_bid_V9_t;

#define PD_CALL_SOCIETY_UNBID_V9 1
typedef struct {
    pd_u32_t pos;
} pd_society_unbid_V9_t;

#define PD_CALL_SOCIETY_VOUCH_V9 2
typedef struct {
    pd_AccountId_V9_t who;
    pd_Balance_t amount;
    pd_Balance_t tip;
} pd_society_vouch_V9_t;

#define PD_CALL_SOCIETY_UNVOUCH_V9 3
typedef struct {
    pd_u32_t pos;
} pd_society_unvouch_V9_t;

#define PD_CALL_SOCIETY_VOTE_V9 4
typedef struct {
    pd_LookupasStaticLookupSource_V9_t candidate;
    pd_bool_t approve;
} pd_society_vote_V9_t;

#define PD_CALL_SOCIETY_DEFENDER_VOTE_V9 5
typedef struct {
    pd_bool_t approve;
} pd_society_defender_vote_V9_t;

#define PD_CALL_SOCIETY_PAYOUT_V9 6
typedef struct {
} pd_society_payout_V9_t;

#define PD_CALL_SOCIETY_FOUND_V9 7
typedef struct {
    pd_AccountId_V9_t founder;
    pd_u32_t max_members;
    pd_Bytes_t rules;
} pd_society_found_V9_t;

#define PD_CALL_SOCIETY_UNFOUND_V9 8
typedef struct {
} pd_society_unfound_V9_t;

#define PD_CALL_SOCIETY_JUDGE_SUSPENDED_MEMBER_V9 9
typedef struct {
    pd_AccountId_V9_t who;
    pd_bool_t forgive;
} pd_society_judge_suspended_member_V9_t;

#define PD_CALL_SOCIETY_SET_MAX_MEMBERS_V9 11
typedef struct {
    pd_u32_t max;
} pd_society_set_max_members_V9_t;

#define PD_CALL_RECOVERY_SET_RECOVERED_V9 1
typedef struct {
    pd_AccountId_V9_t lost;
    pd_AccountId_V9_t rescuer;
} pd_recovery_set_recovered_V9_t;

#define PD_CALL_RECOVERY_INITIATE_RECOVERY_V9 3
typedef struct {
    pd_AccountId_V9_t account;
} pd_recovery_initiate_recovery_V9_t;

#define PD_CALL_RECOVERY_VOUCH_RECOVERY_V9 4
typedef struct {
    pd_AccountId_V9_t lost;
    pd_AccountId_V9_t rescuer;
} pd_recovery_vouch_recovery_V9_t;

#define PD_CALL_RECOVERY_CLAIM_RECOVERY_V9 5
typedef struct {
    pd_AccountId_V9_t account;
} pd_recovery_claim_recovery_V9_t;

#define PD_CALL_RECOVERY_CLOSE_RECOVERY_V9 6
typedef struct {
    pd_AccountId_V9_t rescuer;
} pd_recovery_close_recovery_V9_t;

#define PD_CALL_RECOVERY_REMOVE_RECOVERY_V9 7
typedef struct {
} pd_recovery_remove_recovery_V9_t;

#define PD_CALL_RECOVERY_CANCEL_RECOVERED_V9 8
typedef struct {
    pd_AccountId_V9_t account;
} pd_recovery_cancel_recovered_V9_t;
...
#define PD_CALL_GILT_PLACE_BID_V9 0
typedef struct {
    pd_CompactBalance_t amount;
    pd_u32_t duration;
} pd_gilt_place_bid_V9_t;

#define PD_CALL_GILT_RETRACT_BID_V9 1
typedef struct {
    pd_CompactBalance_t amount;
    pd_u32_t duration;
} pd_gilt_retract_bid_V9_t;
...
#define PD_CALL_BAGSLIST_PUT_IN_FRONT_OF_V9 1
typedef struct {
    pd_AccountId_V9_t lighter;
} pd_bagslist_put_in_front_of_V9_t;
...
#define PD_CALL_CONFIGURATION_SET_DISPUTE_PERIOD_V9 14
typedef struct {
    pd_SessionIndex_V9_t new_;
} pd_configuration_set_dispute_period_V9_t;
...
#define PD_CALL_PARASDISPUTES_FORCE_UNFREEZE_V9 0
typedef struct {
} pd_parasdisputes_force_unfreeze_V9_t;
...
typedef union {
    ...
    pd_society_bid_V9_t society_bid_V9;
    pd_society_unbid_V9_t society_unbid_V9;
    pd_society_vouch_V9_t society_vouch_V9;
    pd_society_unvouch_V9_t society_unvouch_V9;
    pd_society_vote_V9_t society_vote_V9;
    pd_society_defender_vote_V9_t society_defender_vote_V9;
    pd_society_payout_V9_t society_payout_V9;
    pd_society_found_V9_t society_found_V9;
    pd_society_unfound_V9_t society_unfound_V9;
    pd_society_judge_suspended_member_V9_t society_judge_suspended_member_V9;
    pd_society_set_max_members_V9_t society_set_max_members_V9;
    pd_recovery_set_recovered_V9_t recovery_set_recovered_V9;
    pd_recovery_initiate_recovery_V9_t recovery_initiate_recovery_V9;
    pd_recovery_vouch_recovery_V9_t recovery_vouch_recovery_V9;
    pd_recovery_claim_recovery_V9_t recovery_claim_recovery_V9;
    pd_recovery_close_recovery_V9_t recovery_close_recovery_V9;
    pd_recovery_remove_recovery_V9_t recovery_remove_recovery_V9;
    pd_recovery_cancel_recovered_V9_t recovery_cancel_recovered_V9;
    ...
    pd_gilt_place_bid_V9_t gilt_place_bid_V9;
    pd_gilt_retract_bid_V9_t gilt_retract_bid_V9;
    pd_bagslist_rebag_V9_t bagslist_rebag_V9;
    pd_bagslist_put_in_front_of_V9_t bagslist_put_in_front_of_V9;
    ...
    pd_configuration_set_dispute_period_V9_t configuration_set_dispute_period_V9;
    ...
    pd_parasdisputes_force_unfreeze_V9_t parasdisputes_force_unfreeze_V9;
