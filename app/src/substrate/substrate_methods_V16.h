...
#define PD_CALL_TIMESTAMP_V16 2
#define PD_CALL_INDICES_V16 3
#define PD_CALL_BALANCES_V16 4
#define PD_CALL_STAKING_V16 6
#define PD_CALL_SESSION_V16 8
#define PD_CALL_DEMOCRACY_V16 13
#define PD_CALL_COUNCIL_V16 14
#define PD_CALL_TECHNICALCOMMITTEE_V16 15
#define PD_CALL_PHRAGMENELECTION_V16 16
#define PD_CALL_TECHNICALMEMBERSHIP_V16 17
#define PD_CALL_TREASURY_V16 18
#define PD_CALL_CONVICTIONVOTING_V16 20
#define PD_CALL_REFERENDA_V16 21
#define PD_CALL_FELLOWSHIPCOLLECTIVE_V16 22
#define PD_CALL_FELLOWSHIPREFERENDA_V16 23
#define PD_CALL_WHITELIST_V16 44
#define PD_CALL_CLAIMS_V16 19
#define PD_CALL_UTILITY_V16 24
#define PD_CALL_IDENTITY_V16 25
#define PD_CALL_SOCIETY_V16 26
#define PD_CALL_RECOVERY_V16 27
#define PD_CALL_VESTING_V16 28
#define PD_CALL_PROXY_V16 30
#define PD_CALL_MULTISIG_V16 31
#define PD_CALL_PREIMAGE_V16 32
#define PD_CALL_BOUNTIES_V16 35
#define PD_CALL_CHILDBOUNTIES_V16 40
#define PD_CALL_TIPS_V16 36
#define PD_CALL_GILT_V16 38
#define PD_CALL_VOTERLIST_V16 39
#define PD_CALL_NOMINATIONPOOLS_V16 41
#define PD_CALL_FASTUNSTAKE_V16 42
...
#define PD_CALL_CONVICTIONVOTING_VOTE_V16 0
typedef struct {
    pd_Compactu32_t poll_index;
    pd_AccountVote_V16_t vote;
} pd_convictionvoting_vote_V16_t;

#define PD_CALL_CONVICTIONVOTING_DELEGATE_V16 1
typedef struct {
    pd_ClassOf_V16_t class_;
    pd_AccountIdLookupOfT_V16_t to;
    pd_Conviction_V16_t conviction;
    pd_BalanceOf_t balance;
} pd_convictionvoting_delegate_V16_t;

#define PD_CALL_CONVICTIONVOTING_UNDELEGATE_V16 2
typedef struct {
    pd_ClassOf_V16_t class_;
} pd_convictionvoting_undelegate_V16_t;

#define PD_CALL_CONVICTIONVOTING_UNLOCK_V16 3
typedef struct {
    pd_ClassOf_V16_t class_;
    pd_AccountIdLookupOfT_V16_t target;
} pd_convictionvoting_unlock_V16_t;

#define PD_CALL_CONVICTIONVOTING_REMOVE_VOTE_V16 4
typedef struct {
    pd_OptionClassOf_V16_t class_;
    pd_PollIndexOf_V16_t index;
} pd_convictionvoting_remove_vote_V16_t;

#define PD_CALL_CONVICTIONVOTING_REMOVE_OTHER_VOTE_V16 5
typedef struct {
    pd_AccountIdLookupOfT_V16_t target;
    pd_ClassOf_V16_t class_;
    pd_PollIndexOf_V16_t index;
} pd_convictionvoting_remove_other_vote_V16_t;

#define PD_CALL_REFERENDA_PLACE_DECISION_DEPOSIT_V16 1
typedef struct {
    pd_ReferendumIndex_V16_t index;
} pd_referenda_place_decision_deposit_V16_t;

#define PD_CALL_REFERENDA_REFUND_DECISION_DEPOSIT_V16 2
typedef struct {
    pd_ReferendumIndex_V16_t index;
} pd_referenda_refund_decision_deposit_V16_t;

#define PD_CALL_REFERENDA_CANCEL_V16 3
typedef struct {
    pd_ReferendumIndex_V16_t index;
} pd_referenda_cancel_V16_t;

#define PD_CALL_REFERENDA_KILL_V16 4
typedef struct {
    pd_ReferendumIndex_V16_t index;
} pd_referenda_kill_V16_t;

#define PD_CALL_REFERENDA_NUDGE_REFERENDUM_V16 5
typedef struct {
    pd_ReferendumIndex_V16_t index;
} pd_referenda_nudge_referendum_V16_t;

#define PD_CALL_REFERENDA_ONE_FEWER_DECIDING_V16 6
typedef struct {
    pd_TrackIdOf_V16_t track;
} pd_referenda_one_fewer_deciding_V16_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_ADD_MEMBER_V16 0
typedef struct {
    pd_AccountIdLookupOfT_V16_t who;
} pd_fellowshipcollective_add_member_V16_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_PROMOTE_MEMBER_V16 1
typedef struct {
    pd_AccountIdLookupOfT_V16_t who;
} pd_fellowshipcollective_promote_member_V16_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_DEMOTE_MEMBER_V16 2
typedef struct {
    pd_AccountIdLookupOfT_V16_t who;
} pd_fellowshipcollective_demote_member_V16_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_REMOVE_MEMBER_V16 3
typedef struct {
    pd_AccountIdLookupOfT_V16_t who;
    pd_Rank_V16_t min_rank;
} pd_fellowshipcollective_remove_member_V16_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_VOTE_V16 4
typedef struct {
    pd_PollIndexOf_V16_t poll;
    pd_bool_t aye;
} pd_fellowshipcollective_vote_V16_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_CLEANUP_POLL_V16 5
typedef struct {
    pd_PollIndexOf_V16_t poll_index;
    pd_u32_t max;
} pd_fellowshipcollective_cleanup_poll_V16_t;

#define PD_CALL_FELLOWSHIPREFERENDA_PLACE_DECISION_DEPOSIT_V16 1
typedef struct {
    pd_ReferendumIndex_V16_t index;
} pd_fellowshipreferenda_place_decision_deposit_V16_t;

#define PD_CALL_FELLOWSHIPREFERENDA_REFUND_DECISION_DEPOSIT_V16 2
typedef struct {
    pd_ReferendumIndex_V16_t index;
} pd_fellowshipreferenda_refund_decision_deposit_V16_t;

#define PD_CALL_FELLOWSHIPREFERENDA_CANCEL_V16 3
typedef struct {
    pd_ReferendumIndex_V16_t index;
} pd_fellowshipreferenda_cancel_V16_t;

#define PD_CALL_FELLOWSHIPREFERENDA_KILL_V16 4
typedef struct {
    pd_ReferendumIndex_V16_t index;
} pd_fellowshipreferenda_kill_V16_t;

#define PD_CALL_FELLOWSHIPREFERENDA_NUDGE_REFERENDUM_V16 5
typedef struct {
    pd_ReferendumIndex_V16_t index;
} pd_fellowshipreferenda_nudge_referendum_V16_t;

#define PD_CALL_FELLOWSHIPREFERENDA_ONE_FEWER_DECIDING_V16 6
typedef struct {
    pd_TrackIdOf_V16_t track;
} pd_fellowshipreferenda_one_fewer_deciding_V16_t;

#define PD_CALL_WHITELIST_WHITELIST_CALL_V16 0
typedef struct {
    pd_Hash_t call_hash;
} pd_whitelist_whitelist_call_V16_t;

#define PD_CALL_WHITELIST_REMOVE_WHITELISTED_CALL_V16 1
typedef struct {
    pd_Hash_t call_hash;
} pd_whitelist_remove_whitelisted_call_V16_t;

#define PD_CALL_WHITELIST_DISPATCH_WHITELISTED_CALL_V16 2
typedef struct {
    pd_Hash_t call_hash;
    pd_Weight_V16_t call_weight_witness;
} pd_whitelist_dispatch_whitelisted_call_V16_t;

#define PD_CALL_WHITELIST_DISPATCH_WHITELISTED_CALL_WITH_PREIMAGE_V16 3
typedef struct {
    pd_Call_t call;
} pd_whitelist_dispatch_whitelisted_call_with_preimage_V16_t;
...
#define PD_CALL_SOCIETY_BID_V16 0
typedef struct {
    pd_BalanceOf_t amount;
} pd_society_bid_V16_t;

#define PD_CALL_SOCIETY_UNBID_V16 1
typedef struct {
    pd_u32_t pos;
} pd_society_unbid_V16_t;

#define PD_CALL_SOCIETY_VOUCH_V16 2
typedef struct {
    pd_AccountIdLookupOfT_V16_t who;
    pd_BalanceOf_t amount;
    pd_BalanceOf_t tip;
} pd_society_vouch_V16_t;

#define PD_CALL_SOCIETY_UNVOUCH_V16 3
typedef struct {
    pd_u32_t pos;
} pd_society_unvouch_V16_t;

#define PD_CALL_SOCIETY_VOTE_V16 4
typedef struct {
    pd_AccountIdLookupOfT_V16_t candidate;
    pd_bool_t approve;
} pd_society_vote_V16_t;

#define PD_CALL_SOCIETY_DEFENDER_VOTE_V16 5
typedef struct {
    pd_bool_t approve;
} pd_society_defender_vote_V16_t;

#define PD_CALL_SOCIETY_PAYOUT_V16 6
typedef struct {
} pd_society_payout_V16_t;

#define PD_CALL_SOCIETY_FOUND_V16 7
typedef struct {
    pd_AccountIdLookupOfT_V16_t founder;
    pd_u32_t max_members;
    pd_Bytes_t rules;
} pd_society_found_V16_t;

#define PD_CALL_SOCIETY_UNFOUND_V16 8
typedef struct {
} pd_society_unfound_V16_t;

#define PD_CALL_SOCIETY_JUDGE_SUSPENDED_MEMBER_V16 9
typedef struct {
    pd_AccountIdLookupOfT_V16_t who;
    pd_bool_t forgive;
} pd_society_judge_suspended_member_V16_t;

#define PD_CALL_SOCIETY_SET_MAX_MEMBERS_V16 11
typedef struct {
    pd_u32_t max;
} pd_society_set_max_members_V16_t;

#define PD_CALL_RECOVERY_SET_RECOVERED_V16 1
typedef struct {
    pd_AccountIdLookupOfT_V16_t lost;
    pd_AccountIdLookupOfT_V16_t rescuer;
} pd_recovery_set_recovered_V16_t;

#define PD_CALL_RECOVERY_INITIATE_RECOVERY_V16 3
typedef struct {
    pd_AccountIdLookupOfT_V16_t account;
} pd_recovery_initiate_recovery_V16_t;

#define PD_CALL_RECOVERY_VOUCH_RECOVERY_V16 4
typedef struct {
    pd_AccountIdLookupOfT_V16_t lost;
    pd_AccountIdLookupOfT_V16_t rescuer;
} pd_recovery_vouch_recovery_V16_t;

#define PD_CALL_RECOVERY_CLAIM_RECOVERY_V16 5
typedef struct {
    pd_AccountIdLookupOfT_V16_t account;
} pd_recovery_claim_recovery_V16_t;

#define PD_CALL_RECOVERY_CLOSE_RECOVERY_V16 6
typedef struct {
    pd_AccountIdLookupOfT_V16_t rescuer;
} pd_recovery_close_recovery_V16_t;

#define PD_CALL_RECOVERY_REMOVE_RECOVERY_V16 7
typedef struct {
} pd_recovery_remove_recovery_V16_t;

#define PD_CALL_RECOVERY_CANCEL_RECOVERED_V16 8
typedef struct {
    pd_AccountIdLookupOfT_V16_t account;
} pd_recovery_cancel_recovered_V16_t;
...
#define PD_CALL_GILT_PLACE_BID_V16 0
typedef struct {
    pd_CompactBalance_t amount;
    pd_u32_t duration;
} pd_gilt_place_bid_V16_t;

#define PD_CALL_GILT_RETRACT_BID_V16 1
typedef struct {
    pd_CompactBalance_t amount;
    pd_u32_t duration;
} pd_gilt_retract_bid_V16_t;

#define PD_CALL_GILT_SET_TARGET_V16 2
typedef struct {
    pd_Compactu64_t target;
} pd_gilt_set_target_V16_t;

#define PD_CALL_GILT_THAW_V16 3
typedef struct {
    pd_Compactu32_t index;
} pd_gilt_thaw_V16_t;
...
#define PD_CALL_CONFIGURATION_SET_DISPUTE_PERIOD_V16 14
typedef struct {
    pd_SessionIndex_V16_t new_;
} pd_configuration_set_dispute_period_V16_t;
...
typedef union {
    ...
    pd_convictionvoting_vote_V16_t convictionvoting_vote_V16;
    pd_convictionvoting_delegate_V16_t convictionvoting_delegate_V16;
    pd_convictionvoting_undelegate_V16_t convictionvoting_undelegate_V16;
    pd_convictionvoting_unlock_V16_t convictionvoting_unlock_V16;
    pd_convictionvoting_remove_vote_V16_t convictionvoting_remove_vote_V16;
    pd_convictionvoting_remove_other_vote_V16_t convictionvoting_remove_other_vote_V16;
    pd_referenda_place_decision_deposit_V16_t referenda_place_decision_deposit_V16;
    pd_referenda_refund_decision_deposit_V16_t referenda_refund_decision_deposit_V16;
    pd_referenda_cancel_V16_t referenda_cancel_V16;
    pd_referenda_kill_V16_t referenda_kill_V16;
    pd_referenda_nudge_referendum_V16_t referenda_nudge_referendum_V16;
    pd_referenda_one_fewer_deciding_V16_t referenda_one_fewer_deciding_V16;
    pd_fellowshipcollective_add_member_V16_t fellowshipcollective_add_member_V16;
    pd_fellowshipcollective_promote_member_V16_t fellowshipcollective_promote_member_V16;
    pd_fellowshipcollective_demote_member_V16_t fellowshipcollective_demote_member_V16;
    pd_fellowshipcollective_remove_member_V16_t fellowshipcollective_remove_member_V16;
    pd_fellowshipcollective_vote_V16_t fellowshipcollective_vote_V16;
    pd_fellowshipcollective_cleanup_poll_V16_t fellowshipcollective_cleanup_poll_V16;
    pd_fellowshipreferenda_place_decision_deposit_V16_t fellowshipreferenda_place_decision_deposit_V16;
    pd_fellowshipreferenda_refund_decision_deposit_V16_t fellowshipreferenda_refund_decision_deposit_V16;
    pd_fellowshipreferenda_cancel_V16_t fellowshipreferenda_cancel_V16;
    pd_fellowshipreferenda_kill_V16_t fellowshipreferenda_kill_V16;
    pd_fellowshipreferenda_nudge_referendum_V16_t fellowshipreferenda_nudge_referendum_V16;
    pd_fellowshipreferenda_one_fewer_deciding_V16_t fellowshipreferenda_one_fewer_deciding_V16;
    pd_whitelist_whitelist_call_V16_t whitelist_whitelist_call_V16;
    pd_whitelist_remove_whitelisted_call_V16_t whitelist_remove_whitelisted_call_V16;
    pd_whitelist_dispatch_whitelisted_call_V16_t whitelist_dispatch_whitelisted_call_V16;
    pd_whitelist_dispatch_whitelisted_call_with_preimage_V16_t whitelist_dispatch_whitelisted_call_with_preimage_V16;
    ...
    pd_society_bid_V16_t society_bid_V16;
    pd_society_unbid_V16_t society_unbid_V16;
    pd_society_vouch_V16_t society_vouch_V16;
    pd_society_unvouch_V16_t society_unvouch_V16;
    pd_society_vote_V16_t society_vote_V16;
    pd_society_defender_vote_V16_t society_defender_vote_V16;
    pd_society_payout_V16_t society_payout_V16;
    pd_society_found_V16_t society_found_V16;
    pd_society_unfound_V16_t society_unfound_V16;
    pd_society_judge_suspended_member_V16_t society_judge_suspended_member_V16;
    pd_society_set_max_members_V16_t society_set_max_members_V16;
    pd_recovery_set_recovered_V16_t recovery_set_recovered_V16;
    pd_recovery_initiate_recovery_V16_t recovery_initiate_recovery_V16;
    pd_recovery_vouch_recovery_V16_t recovery_vouch_recovery_V16;
    pd_recovery_claim_recovery_V16_t recovery_claim_recovery_V16;
    pd_recovery_close_recovery_V16_t recovery_close_recovery_V16;
    pd_recovery_remove_recovery_V16_t recovery_remove_recovery_V16;
    pd_recovery_cancel_recovered_V16_t recovery_cancel_recovered_V16;
    ...
    pd_gilt_place_bid_V16_t gilt_place_bid_V16;
    pd_gilt_retract_bid_V16_t gilt_retract_bid_V16;
    pd_gilt_set_target_V16_t gilt_set_target_V16;
    pd_gilt_thaw_V16_t gilt_thaw_V16;
    ...
    pd_configuration_set_dispute_period_V16_t configuration_set_dispute_period_V16;
