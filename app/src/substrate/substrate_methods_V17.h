...
#define PD_CALL_TIMESTAMP_V17 2
#define PD_CALL_INDICES_V17 3
#define PD_CALL_BALANCES_V17 4
#define PD_CALL_STAKING_V17 6
#define PD_CALL_SESSION_V17 8
#define PD_CALL_DEMOCRACY_V17 13
#define PD_CALL_COUNCIL_V17 14
#define PD_CALL_TECHNICALCOMMITTEE_V17 15
#define PD_CALL_PHRAGMENELECTION_V17 16
#define PD_CALL_TECHNICALMEMBERSHIP_V17 17
#define PD_CALL_TREASURY_V17 18
#define PD_CALL_CONVICTIONVOTING_V17 20
#define PD_CALL_REFERENDA_V17 21
#define PD_CALL_FELLOWSHIPCOLLECTIVE_V17 22
#define PD_CALL_FELLOWSHIPREFERENDA_V17 23
#define PD_CALL_WHITELIST_V17 44
#define PD_CALL_CLAIMS_V17 19
#define PD_CALL_UTILITY_V17 24
#define PD_CALL_IDENTITY_V17 25
#define PD_CALL_SOCIETY_V17 26
#define PD_CALL_RECOVERY_V17 27
#define PD_CALL_VESTING_V17 28
#define PD_CALL_PROXY_V17 30
#define PD_CALL_MULTISIG_V17 31
#define PD_CALL_PREIMAGE_V17 32
#define PD_CALL_BOUNTIES_V17 35
#define PD_CALL_CHILDBOUNTIES_V17 40
#define PD_CALL_TIPS_V17 36
#define PD_CALL_NIS_V17 38
#define PD_CALL_NISCOUNTERPARTBALANCES_V17 45
#define PD_CALL_VOTERLIST_V17 39
#define PD_CALL_NOMINATIONPOOLS_V17 41
#define PD_CALL_FASTUNSTAKE_V17 42
...
#define PD_CALL_CONVICTIONVOTING_VOTE_V17 0
typedef struct {
    pd_Compactu32_t poll_index;
    pd_AccountVote_V17_t vote;
} pd_convictionvoting_vote_V17_t;

#define PD_CALL_CONVICTIONVOTING_DELEGATE_V17 1
typedef struct {
    pd_ClassOf_V17_t class_;
    pd_AccountIdLookupOfT_V17_t to;
    pd_Conviction_V17_t conviction;
    pd_BalanceOf_t balance;
} pd_convictionvoting_delegate_V17_t;

#define PD_CALL_CONVICTIONVOTING_UNDELEGATE_V17 2
typedef struct {
    pd_ClassOf_V17_t class_;
} pd_convictionvoting_undelegate_V17_t;

#define PD_CALL_CONVICTIONVOTING_UNLOCK_V17 3
typedef struct {
    pd_ClassOf_V17_t class_;
    pd_AccountIdLookupOfT_V17_t target;
} pd_convictionvoting_unlock_V17_t;

#define PD_CALL_CONVICTIONVOTING_REMOVE_VOTE_V17 4
typedef struct {
    pd_OptionClassOf_V17_t class_;
    pd_PollIndexOf_V17_t index;
} pd_convictionvoting_remove_vote_V17_t;

#define PD_CALL_CONVICTIONVOTING_REMOVE_OTHER_VOTE_V17 5
typedef struct {
    pd_AccountIdLookupOfT_V17_t target;
    pd_ClassOf_V17_t class_;
    pd_PollIndexOf_V17_t index;
} pd_convictionvoting_remove_other_vote_V17_t;

#define PD_CALL_REFERENDA_PLACE_DECISION_DEPOSIT_V17 1
typedef struct {
    pd_ReferendumIndex_V17_t index;
} pd_referenda_place_decision_deposit_V17_t;

#define PD_CALL_REFERENDA_REFUND_DECISION_DEPOSIT_V17 2
typedef struct {
    pd_ReferendumIndex_V17_t index;
} pd_referenda_refund_decision_deposit_V17_t;

#define PD_CALL_REFERENDA_CANCEL_V17 3
typedef struct {
    pd_ReferendumIndex_V17_t index;
} pd_referenda_cancel_V17_t;

#define PD_CALL_REFERENDA_KILL_V17 4
typedef struct {
    pd_ReferendumIndex_V17_t index;
} pd_referenda_kill_V17_t;

#define PD_CALL_REFERENDA_NUDGE_REFERENDUM_V17 5
typedef struct {
    pd_ReferendumIndex_V17_t index;
} pd_referenda_nudge_referendum_V17_t;

#define PD_CALL_REFERENDA_ONE_FEWER_DECIDING_V17 6
typedef struct {
    pd_TrackIdOf_V17_t track;
} pd_referenda_one_fewer_deciding_V17_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_ADD_MEMBER_V17 0
typedef struct {
    pd_AccountIdLookupOfT_V17_t who;
} pd_fellowshipcollective_add_member_V17_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_PROMOTE_MEMBER_V17 1
typedef struct {
    pd_AccountIdLookupOfT_V17_t who;
} pd_fellowshipcollective_promote_member_V17_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_DEMOTE_MEMBER_V17 2
typedef struct {
    pd_AccountIdLookupOfT_V17_t who;
} pd_fellowshipcollective_demote_member_V17_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_REMOVE_MEMBER_V17 3
typedef struct {
    pd_AccountIdLookupOfT_V17_t who;
    pd_Rank_V17_t min_rank;
} pd_fellowshipcollective_remove_member_V17_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_VOTE_V17 4
typedef struct {
    pd_PollIndexOf_V17_t poll;
    pd_bool_t aye;
} pd_fellowshipcollective_vote_V17_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_CLEANUP_POLL_V17 5
typedef struct {
    pd_PollIndexOf_V17_t poll_index;
    pd_u32_t max;
} pd_fellowshipcollective_cleanup_poll_V17_t;

#define PD_CALL_FELLOWSHIPREFERENDA_PLACE_DECISION_DEPOSIT_V17 1
typedef struct {
    pd_ReferendumIndex_V17_t index;
} pd_fellowshipreferenda_place_decision_deposit_V17_t;

#define PD_CALL_FELLOWSHIPREFERENDA_REFUND_DECISION_DEPOSIT_V17 2
typedef struct {
    pd_ReferendumIndex_V17_t index;
} pd_fellowshipreferenda_refund_decision_deposit_V17_t;

#define PD_CALL_FELLOWSHIPREFERENDA_CANCEL_V17 3
typedef struct {
    pd_ReferendumIndex_V17_t index;
} pd_fellowshipreferenda_cancel_V17_t;

#define PD_CALL_FELLOWSHIPREFERENDA_KILL_V17 4
typedef struct {
    pd_ReferendumIndex_V17_t index;
} pd_fellowshipreferenda_kill_V17_t;

#define PD_CALL_FELLOWSHIPREFERENDA_NUDGE_REFERENDUM_V17 5
typedef struct {
    pd_ReferendumIndex_V17_t index;
} pd_fellowshipreferenda_nudge_referendum_V17_t;

#define PD_CALL_FELLOWSHIPREFERENDA_ONE_FEWER_DECIDING_V17 6
typedef struct {
    pd_TrackIdOf_V17_t track;
} pd_fellowshipreferenda_one_fewer_deciding_V17_t;

#define PD_CALL_WHITELIST_WHITELIST_CALL_V17 0
typedef struct {
    pd_Hash_t call_hash;
} pd_whitelist_whitelist_call_V17_t;

#define PD_CALL_WHITELIST_REMOVE_WHITELISTED_CALL_V17 1
typedef struct {
    pd_Hash_t call_hash;
} pd_whitelist_remove_whitelisted_call_V17_t;

#define PD_CALL_WHITELIST_DISPATCH_WHITELISTED_CALL_V17 2
typedef struct {
    pd_Hash_t call_hash;
    pd_Weight_V17_t call_weight_witness;
} pd_whitelist_dispatch_whitelisted_call_V17_t;

#define PD_CALL_WHITELIST_DISPATCH_WHITELISTED_CALL_WITH_PREIMAGE_V17 3
typedef struct {
    pd_Call_t call;
} pd_whitelist_dispatch_whitelisted_call_with_preimage_V17_t;
...
#define PD_CALL_SOCIETY_BID_V17 0
typedef struct {
    pd_BalanceOf_t amount;
} pd_society_bid_V17_t;

#define PD_CALL_SOCIETY_UNBID_V17 1
typedef struct {
    pd_u32_t pos;
} pd_society_unbid_V17_t;

#define PD_CALL_SOCIETY_VOUCH_V17 2
typedef struct {
    pd_AccountIdLookupOfT_V17_t who;
    pd_BalanceOf_t amount;
    pd_BalanceOf_t tip;
} pd_society_vouch_V17_t;

#define PD_CALL_SOCIETY_UNVOUCH_V17 3
typedef struct {
    pd_u32_t pos;
} pd_society_unvouch_V17_t;

#define PD_CALL_SOCIETY_VOTE_V17 4
typedef struct {
    pd_AccountIdLookupOfT_V17_t candidate;
    pd_bool_t approve;
} pd_society_vote_V17_t;

#define PD_CALL_SOCIETY_DEFENDER_VOTE_V17 5
typedef struct {
    pd_bool_t approve;
} pd_society_defender_vote_V17_t;

#define PD_CALL_SOCIETY_PAYOUT_V17 6
typedef struct {
} pd_society_payout_V17_t;

#define PD_CALL_SOCIETY_FOUND_V17 7
typedef struct {
    pd_AccountIdLookupOfT_V17_t founder;
    pd_u32_t max_members;
    pd_Bytes_t rules;
} pd_society_found_V17_t;

#define PD_CALL_SOCIETY_UNFOUND_V17 8
typedef struct {
} pd_society_unfound_V17_t;

#define PD_CALL_SOCIETY_JUDGE_SUSPENDED_MEMBER_V17 9
typedef struct {
    pd_AccountIdLookupOfT_V17_t who;
    pd_bool_t forgive;
} pd_society_judge_suspended_member_V17_t;

#define PD_CALL_SOCIETY_SET_MAX_MEMBERS_V17 11
typedef struct {
    pd_u32_t max;
} pd_society_set_max_members_V17_t;

#define PD_CALL_RECOVERY_SET_RECOVERED_V17 1
typedef struct {
    pd_AccountIdLookupOfT_V17_t lost;
    pd_AccountIdLookupOfT_V17_t rescuer;
} pd_recovery_set_recovered_V17_t;

#define PD_CALL_RECOVERY_INITIATE_RECOVERY_V17 3
typedef struct {
    pd_AccountIdLookupOfT_V17_t account;
} pd_recovery_initiate_recovery_V17_t;

#define PD_CALL_RECOVERY_VOUCH_RECOVERY_V17 4
typedef struct {
    pd_AccountIdLookupOfT_V17_t lost;
    pd_AccountIdLookupOfT_V17_t rescuer;
} pd_recovery_vouch_recovery_V17_t;

#define PD_CALL_RECOVERY_CLAIM_RECOVERY_V17 5
typedef struct {
    pd_AccountIdLookupOfT_V17_t account;
} pd_recovery_claim_recovery_V17_t;

#define PD_CALL_RECOVERY_CLOSE_RECOVERY_V17 6
typedef struct {
    pd_AccountIdLookupOfT_V17_t rescuer;
} pd_recovery_close_recovery_V17_t;

#define PD_CALL_RECOVERY_REMOVE_RECOVERY_V17 7
typedef struct {
} pd_recovery_remove_recovery_V17_t;

#define PD_CALL_RECOVERY_CANCEL_RECOVERED_V17 8
typedef struct {
    pd_AccountIdLookupOfT_V17_t account;
} pd_recovery_cancel_recovered_V17_t;
...
#define PD_CALL_NIS_PLACE_BID_V17 0
typedef struct {
    pd_Compactu128_t amount;
    pd_u32_t duration;
} pd_nis_place_bid_V17_t;

#define PD_CALL_NIS_RETRACT_BID_V17 1
typedef struct {
    pd_Compactu128_t amount;
    pd_u32_t duration;
} pd_nis_retract_bid_V17_t;

#define PD_CALL_NIS_FUND_DEFICIT_V17 2
typedef struct {
} pd_nis_fund_deficit_V17_t;

#define PD_CALL_NIS_THAW_V17 3
typedef struct {
    pd_Compactu32_t index;
    pd_Optionu128_t portion;
} pd_nis_thaw_V17_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_TRANSFER_V17 0
typedef struct {
    pd_AccountIdLookupOfT_V17_t dest;
    pd_Compactu128_t amount;
} pd_niscounterpartbalances_transfer_V17_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_SET_BALANCE_V17 1
typedef struct {
    pd_AccountIdLookupOfT_V17_t who;
    pd_Compactu128_t new_free;
    pd_Compactu128_t new_reserved;
} pd_niscounterpartbalances_set_balance_V17_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_FORCE_TRANSFER_V17 2
typedef struct {
    pd_AccountIdLookupOfT_V17_t source;
    pd_AccountIdLookupOfT_V17_t dest;
    pd_Compactu128_t amount;
} pd_niscounterpartbalances_force_transfer_V17_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_TRANSFER_KEEP_ALIVE_V17 3
typedef struct {
    pd_AccountIdLookupOfT_V17_t dest;
    pd_Compactu128_t amount;
} pd_niscounterpartbalances_transfer_keep_alive_V17_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_TRANSFER_ALL_V17 4
typedef struct {
    pd_AccountIdLookupOfT_V17_t dest;
    pd_bool_t keep_alive;
} pd_niscounterpartbalances_transfer_all_V17_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_FORCE_UNRESERVE_V17 5
typedef struct {
    pd_AccountIdLookupOfT_V17_t who;
    pd_Balance_t amount;
} pd_niscounterpartbalances_force_unreserve_V17_t;
...
#define PD_CALL_CONFIGURATION_SET_DISPUTE_PERIOD_V17 14
typedef struct {
    pd_SessionIndex_V17_t new_;
} pd_configuration_set_dispute_period_V17_t;
...
typedef union {
    ...
    pd_convictionvoting_vote_V17_t convictionvoting_vote_V17;
    pd_convictionvoting_delegate_V17_t convictionvoting_delegate_V17;
    pd_convictionvoting_undelegate_V17_t convictionvoting_undelegate_V17;
    pd_convictionvoting_unlock_V17_t convictionvoting_unlock_V17;
    pd_convictionvoting_remove_vote_V17_t convictionvoting_remove_vote_V17;
    pd_convictionvoting_remove_other_vote_V17_t convictionvoting_remove_other_vote_V17;
    pd_referenda_place_decision_deposit_V17_t referenda_place_decision_deposit_V17;
    pd_referenda_refund_decision_deposit_V17_t referenda_refund_decision_deposit_V17;
    pd_referenda_cancel_V17_t referenda_cancel_V17;
    pd_referenda_kill_V17_t referenda_kill_V17;
    pd_referenda_nudge_referendum_V17_t referenda_nudge_referendum_V17;
    pd_referenda_one_fewer_deciding_V17_t referenda_one_fewer_deciding_V17;
    pd_fellowshipcollective_add_member_V17_t fellowshipcollective_add_member_V17;
    pd_fellowshipcollective_promote_member_V17_t fellowshipcollective_promote_member_V17;
    pd_fellowshipcollective_demote_member_V17_t fellowshipcollective_demote_member_V17;
    pd_fellowshipcollective_remove_member_V17_t fellowshipcollective_remove_member_V17;
    pd_fellowshipcollective_vote_V17_t fellowshipcollective_vote_V17;
    pd_fellowshipcollective_cleanup_poll_V17_t fellowshipcollective_cleanup_poll_V17;
    pd_fellowshipreferenda_place_decision_deposit_V17_t fellowshipreferenda_place_decision_deposit_V17;
    pd_fellowshipreferenda_refund_decision_deposit_V17_t fellowshipreferenda_refund_decision_deposit_V17;
    pd_fellowshipreferenda_cancel_V17_t fellowshipreferenda_cancel_V17;
    pd_fellowshipreferenda_kill_V17_t fellowshipreferenda_kill_V17;
    pd_fellowshipreferenda_nudge_referendum_V17_t fellowshipreferenda_nudge_referendum_V17;
    pd_fellowshipreferenda_one_fewer_deciding_V17_t fellowshipreferenda_one_fewer_deciding_V17;
    pd_whitelist_whitelist_call_V17_t whitelist_whitelist_call_V17;
    pd_whitelist_remove_whitelisted_call_V17_t whitelist_remove_whitelisted_call_V17;
    pd_whitelist_dispatch_whitelisted_call_V17_t whitelist_dispatch_whitelisted_call_V17;
    pd_whitelist_dispatch_whitelisted_call_with_preimage_V17_t whitelist_dispatch_whitelisted_call_with_preimage_V17;
    ...
    pd_society_bid_V17_t society_bid_V17;
    pd_society_unbid_V17_t society_unbid_V17;
    pd_society_vouch_V17_t society_vouch_V17;
    pd_society_unvouch_V17_t society_unvouch_V17;
    pd_society_vote_V17_t society_vote_V17;
    pd_society_defender_vote_V17_t society_defender_vote_V17;
    pd_society_payout_V17_t society_payout_V17;
    pd_society_found_V17_t society_found_V17;
    pd_society_unfound_V17_t society_unfound_V17;
    pd_society_judge_suspended_member_V17_t society_judge_suspended_member_V17;
    pd_society_set_max_members_V17_t society_set_max_members_V17;
    pd_recovery_set_recovered_V17_t recovery_set_recovered_V17;
    pd_recovery_initiate_recovery_V17_t recovery_initiate_recovery_V17;
    pd_recovery_vouch_recovery_V17_t recovery_vouch_recovery_V17;
    pd_recovery_claim_recovery_V17_t recovery_claim_recovery_V17;
    pd_recovery_close_recovery_V17_t recovery_close_recovery_V17;
    pd_recovery_remove_recovery_V17_t recovery_remove_recovery_V17;
    pd_recovery_cancel_recovered_V17_t recovery_cancel_recovered_V17;
    ...
    pd_nis_place_bid_V17_t nis_place_bid_V17;
    pd_nis_retract_bid_V17_t nis_retract_bid_V17;
    pd_nis_fund_deficit_V17_t nis_fund_deficit_V17;
    pd_nis_thaw_V17_t nis_thaw_V17;
    pd_niscounterpartbalances_transfer_V17_t niscounterpartbalances_transfer_V17;
    pd_niscounterpartbalances_set_balance_V17_t niscounterpartbalances_set_balance_V17;
    pd_niscounterpartbalances_force_transfer_V17_t niscounterpartbalances_force_transfer_V17;
    pd_niscounterpartbalances_transfer_keep_alive_V17_t niscounterpartbalances_transfer_keep_alive_V17;
    pd_niscounterpartbalances_transfer_all_V17_t niscounterpartbalances_transfer_all_V17;
    pd_niscounterpartbalances_force_unreserve_V17_t niscounterpartbalances_force_unreserve_V17;
    ...
    pd_configuration_set_dispute_period_V17_t configuration_set_dispute_period_V17;
