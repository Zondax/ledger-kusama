...
#define PD_CALL_PHRAGMENELECTION_V14 16
#define PD_CALL_TECHNICALMEMBERSHIP_V14 17
#define PD_CALL_TREASURY_V14 18
#define PD_CALL_CLAIMS_V14 19
#define PD_CALL_UTILITY_V14 24
#define PD_CALL_IDENTITY_V14 25
#define PD_CALL_SOCIETY_V14 26
#define PD_CALL_RECOVERY_V14 27
#define PD_CALL_VESTING_V14 28
#define PD_CALL_PROXY_V14 30
#define PD_CALL_MULTISIG_V14 31
#define PD_CALL_PREIMAGE_V14 32
...
#define PD_CALL_FASTUNSTAKE_V14 42
...
#define PD_CALL_STAKING_REAP_STASH_V14 20
typedef struct {
    pd_AccountId_V14_t stash;
    pd_u32_t num_slashing_spans;
} pd_staking_reap_stash_V14_t;

#define PD_CALL_STAKING_KICK_V14 21
typedef struct {
    pd_VecAccountIdLookupOfT_V14_t who;
} pd_staking_kick_V14_t;

#define PD_CALL_STAKING_CHILL_OTHER_V14 23
typedef struct {
    pd_AccountId_V14_t controller;
} pd_staking_chill_other_V14_t;

#define PD_CALL_STAKING_FORCE_APPLY_MIN_COMMISSION_V14 24
typedef struct {
    pd_AccountId_V14_t validator_stash;
...
#define PD_CALL_SOCIETY_BID_V14 0
typedef struct {
    pd_BalanceOf_t amount;
} pd_society_bid_V14_t;

#define PD_CALL_SOCIETY_UNBID_V14 1
typedef struct {
    pd_u32_t pos;
} pd_society_unbid_V14_t;

#define PD_CALL_SOCIETY_VOUCH_V14 2
typedef struct {
    pd_AccountIdLookupOfT_V14_t who;
    pd_BalanceOf_t amount;
    pd_BalanceOf_t tip;
} pd_society_vouch_V14_t;

#define PD_CALL_SOCIETY_UNVOUCH_V14 3
typedef struct {
    pd_u32_t pos;
} pd_society_unvouch_V14_t;

#define PD_CALL_SOCIETY_VOTE_V14 4
typedef struct {
    pd_AccountIdLookupOfT_V14_t candidate;
    pd_bool_t approve;
} pd_society_vote_V14_t;

#define PD_CALL_SOCIETY_DEFENDER_VOTE_V14 5
typedef struct {
    pd_bool_t approve;
} pd_society_defender_vote_V14_t;

#define PD_CALL_SOCIETY_PAYOUT_V14 6
typedef struct {
} pd_society_payout_V14_t;

#define PD_CALL_SOCIETY_FOUND_V14 7
typedef struct {
    pd_AccountIdLookupOfT_V14_t founder;
    pd_u32_t max_members;
    pd_Bytes_t rules;
} pd_society_found_V14_t;

#define PD_CALL_SOCIETY_UNFOUND_V14 8
typedef struct {
} pd_society_unfound_V14_t;

#define PD_CALL_SOCIETY_JUDGE_SUSPENDED_MEMBER_V14 9
typedef struct {
    pd_AccountIdLookupOfT_V14_t who;
    pd_bool_t forgive;
} pd_society_judge_suspended_member_V14_t;

#define PD_CALL_SOCIETY_SET_MAX_MEMBERS_V14 11
typedef struct {
    pd_u32_t max;
} pd_society_set_max_members_V14_t;

#define PD_CALL_RECOVERY_SET_RECOVERED_V14 1
typedef struct {
    pd_AccountIdLookupOfT_V14_t lost;
    pd_AccountIdLookupOfT_V14_t rescuer;
} pd_recovery_set_recovered_V14_t;

#define PD_CALL_RECOVERY_INITIATE_RECOVERY_V14 3
typedef struct {
    pd_AccountIdLookupOfT_V14_t account;
} pd_recovery_initiate_recovery_V14_t;

#define PD_CALL_RECOVERY_VOUCH_RECOVERY_V14 4
typedef struct {
    pd_AccountIdLookupOfT_V14_t lost;
    pd_AccountIdLookupOfT_V14_t rescuer;
} pd_recovery_vouch_recovery_V14_t;

#define PD_CALL_RECOVERY_CLAIM_RECOVERY_V14 5
typedef struct {
    pd_AccountIdLookupOfT_V14_t account;
} pd_recovery_claim_recovery_V14_t;

#define PD_CALL_RECOVERY_CLOSE_RECOVERY_V14 6
typedef struct {
    pd_AccountIdLookupOfT_V14_t rescuer;
} pd_recovery_close_recovery_V14_t;

#define PD_CALL_RECOVERY_REMOVE_RECOVERY_V14 7
typedef struct {
} pd_recovery_remove_recovery_V14_t;

#define PD_CALL_RECOVERY_CANCEL_RECOVERED_V14 8
typedef struct {
    pd_AccountIdLookupOfT_V14_t account;
} pd_recovery_cancel_recovered_V14_t;
...
typedef struct {
    pd_CompactBalance_t amount;
    pd_u32_t duration;
} pd_gilt_place_bid_V14_t;

#define PD_CALL_GILT_RETRACT_BID_V14 1
typedef struct {
    pd_CompactBalance_t amount;
    pd_u32_t duration;
} pd_gilt_retract_bid_V14_t;

#define PD_CALL_GILT_SET_TARGET_V14 2
typedef struct {
    pd_Compactu64_t target;
} pd_gilt_set_target_V14_t;

#define PD_CALL_GILT_THAW_V14 3
typedef struct {
    pd_Compactu32_t index;
} pd_gilt_thaw_V14_t;
...
#define PD_CALL_FASTUNSTAKE_REGISTER_FAST_UNSTAKE_V14 0
typedef struct {
} pd_fastunstake_register_fast_unstake_V14_t;

#define PD_CALL_FASTUNSTAKE_DEREGISTER_V14 1
typedef struct {
} pd_fastunstake_deregister_V14_t;

#define PD_CALL_FASTUNSTAKE_CONTROL_V14 2
typedef struct {
    pd_EraIndex_V14_t unchecked_eras_to_check;
} pd_fastunstake_control_V14_t;
...
#define PD_CALL_CONFIGURATION_SET_DISPUTE_PERIOD_V14 14
typedef struct {
    pd_SessionIndex_V14_t new_;
} pd_configuration_set_dispute_period_V14_t;
...
typedef union {
    ...
    pd_society_unbid_V14_t society_unbid_V14;
    pd_society_vouch_V14_t society_vouch_V14;
    pd_society_unvouch_V14_t society_unvouch_V14;
    pd_society_vote_V14_t society_vote_V14;
    pd_society_defender_vote_V14_t society_defender_vote_V14;
    pd_society_payout_V14_t society_payout_V14;
    pd_society_found_V14_t society_found_V14;
    pd_society_unfound_V14_t society_unfound_V14;
    pd_society_judge_suspended_member_V14_t society_judge_suspended_member_V14;
    pd_society_set_max_members_V14_t society_set_max_members_V14;
    pd_recovery_set_recovered_V14_t recovery_set_recovered_V14;
    pd_recovery_initiate_recovery_V14_t recovery_initiate_recovery_V14;
    pd_recovery_vouch_recovery_V14_t recovery_vouch_recovery_V14;
    pd_recovery_claim_recovery_V14_t recovery_claim_recovery_V14;
    pd_recovery_close_recovery_V14_t recovery_close_recovery_V14;
    pd_recovery_remove_recovery_V14_t recovery_remove_recovery_V14;
    pd_recovery_cancel_recovered_V14_t recovery_cancel_recovered_V14;
    ...
    pd_gilt_thaw_V14_t gilt_thaw_V14;
    ...
    pd_fastunstake_register_fast_unstake_V14_t fastunstake_register_fast_unstake_V14;
    pd_fastunstake_deregister_V14_t fastunstake_deregister_V14;
    pd_fastunstake_control_V14_t fastunstake_control_V14;
    ...
    pd_configuration_set_dispute_period_V14_t configuration_set_dispute_period_V14;
