...
#define PD_CALL_TIMESTAMP_V18 2
#define PD_CALL_INDICES_V18 3
#define PD_CALL_BALANCES_V18 4
#define PD_CALL_STAKING_V18 6
#define PD_CALL_SESSION_V18 8
#define PD_CALL_DEMOCRACY_V18 13
#define PD_CALL_COUNCIL_V18 14
#define PD_CALL_TECHNICALCOMMITTEE_V18 15
#define PD_CALL_PHRAGMENELECTION_V18 16
#define PD_CALL_TECHNICALMEMBERSHIP_V18 17
#define PD_CALL_TREASURY_V18 18
#define PD_CALL_CONVICTIONVOTING_V18 20
#define PD_CALL_REFERENDA_V18 21
#define PD_CALL_FELLOWSHIPCOLLECTIVE_V18 22
#define PD_CALL_FELLOWSHIPREFERENDA_V18 23
#define PD_CALL_WHITELIST_V18 44
#define PD_CALL_CLAIMS_V18 19
#define PD_CALL_UTILITY_V18 24
#define PD_CALL_IDENTITY_V18 25
#define PD_CALL_SOCIETY_V18 26
#define PD_CALL_RECOVERY_V18 27
#define PD_CALL_VESTING_V18 28
#define PD_CALL_PROXY_V18 30
#define PD_CALL_MULTISIG_V18 31
#define PD_CALL_PREIMAGE_V18 32
#define PD_CALL_BOUNTIES_V18 35
#define PD_CALL_CHILDBOUNTIES_V18 40
#define PD_CALL_TIPS_V18 36
#define PD_CALL_NIS_V18 38
#define PD_CALL_NISCOUNTERPARTBALANCES_V18 45
#define PD_CALL_VOTERLIST_V18 39
#define PD_CALL_NOMINATIONPOOLS_V18 41
#define PD_CALL_FASTUNSTAKE_V18 42
...
typedef struct {
    pd_Call_t call;
} pd_whitelist_dispatch_whitelisted_call_with_preimage_V18_t;
...
#define PD_CALL_SOCIETY_BID_V18 0
typedef struct {
    pd_BalanceOf_t amount;
} pd_society_bid_V18_t;

#define PD_CALL_SOCIETY_UNBID_V18 1
typedef struct {
    pd_u32_t pos;
} pd_society_unbid_V18_t;
...
#define PD_CALL_SOCIETY_UNVOUCH_V18 3
typedef struct {
    pd_u32_t pos;
} pd_society_unvouch_V18_t;
...
#define PD_CALL_SOCIETY_DEFENDER_VOTE_V18 5
typedef struct {
    pd_bool_t approve;
} pd_society_defender_vote_V18_t;

#define PD_CALL_SOCIETY_PAYOUT_V18 6
typedef struct {
} pd_society_payout_V18_t;
...
#define PD_CALL_SOCIETY_UNFOUND_V18 8
typedef struct {
} pd_society_unfound_V18_t;
...
#define PD_CALL_SOCIETY_SET_MAX_MEMBERS_V18 11
typedef struct {
    pd_u32_t max;
} pd_society_set_max_members_V18_t;
...
typedef struct {
} pd_recovery_remove_recovery_V18_t;
...
#define PD_CALL_NIS_PLACE_BID_V18 0
typedef struct {
    pd_Compactu128_t amount;
    pd_u32_t duration;
} pd_nis_place_bid_V18_t;

#define PD_CALL_NIS_RETRACT_BID_V18 1
typedef struct {
    pd_Compactu128_t amount;
    pd_u32_t duration;
} pd_nis_retract_bid_V18_t;

#define PD_CALL_NIS_FUND_DEFICIT_V18 2
typedef struct {
} pd_nis_fund_deficit_V18_t;

#define PD_CALL_NIS_THAW_V18 3
typedef struct {
    pd_Compactu32_t index;
...
typedef union {
    ...
    pd_convictionvoting_vote_V18_t convictionvoting_vote_V18;
    pd_convictionvoting_delegate_V18_t convictionvoting_delegate_V18;
    pd_convictionvoting_undelegate_V18_t convictionvoting_undelegate_V18;
    pd_convictionvoting_unlock_V18_t convictionvoting_unlock_V18;
    pd_convictionvoting_remove_vote_V18_t convictionvoting_remove_vote_V18;
    pd_convictionvoting_remove_other_vote_V18_t convictionvoting_remove_other_vote_V18;
    pd_referenda_place_decision_deposit_V18_t referenda_place_decision_deposit_V18;
    pd_referenda_refund_decision_deposit_V18_t referenda_refund_decision_deposit_V18;
    pd_referenda_cancel_V18_t referenda_cancel_V18;
    pd_referenda_kill_V18_t referenda_kill_V18;
    pd_referenda_nudge_referendum_V18_t referenda_nudge_referendum_V18;
    pd_referenda_one_fewer_deciding_V18_t referenda_one_fewer_deciding_V18;
    pd_referenda_refund_submission_deposit_V18_t referenda_refund_submission_deposit_V18;
    pd_fellowshipcollective_add_member_V18_t fellowshipcollective_add_member_V18;
    pd_fellowshipcollective_promote_member_V18_t fellowshipcollective_promote_member_V18;
    pd_fellowshipcollective_demote_member_V18_t fellowshipcollective_demote_member_V18;
    pd_fellowshipcollective_remove_member_V18_t fellowshipcollective_remove_member_V18;
    pd_fellowshipcollective_vote_V18_t fellowshipcollective_vote_V18;
    pd_fellowshipcollective_cleanup_poll_V18_t fellowshipcollective_cleanup_poll_V18;
    pd_fellowshipreferenda_place_decision_deposit_V18_t fellowshipreferenda_place_decision_deposit_V18;
    pd_fellowshipreferenda_refund_decision_deposit_V18_t fellowshipreferenda_refund_decision_deposit_V18;
    pd_fellowshipreferenda_cancel_V18_t fellowshipreferenda_cancel_V18;
    pd_fellowshipreferenda_kill_V18_t fellowshipreferenda_kill_V18;
    pd_fellowshipreferenda_nudge_referendum_V18_t fellowshipreferenda_nudge_referendum_V18;
    pd_fellowshipreferenda_one_fewer_deciding_V18_t fellowshipreferenda_one_fewer_deciding_V18;
    pd_fellowshipreferenda_refund_submission_deposit_V18_t fellowshipreferenda_refund_submission_deposit_V18;
    pd_whitelist_whitelist_call_V18_t whitelist_whitelist_call_V18;
    pd_whitelist_remove_whitelisted_call_V18_t whitelist_remove_whitelisted_call_V18;
    pd_whitelist_dispatch_whitelisted_call_V18_t whitelist_dispatch_whitelisted_call_V18;
    pd_whitelist_dispatch_whitelisted_call_with_preimage_V18_t whitelist_dispatch_whitelisted_call_with_preimage_V18;
    ...
    pd_society_bid_V18_t society_bid_V18;
    pd_society_unbid_V18_t society_unbid_V18;
    pd_society_vouch_V18_t society_vouch_V18;
    pd_society_unvouch_V18_t society_unvouch_V18;
    pd_society_vote_V18_t society_vote_V18;
    pd_society_defender_vote_V18_t society_defender_vote_V18;
    pd_society_payout_V18_t society_payout_V18;
    pd_society_found_V18_t society_found_V18;
    pd_society_unfound_V18_t society_unfound_V18;
    pd_society_judge_suspended_member_V18_t society_judge_suspended_member_V18;
    pd_society_set_max_members_V18_t society_set_max_members_V18;
    pd_recovery_set_recovered_V18_t recovery_set_recovered_V18;
    pd_recovery_initiate_recovery_V18_t recovery_initiate_recovery_V18;
    pd_recovery_vouch_recovery_V18_t recovery_vouch_recovery_V18;
    pd_recovery_claim_recovery_V18_t recovery_claim_recovery_V18;
    pd_recovery_close_recovery_V18_t recovery_close_recovery_V18;
    pd_recovery_remove_recovery_V18_t recovery_remove_recovery_V18;
    pd_recovery_cancel_recovered_V18_t recovery_cancel_recovered_V18;
    ...
    pd_nis_place_bid_V18_t nis_place_bid_V18;
    pd_nis_retract_bid_V18_t nis_retract_bid_V18;
    pd_nis_fund_deficit_V18_t nis_fund_deficit_V18;
    pd_nis_thaw_V18_t nis_thaw_V18;
    pd_niscounterpartbalances_transfer_V18_t niscounterpartbalances_transfer_V18;
    pd_niscounterpartbalances_set_balance_V18_t niscounterpartbalances_set_balance_V18;
    pd_niscounterpartbalances_force_transfer_V18_t niscounterpartbalances_force_transfer_V18;
    pd_niscounterpartbalances_transfer_keep_alive_V18_t niscounterpartbalances_transfer_keep_alive_V18;
    pd_niscounterpartbalances_transfer_all_V18_t niscounterpartbalances_transfer_all_V18;
    pd_niscounterpartbalances_force_unreserve_V18_t niscounterpartbalances_force_unreserve_V18;
    ...
    pd_configuration_set_dispute_period_V18_t configuration_set_dispute_period_V18;
