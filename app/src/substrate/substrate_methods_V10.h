...
#define PD_CALL_TIMESTAMP_V10 2
#define PD_CALL_INDICES_V10 3
#define PD_CALL_BALANCES_V10 4
#define PD_CALL_STAKING_V10 6
#define PD_CALL_SESSION_V10 8
#define PD_CALL_GRANDPA_V10 10
#define PD_CALL_DEMOCRACY_V10 13
#define PD_CALL_COUNCIL_V10 14
#define PD_CALL_TECHNICALCOMMITTEE_V10 15
#define PD_CALL_PHRAGMENELECTION_V10 16
#define PD_CALL_TECHNICALMEMBERSHIP_V10 17
#define PD_CALL_TREASURY_V10 18
#define PD_CALL_CLAIMS_V10 19
#define PD_CALL_UTILITY_V10 24
#define PD_CALL_IDENTITY_V10 25
#define PD_CALL_SOCIETY_V10 26
#define PD_CALL_RECOVERY_V10 27
#define PD_CALL_VESTING_V10 28
#define PD_CALL_PROXY_V10 30
#define PD_CALL_MULTISIG_V10 31
#define PD_CALL_PREIMAGE_V10 32
#define PD_CALL_BOUNTIES_V10 35
#define PD_CALL_TIPS_V10 36
#define PD_CALL_ELECTIONPROVIDERMULTIPHASE_V10 37
#define PD_CALL_GILT_V10 38
#define PD_CALL_BAGSLIST_V10 39
...
#define PD_CALL_SOCIETY_BID_V10 0
typedef struct {
    pd_Balance_t amount;
} pd_society_bid_V10_t;

#define PD_CALL_SOCIETY_UNBID_V10 1
typedef struct {
    pd_u32_t pos;
} pd_society_unbid_V10_t;

#define PD_CALL_SOCIETY_VOUCH_V10 2
typedef struct {
    pd_AccountId_V10_t who;
    pd_Balance_t amount;
    pd_Balance_t tip;
} pd_society_vouch_V10_t;

#define PD_CALL_SOCIETY_UNVOUCH_V10 3
typedef struct {
    pd_u32_t pos;
} pd_society_unvouch_V10_t;

#define PD_CALL_SOCIETY_VOTE_V10 4
typedef struct {
    pd_LookupasStaticLookupSource_V10_t candidate;
    pd_bool_t approve;
} pd_society_vote_V10_t;

#define PD_CALL_SOCIETY_DEFENDER_VOTE_V10 5
typedef struct {
    pd_bool_t approve;
} pd_society_defender_vote_V10_t;

#define PD_CALL_SOCIETY_PAYOUT_V10 6
typedef struct {
} pd_society_payout_V10_t;

#define PD_CALL_SOCIETY_FOUND_V10 7
typedef struct {
    pd_AccountId_V10_t founder;
    pd_u32_t max_members;
    pd_Bytes_t rules;
} pd_society_found_V10_t;

#define PD_CALL_SOCIETY_UNFOUND_V10 8
typedef struct {
} pd_society_unfound_V10_t;

#define PD_CALL_SOCIETY_JUDGE_SUSPENDED_MEMBER_V10 9
typedef struct {
    pd_AccountId_V10_t who;
    pd_bool_t forgive;
} pd_society_judge_suspended_member_V10_t;

#define PD_CALL_SOCIETY_SET_MAX_MEMBERS_V10 11
typedef struct {
    pd_u32_t max;
} pd_society_set_max_members_V10_t;

#define PD_CALL_RECOVERY_SET_RECOVERED_V10 1
typedef struct {
    pd_AccountId_V10_t lost;
    pd_AccountId_V10_t rescuer;
} pd_recovery_set_recovered_V10_t;

#define PD_CALL_RECOVERY_INITIATE_RECOVERY_V10 3
typedef struct {
    pd_AccountId_V10_t account;
} pd_recovery_initiate_recovery_V10_t;

#define PD_CALL_RECOVERY_VOUCH_RECOVERY_V10 4
typedef struct {
    pd_AccountId_V10_t lost;
    pd_AccountId_V10_t rescuer;
} pd_recovery_vouch_recovery_V10_t;

#define PD_CALL_RECOVERY_CLAIM_RECOVERY_V10 5
typedef struct {
    pd_AccountId_V10_t account;
} pd_recovery_claim_recovery_V10_t;

#define PD_CALL_RECOVERY_CLOSE_RECOVERY_V10 6
typedef struct {
    pd_AccountId_V10_t rescuer;
} pd_recovery_close_recovery_V10_t;

#define PD_CALL_RECOVERY_REMOVE_RECOVERY_V10 7
typedef struct {
} pd_recovery_remove_recovery_V10_t;

#define PD_CALL_RECOVERY_CANCEL_RECOVERED_V10 8
typedef struct {
    pd_AccountId_V10_t account;
} pd_recovery_cancel_recovered_V10_t;
...
#define PD_CALL_GILT_PLACE_BID_V10 0
typedef struct {
    pd_CompactBalance_t amount;
    pd_u32_t duration;
} pd_gilt_place_bid_V10_t;

#define PD_CALL_GILT_RETRACT_BID_V10 1
typedef struct {
    pd_CompactBalance_t amount;
    pd_u32_t duration;
} pd_gilt_retract_bid_V10_t;
...
#define PD_CALL_CONFIGURATION_SET_DISPUTE_PERIOD_V10 14
typedef struct {
    pd_SessionIndex_V10_t new_;
} pd_configuration_set_dispute_period_V10_t;
...
#define PD_CALL_PARASDISPUTES_FORCE_UNFREEZE_V10 0
typedef struct {
} pd_parasdisputes_force_unfreeze_V10_t;
...
typedef union {
    ...
    pd_society_bid_V10_t society_bid_V10;
    pd_society_unbid_V10_t society_unbid_V10;
    pd_society_vouch_V10_t society_vouch_V10;
    pd_society_unvouch_V10_t society_unvouch_V10;
    pd_society_vote_V10_t society_vote_V10;
    pd_society_defender_vote_V10_t society_defender_vote_V10;
    pd_society_payout_V10_t society_payout_V10;
    pd_society_found_V10_t society_found_V10;
    pd_society_unfound_V10_t society_unfound_V10;
    pd_society_judge_suspended_member_V10_t society_judge_suspended_member_V10;
    pd_society_set_max_members_V10_t society_set_max_members_V10;
    pd_recovery_set_recovered_V10_t recovery_set_recovered_V10;
    pd_recovery_initiate_recovery_V10_t recovery_initiate_recovery_V10;
    pd_recovery_vouch_recovery_V10_t recovery_vouch_recovery_V10;
    pd_recovery_claim_recovery_V10_t recovery_claim_recovery_V10;
    pd_recovery_close_recovery_V10_t recovery_close_recovery_V10;
    pd_recovery_remove_recovery_V10_t recovery_remove_recovery_V10;
    pd_recovery_cancel_recovered_V10_t recovery_cancel_recovered_V10;
    ...
    pd_gilt_place_bid_V10_t gilt_place_bid_V10;
    pd_gilt_retract_bid_V10_t gilt_retract_bid_V10;
    ...
    pd_configuration_set_dispute_period_V10_t configuration_set_dispute_period_V10;
    ...
    pd_parasdisputes_force_unfreeze_V10_t parasdisputes_force_unfreeze_V10;
