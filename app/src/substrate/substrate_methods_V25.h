...
#define PD_CALL_FELLOWSHIPCOLLECTIVE_V25 22
#define PD_CALL_FELLOWSHIPREFERENDA_V25 23
#define PD_CALL_WHITELIST_V25 44
#define PD_CALL_CLAIMS_V25 19
#define PD_CALL_UTILITY_V25 24
#define PD_CALL_IDENTITY_V25 25
#define PD_CALL_SOCIETY_V25 26
#define PD_CALL_RECOVERY_V25 27
#define PD_CALL_VESTING_V25 28
#define PD_CALL_PROXY_V25 30
#define PD_CALL_MULTISIG_V25 31
#define PD_CALL_PREIMAGE_V25 32
#define PD_CALL_BOUNTIES_V25 35
#define PD_CALL_CHILDBOUNTIES_V25 40
#define PD_CALL_NIS_V25 38
#define PD_CALL_NISCOUNTERPARTBALANCES_V25 45
#define PD_CALL_VOTERLIST_V25 39
#define PD_CALL_NOMINATIONPOOLS_V25 41
#define PD_CALL_FASTUNSTAKE_V25 42
...
#define PD_CALL_FELLOWSHIPCOLLECTIVE_ADD_MEMBER_V25 0
typedef struct {
    pd_AccountIdLookupOfT_t who;
} pd_fellowshipcollective_add_member_V25_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_PROMOTE_MEMBER_V25 1
typedef struct {
    pd_AccountIdLookupOfT_t who;
} pd_fellowshipcollective_promote_member_V25_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_DEMOTE_MEMBER_V25 2
typedef struct {
    pd_AccountIdLookupOfT_t who;
} pd_fellowshipcollective_demote_member_V25_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_REMOVE_MEMBER_V25 3
typedef struct {
    pd_AccountIdLookupOfT_t who;
    pd_Rank_t min_rank;
} pd_fellowshipcollective_remove_member_V25_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_VOTE_V25 4
typedef struct {
    pd_PollIndexOf_t poll;
    pd_bool_t aye;
} pd_fellowshipcollective_vote_V25_t;

#define PD_CALL_FELLOWSHIPCOLLECTIVE_CLEANUP_POLL_V25 5
typedef struct {
...
typedef struct {
    ...
    pd_BoundedCallOfT_t proposal;
    pd_DispatchTimeBlockNumber_t enactment_moment;
} pd_fellowshipreferenda_submit_V25_t;

#define PD_CALL_FELLOWSHIPREFERENDA_PLACE_DECISION_DEPOSIT_V25 1
typedef struct {
    pd_ReferendumIndex_t index;
} pd_fellowshipreferenda_place_decision_deposit_V25_t;

#define PD_CALL_FELLOWSHIPREFERENDA_REFUND_DECISION_DEPOSIT_V25 2
typedef struct {
    pd_ReferendumIndex_t index;
} pd_fellowshipreferenda_refund_decision_deposit_V25_t;

#define PD_CALL_FELLOWSHIPREFERENDA_CANCEL_V25 3
typedef struct {
    pd_ReferendumIndex_t index;
} pd_fellowshipreferenda_cancel_V25_t;

#define PD_CALL_FELLOWSHIPREFERENDA_KILL_V25 4
typedef struct {
    pd_ReferendumIndex_t index;
} pd_fellowshipreferenda_kill_V25_t;

#define PD_CALL_FELLOWSHIPREFERENDA_NUDGE_REFERENDUM_V25 5
typedef struct {
    pd_ReferendumIndex_t index;
} pd_fellowshipreferenda_nudge_referendum_V25_t;

#define PD_CALL_FELLOWSHIPREFERENDA_ONE_FEWER_DECIDING_V25 6
typedef struct {
    pd_TrackIdOf_t track;
} pd_fellowshipreferenda_one_fewer_deciding_V25_t;

#define PD_CALL_FELLOWSHIPREFERENDA_REFUND_SUBMISSION_DEPOSIT_V25 7
typedef struct {
    pd_ReferendumIndex_t index;
} pd_fellowshipreferenda_refund_submission_deposit_V25_t;

#define PD_CALL_FELLOWSHIPREFERENDA_SET_METADATA_V25 8
typedef struct {
    pd_ReferendumIndex_t index;
    pd_OptionHash_t maybe_hash;
} pd_fellowshipreferenda_set_metadata_V25_t;
...
} pd_society_bid_V25_t;

#define PD_CALL_SOCIETY_UNBID_V25 1
typedef struct {
} pd_society_unbid_V25_t;

#define PD_CALL_SOCIETY_VOUCH_V25 2
typedef struct {
    pd_AccountIdLookupOfT_t who;
    pd_BalanceOf_t amount;
    pd_BalanceOf_t tip;
} pd_society_vouch_V25_t;

#define PD_CALL_SOCIETY_UNVOUCH_V25 3
typedef struct {
} pd_society_unvouch_V25_t;

#define PD_CALL_SOCIETY_VOTE_V25 4
typedef struct {
    pd_AccountIdLookupOfT_t candidate;
    pd_bool_t approve;
} pd_society_vote_V25_t;

#define PD_CALL_SOCIETY_DEFENDER_VOTE_V25 5
typedef struct {
    pd_bool_t approve;
} pd_society_defender_vote_V25_t;

#define PD_CALL_SOCIETY_PAYOUT_V25 6
typedef struct {
} pd_society_payout_V25_t;

#define PD_CALL_SOCIETY_WAIVE_REPAY_V25 7
typedef struct {
    pd_BalanceOf_t amount;
} pd_society_waive_repay_V25_t;

#define PD_CALL_SOCIETY_FOUND_SOCIETY_V25 8
typedef struct {
    ...
    pd_Vecu8_t rules;
} pd_society_found_society_V25_t;

#define PD_CALL_SOCIETY_DISSOLVE_V25 9
typedef struct {
} pd_society_dissolve_V25_t;

#define PD_CALL_SOCIETY_JUDGE_SUSPENDED_MEMBER_V25 10
typedef struct {
    pd_AccountIdLookupOfT_t who;
    pd_bool_t forgive;
} pd_society_judge_suspended_member_V25_t;

#define PD_CALL_SOCIETY_SET_PARAMETERS_V25 11
typedef struct {
    pd_u32_t max_members;
    pd_u32_t max_intake;
    pd_u32_t max_strikes;
    pd_BalanceOf_t candidate_deposit;
} pd_society_set_parameters_V25_t;

#define PD_CALL_SOCIETY_PUNISH_SKEPTIC_V25 12
typedef struct {
} pd_society_punish_skeptic_V25_t;

#define PD_CALL_SOCIETY_CLAIM_MEMBERSHIP_V25 13
typedef struct {
} pd_society_claim_membership_V25_t;

#define PD_CALL_SOCIETY_BESTOW_MEMBERSHIP_V25 14
typedef struct {
    pd_AccountId_t candidate;
} pd_society_bestow_membership_V25_t;

#define PD_CALL_SOCIETY_KICK_CANDIDATE_V25 15
typedef struct {
    pd_AccountId_t candidate;
} pd_society_kick_candidate_V25_t;

#define PD_CALL_SOCIETY_RESIGN_CANDIDACY_V25 16
typedef struct {
} pd_society_resign_candidacy_V25_t;

#define PD_CALL_SOCIETY_DROP_CANDIDATE_V25 17
typedef struct {
    pd_AccountId_t candidate;
} pd_society_drop_candidate_V25_t;

#define PD_CALL_SOCIETY_CLEANUP_CANDIDACY_V25 18
typedef struct {
    pd_AccountId_t candidate;
    pd_u32_t max;
} pd_society_cleanup_candidacy_V25_t;

#define PD_CALL_SOCIETY_CLEANUP_CHALLENGE_V25 19
typedef struct {
    pd_RoundIndex_t challenge_round;
    pd_u32_t max;
} pd_society_cleanup_challenge_V25_t;

#define PD_CALL_RECOVERY_SET_RECOVERED_V25 1
typedef struct {
    pd_AccountIdLookupOfT_t lost;
    pd_AccountIdLookupOfT_t rescuer;
} pd_recovery_set_recovered_V25_t;

#define PD_CALL_RECOVERY_INITIATE_RECOVERY_V25 3
typedef struct {
    pd_AccountIdLookupOfT_t account;
} pd_recovery_initiate_recovery_V25_t;

#define PD_CALL_RECOVERY_VOUCH_RECOVERY_V25 4
typedef struct {
    pd_AccountIdLookupOfT_t lost;
    pd_AccountIdLookupOfT_t rescuer;
} pd_recovery_vouch_recovery_V25_t;

#define PD_CALL_RECOVERY_CLAIM_RECOVERY_V25 5
typedef struct {
    pd_AccountIdLookupOfT_t account;
} pd_recovery_claim_recovery_V25_t;

#define PD_CALL_RECOVERY_CLOSE_RECOVERY_V25 6
typedef struct {
    pd_AccountIdLookupOfT_t rescuer;
} pd_recovery_close_recovery_V25_t;

#define PD_CALL_RECOVERY_REMOVE_RECOVERY_V25 7
typedef struct {
} pd_recovery_remove_recovery_V25_t;

#define PD_CALL_RECOVERY_CANCEL_RECOVERED_V25 8
typedef struct {
    pd_AccountIdLookupOfT_t account;
} pd_recovery_cancel_recovered_V25_t;
...
#define PD_CALL_NIS_PLACE_BID_V25 0
typedef struct {
    pd_Compactu128_t amount;
    pd_u32_t duration;
} pd_nis_place_bid_V25_t;

#define PD_CALL_NIS_RETRACT_BID_V25 1
typedef struct {
    pd_Compactu128_t amount;
    pd_u32_t duration;
} pd_nis_retract_bid_V25_t;

#define PD_CALL_NIS_FUND_DEFICIT_V25 2
typedef struct {
} pd_nis_fund_deficit_V25_t;

#define PD_CALL_NIS_THAW_PRIVATE_V25 3
typedef struct {
    pd_Compactu32_t index;
    pd_OptionPerquintill_t maybe_proportion;
} pd_nis_thaw_private_V25_t;

#define PD_CALL_NIS_THAW_COMMUNAL_V25 4
typedef struct {
    pd_Compactu32_t index;
} pd_nis_thaw_communal_V25_t;

#define PD_CALL_NIS_COMMUNIFY_V25 5
typedef struct {
    pd_Compactu32_t index;
} pd_nis_communify_V25_t;

#define PD_CALL_NIS_PRIVATIZE_V25 6
typedef struct {
    pd_Compactu32_t index;
} pd_nis_privatize_V25_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_TRANSFER_ALLOW_DEATH_V25 0
typedef struct {
    pd_AccountIdLookupOfT_t dest;
    pd_Compactu128_t amount;
} pd_niscounterpartbalances_transfer_allow_death_V25_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_FORCE_TRANSFER_V25 2
typedef struct {
    pd_AccountIdLookupOfT_t source;
    pd_AccountIdLookupOfT_t dest;
    pd_Compactu128_t amount;
} pd_niscounterpartbalances_force_transfer_V25_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_TRANSFER_KEEP_ALIVE_V25 3
typedef struct {
    pd_AccountIdLookupOfT_t dest;
    pd_Compactu128_t amount;
} pd_niscounterpartbalances_transfer_keep_alive_V25_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_TRANSFER_ALL_V25 4
typedef struct {
    pd_AccountIdLookupOfT_t dest;
    pd_bool_t keep_alive;
} pd_niscounterpartbalances_transfer_all_V25_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_FORCE_UNRESERVE_V25 5
typedef struct {
    pd_AccountIdLookupOfT_t who;
    pd_Balance_t amount;
} pd_niscounterpartbalances_force_unreserve_V25_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_UPGRADE_ACCOUNTS_V25 6
typedef struct {
    pd_VecAccountId_t who;
} pd_niscounterpartbalances_upgrade_accounts_V25_t;

#define PD_CALL_NISCOUNTERPARTBALANCES_FORCE_SET_BALANCE_V25 8
typedef struct {
    pd_AccountIdLookupOfT_t who;
...
#define PD_CALL_CONFIGURATION_SET_DISPUTE_PERIOD_V25 14
typedef struct {
    pd_SessionIndex_t new_;
} pd_configuration_set_dispute_period_V25_t;
...
typedef union {
    ...
    pd_fellowshipcollective_add_member_V25_t fellowshipcollective_add_member_V25;
    pd_fellowshipcollective_promote_member_V25_t fellowshipcollective_promote_member_V25;
    pd_fellowshipcollective_demote_member_V25_t fellowshipcollective_demote_member_V25;
    ...
    pd_fellowshipreferenda_cancel_V25_t fellowshipreferenda_cancel_V25;
    pd_fellowshipreferenda_kill_V25_t fellowshipreferenda_kill_V25;
    pd_fellowshipreferenda_nudge_referendum_V25_t fellowshipreferenda_nudge_referendum_V25;
    pd_fellowshipreferenda_one_fewer_deciding_V25_t fellowshipreferenda_one_fewer_deciding_V25;
    pd_fellowshipreferenda_refund_submission_deposit_V25_t fellowshipreferenda_refund_submission_deposit_V25;
    pd_fellowshipreferenda_set_metadata_V25_t fellowshipreferenda_set_metadata_V25;
    ...
    pd_society_unvouch_V25_t society_unvouch_V25;
    pd_society_vote_V25_t society_vote_V25;
    pd_society_defender_vote_V25_t society_defender_vote_V25;
    pd_society_payout_V25_t society_payout_V25;
    pd_society_waive_repay_V25_t society_waive_repay_V25;
    pd_society_found_society_V25_t society_found_society_V25;
    pd_society_dissolve_V25_t society_dissolve_V25;
    pd_society_judge_suspended_member_V25_t society_judge_suspended_member_V25;
    pd_society_set_parameters_V25_t society_set_parameters_V25;
    pd_society_punish_skeptic_V25_t society_punish_skeptic_V25;
    pd_society_claim_membership_V25_t society_claim_membership_V25;
    pd_society_bestow_membership_V25_t society_bestow_membership_V25;
    pd_society_kick_candidate_V25_t society_kick_candidate_V25;
    pd_society_resign_candidacy_V25_t society_resign_candidacy_V25;
    pd_society_drop_candidate_V25_t society_drop_candidate_V25;
    pd_society_cleanup_candidacy_V25_t society_cleanup_candidacy_V25;
    pd_society_cleanup_challenge_V25_t society_cleanup_challenge_V25;
    pd_recovery_set_recovered_V25_t recovery_set_recovered_V25;
    pd_recovery_initiate_recovery_V25_t recovery_initiate_recovery_V25;
    pd_recovery_vouch_recovery_V25_t recovery_vouch_recovery_V25;
    pd_recovery_claim_recovery_V25_t recovery_claim_recovery_V25;
    pd_recovery_close_recovery_V25_t recovery_close_recovery_V25;
    pd_recovery_remove_recovery_V25_t recovery_remove_recovery_V25;
    pd_recovery_cancel_recovered_V25_t recovery_cancel_recovered_V25;
    ...
    pd_nis_place_bid_V25_t nis_place_bid_V25;
    pd_nis_retract_bid_V25_t nis_retract_bid_V25;
    pd_nis_fund_deficit_V25_t nis_fund_deficit_V25;
    pd_nis_thaw_private_V25_t nis_thaw_private_V25;
    pd_nis_thaw_communal_V25_t nis_thaw_communal_V25;
    pd_nis_communify_V25_t nis_communify_V25;
    pd_nis_privatize_V25_t nis_privatize_V25;
    pd_niscounterpartbalances_transfer_allow_death_V25_t niscounterpartbalances_transfer_allow_death_V25;
    pd_niscounterpartbalances_force_transfer_V25_t niscounterpartbalances_force_transfer_V25;
    pd_niscounterpartbalances_transfer_keep_alive_V25_t niscounterpartbalances_transfer_keep_alive_V25;
    pd_niscounterpartbalances_transfer_all_V25_t niscounterpartbalances_transfer_all_V25;
    ...
    pd_configuration_set_dispute_period_V25_t configuration_set_dispute_period_V25;
