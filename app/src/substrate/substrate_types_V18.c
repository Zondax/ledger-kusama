...
parser_error_t _readClassOf_V18(parser_context_t* c, pd_ClassOf_V18_t* v)
{
    CHECK_INPUT()
...
parser_error_t _readPollIndexOf_V18(parser_context_t* c, pd_PollIndexOf_V18_t* v)
{
    CHECK_INPUT()
    CHECK_ERROR(_readUInt32(c, &v->value))
    return parser_ok;
...
parser_error_t _readPreimageHash_V18(parser_context_t* c, pd_PreimageHash_V18_t* v) {
    GEN_DEF_READARRAY(32)
}
...
parser_error_t _readRank_V18(parser_context_t* c, pd_Rank_V18_t* v)
{
    CHECK_INPUT()
    CHECK_ERROR(_readUInt16(c, &v->value))
    return parser_ok;
...
parser_error_t _readTrackIdOf_V18(parser_context_t* c, pd_TrackIdOf_V18_t* v)
{
    CHECK_INPUT()
    CHECK_ERROR(_readUInt16(c, &v->value))
    return parser_ok;
...
parser_error_t _readOptionClassOf_V18(parser_context_t* c, pd_OptionClassOf_V18_t* v)
{
    CHECK_ERROR(_readUInt8(c, &v->some))
    if (v->some > 0) {
        CHECK_ERROR(_readClassOf_V18(c, &v->contained))
    }
    return parser_ok;
}
    ...
    uint8_t* pageCount)
{
    ...
    CHECK_ERROR(_toStringAssetInstance_V18(&v->instance, outValue, outValueLen, 0, &pages[1]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[1]) {
        CHECK_ERROR(_toStringAssetInstance_V18(&v->instance, outValue, outValueLen, pageIdx, &pages[1]))
        return parser_ok;
    }
    ...
    uint8_t* pageCount)
{
    ...
    // First measure number of pages
    uint8_t pages[2] = { 0 };
    CHECK_ERROR(_toStringNetworkId_V18(&v->networkId, outValue, outValueLen, 0, &pages[0]))
    CHECK_ERROR(_toStringu8_array_32_V18(&v->key, outValue, outValueLen, 0, &pages[1]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[0]) {
        CHECK_ERROR(_toStringNetworkId_V18(&v->networkId, outValue, outValueLen, pageIdx, &pages[0]))
        return parser_ok;
    }
    pageIdx -= pages[0];

    if (pageIdx < pages[1]) {
        CHECK_ERROR(_toStringu8_array_32_V18(&v->key, outValue, outValueLen, pageIdx, &pages[1]))
        return parser_ok;
    }
    ...
    uint8_t* pageCount)
{
    ...
    switch (v->value) {
    case 0: // Id
        CHECK_ERROR(_toStringAccountId_V18(&v->id, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 1: // Index
        CHECK_ERROR(_toStringCompactAccountIndex_V18(&v->index, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 2: // Raw
    ...
    uint8_t* pageCount)
{
    ...
    pages[0] = 1;
    CHECK_ERROR(_toStringVote_V18(&v->vote, outValue, outValueLen, 0, &pages[1]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[1]) {
        CHECK_ERROR(_toStringVote_V18(&v->vote, outValue, outValueLen, pageIdx, &pages[1]));
        return parser_ok;
    }
    pageIdx -= pages[1];
    ...
    uint8_t* pageCount)
{
    ...
    switch (v->value) {
    case 0:
        CHECK_ERROR(_toStringAccountVoteStandard_V18(&v->voteStandard, outValue, outValueLen, pageIdx, pageCount));
        break;
    case 1:
        CHECK_ERROR(_toStringAccountVoteSplit_V18(&v->voteSplit, outValue, outValueLen, pageIdx, pageCount));
        break;
    default:
        return parser_unexpected_value;
    }
    ...
    uint8_t* pageCount)
{
    ...
    *pageCount = 1;
    ...
    case 1: // Members
        ...
        break;
    case 2: // Fraction
        CHECK_ERROR(_toStringFraction_V18(&v->fraction, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 3: // AtLeastProportion
        CHECK_ERROR(_toStringFraction_V18(&v->fraction, outValue, outValueLen, pageIdx, pageCount))
        break;
    ...
    uint8_t* pageCount)
{
    ...
    case 1:
        ...
        break;
    case 2:
        CHECK_ERROR(_toStringTupleH256u32_V18(&v->lookup, outValue, outValueLen, pageIdx, pageCount))
        break;
    default:
        return parser_unexpected_value;
    }
    ...
    uint8_t* pageCount)
{
    ...
    switch (v->value) {
    case 0: // V0
        CHECK_ERROR(_toStringVecMultiAssetV0_V18(&v->vecMultiassetV0, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 1: // V1
        CHECK_ERROR(_toStringVecMultiAssetV1_V18(&v->vecMultiassetV1, outValue, outValueLen, pageIdx, pageCount))
        break;
    default:
        return parser_not_supported;
    }
    ...
    uint8_t* pageCount)
{
    ...
    switch (v->value) {
    case 0: // V0
        CHECK_ERROR(_toStringMultiLocationV0_V18(&v->multilocationV0, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 1: // V1
        CHECK_ERROR(_toStringMultiLocationV1_V18(&v->multilocationV1, outValue, outValueLen, pageIdx, pageCount))
        break;
    default:
        return parser_not_supported;
    }
...
parser_error_t _toStringClassOf_V18(
    const pd_ClassOf_V18_t* v,
    char* outValue,
    uint16_t outValueLen,
    uint8_t pageIdx,
    uint8_t* pageCount)
    ...
    uint8_t* pageCount)
{
    ...
    // First measure number of pages
    uint8_t pages[2] = { 0 };
    CHECK_ERROR(_toStringMultiLocationV0_V18(&v->id, outValue, outValueLen, 0, &pages[0]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[0]) {
        CHECK_ERROR(_toStringMultiLocationV0_V18(&v->id, outValue, outValueLen, pageIdx, &pages[0]))
        return parser_ok;
    }
    pageIdx -= pages[0];
    ...
    uint8_t* pageCount)
{
    ...
    // First measure number of pages
    uint8_t pages[2] = { 0 };
    CHECK_ERROR(_toStringMultiLocationV0_V18(&v->_class, outValue, outValueLen, 0, &pages[0]))
    CHECK_ERROR(_toStringAssetInstance_V18(&v->instance, outValue, outValueLen, 0, &pages[1]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[0]) {
        CHECK_ERROR(_toStringMultiLocationV0_V18(&v->_class, outValue, outValueLen, pageIdx, &pages[0]))
        return parser_ok;
    }
    pageIdx -= pages[0];
    ...
    uint8_t* pageCount)
{
    ...
    *pageCount = 1;
    ...
    case 0:
        ...
        break;
    case 1:
        CHECK_ERROR(_toStringAccountId_V18(&v->set, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 2:
    ...
    uint8_t* pageCount)
{
    ...
    *pageCount = 1;
    ...
    case 0:
        ...
        break;
    case 1:
        CHECK_ERROR(_toStringPerbill_V18(&v->set, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 2:
        snprintf(outValue, outValueLen, "Remove");
        break;
    ...
    uint8_t* pageCount)
{
    ...
    *pageCount = 1;
    ...
    case 0:
        ...
        break;
    case 1:
        CHECK_ERROR(_toStringPercent_V18(&v->set, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 2:
        snprintf(outValue, outValueLen, "Remove");
        break;
    ...
    uint8_t* pageCount)
{
    ...
    case 0: // Undefined
        ...
        break;
    case 1: // Index
        CHECK_ERROR(_toStringAssetInstance_V18(&v->nonFungible, outValue, outValueLen, pageIdx, pageCount))
        break;
    default:
        return parser_not_supported;
    }
    ...
    uint8_t* pageCount)
{
    ...
    // First measure number of pages
    uint8_t pages[1] = { 0 };
    CHECK_ERROR(_toStringJunctionV0_V18(&v->junction, outValue, outValueLen, 0, &pages[0]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[0]) {
        CHECK_ERROR(_toStringJunctionV0_V18(&v->junction, outValue, outValueLen, pageIdx, &pages[0]))
        return parser_ok;
    }
    ...
    uint8_t* pageCount)
{
    ...
    // First measure number of pages
    uint8_t pages[2] = { 0 };
    CHECK_ERROR(_toStringJunctionV0_V18(&v->junction0, outValue, outValueLen, 0, &pages[0]))
    CHECK_ERROR(_toStringJunctionV0_V18(&v->junction1, outValue, outValueLen, 0, &pages[1]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[0]) {
        CHECK_ERROR(_toStringJunctionV0_V18(&v->junction0, outValue, outValueLen, pageIdx, &pages[0]))
        return parser_ok;
    }
    pageIdx -= pages[0];

    if (pageIdx < pages[1]) {
        CHECK_ERROR(_toStringJunctionV0_V18(&v->junction1, outValue, outValueLen, pageIdx, &pages[1]))
        return parser_ok;
    }
    ...
    uint8_t* pageCount)
{
    ...
    CHECK_ERROR(_toStringJunctionV0_V18(&v->junction0, outValue, outValueLen, 0, &pages[0]))
    CHECK_ERROR(_toStringJunctionV0_V18(&v->junction1, outValue, outValueLen, 0, &pages[1]))
    CHECK_ERROR(_toStringJunctionV0_V18(&v->junction2, outValue, outValueLen, 0, &pages[2]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[2]) {
        CHECK_ERROR(_toStringJunctionV0_V18(&v->junction2, outValue, outValueLen, pageIdx, &pages[2]))
        return parser_ok;
    }
    ...
    uint8_t* pageCount)
{
    ...
    CHECK_ERROR(_toStringJunctionV0_V18(&v->junction1, outValue, outValueLen, 0, &pages[1]))
    CHECK_ERROR(_toStringJunctionV0_V18(&v->junction2, outValue, outValueLen, 0, &pages[2]))
    CHECK_ERROR(_toStringJunctionV0_V18(&v->junction3, outValue, outValueLen, 0, &pages[3]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[3]) {
        CHECK_ERROR(_toStringJunctionV0_V18(&v->junction3, outValue, outValueLen, pageIdx, &pages[3]))
        return parser_ok;
    }
    ...
    uint8_t* pageCount)
{
    ...
    CHECK_ERROR(_toStringJunctionV0_V18(&v->junction2, outValue, outValueLen, 0, &pages[2]))
    CHECK_ERROR(_toStringJunctionV0_V18(&v->junction3, outValue, outValueLen, 0, &pages[3]))
    CHECK_ERROR(_toStringJunctionV0_V18(&v->junction4, outValue, outValueLen, 0, &pages[4]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[4]) {
        CHECK_ERROR(_toStringJunctionV0_V18(&v->junction4, outValue, outValueLen, pageIdx, &pages[4]))
        return parser_ok;
    }
    ...
    uint8_t* pageCount)
{
    ...
    CHECK_ERROR(_toStringJunctionV0_V18(&v->junction3, outValue, outValueLen, 0, &pages[3]))
    CHECK_ERROR(_toStringJunctionV0_V18(&v->junction4, outValue, outValueLen, 0, &pages[4]))
    CHECK_ERROR(_toStringJunctionV0_V18(&v->junction5, outValue, outValueLen, 0, &pages[5]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[5]) {
        CHECK_ERROR(_toStringJunctionV0_V18(&v->junction5, outValue, outValueLen, pageIdx, &pages[5]))
        return parser_ok;
    }
    ...
    uint8_t* pageCount)
{
    ...
    CHECK_ERROR(_toStringJunctionV0_V18(&v->junction4, outValue, outValueLen, 0, &pages[4]))
    CHECK_ERROR(_toStringJunctionV0_V18(&v->junction5, outValue, outValueLen, 0, &pages[5]))
    CHECK_ERROR(_toStringJunctionV0_V18(&v->junction6, outValue, outValueLen, 0, &pages[6]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[6]) {
        CHECK_ERROR(_toStringJunctionV0_V18(&v->junction6, outValue, outValueLen, pageIdx, &pages[6]))
        return parser_ok;
    }
    ...
    uint8_t* pageCount)
{
    ...
    CHECK_ERROR(_toStringJunctionV0_V18(&v->junction5, outValue, outValueLen, 0, &pages[5]))
    CHECK_ERROR(_toStringJunctionV0_V18(&v->junction6, outValue, outValueLen, 0, &pages[6]))
    CHECK_ERROR(_toStringJunctionV0_V18(&v->junction7, outValue, outValueLen, 0, &pages[7]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[7]) {
        CHECK_ERROR(_toStringJunctionV0_V18(&v->junction7, outValue, outValueLen, pageIdx, &pages[7]))
        return parser_ok;
    }
    ...
    uint8_t* pageCount)
{
    ...
    *pageCount = 1;
    ...
    case 1: // Parachain
        ...
        break;
    case 2: // AccountId32
        CHECK_ERROR(_toStringAccountId32_V18(&v->accountId32, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 3: // AccountIndex64
        CHECK_ERROR(_toStringAccountIndex64_V18(&v->accountIndex64, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 4: // AccountKey20
        CHECK_ERROR(_toStringAccountKey20_V18(&v->accountKey20, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 5: // PalletInstance
    ...
    case 8: // OnlyChild
        ...
        break;
    case 9: // Plurality
        CHECK_ERROR(_toStringPlurality_V18(&v->plurality, outValue, outValueLen, pageIdx, pageCount))
        break;
    default:
        return parser_unexpected_value;
    }
    ...
    uint8_t* pageCount)
{
    ...
    // First measure number of pages
    uint8_t pages[1] = { 0 };
    CHECK_ERROR(_toStringJunctionV1_V18(&v->junction, outValue, outValueLen, 0, &pages[0]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[0]) {
        CHECK_ERROR(_toStringJunctionV1_V18(&v->junction, outValue, outValueLen, pageIdx, &pages[0]))
        return parser_ok;
    }
    ...
    uint8_t* pageCount)
{
    ...
    // First measure number of pages
    uint8_t pages[2] = { 0 };
    CHECK_ERROR(_toStringJunctionV1_V18(&v->junction0, outValue, outValueLen, 0, &pages[0]))
    CHECK_ERROR(_toStringJunctionV1_V18(&v->junction1, outValue, outValueLen, 0, &pages[1]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[0]) {
        CHECK_ERROR(_toStringJunctionV1_V18(&v->junction0, outValue, outValueLen, pageIdx, &pages[0]))
        return parser_ok;
    }
    pageIdx -= pages[0];

    if (pageIdx < pages[1]) {
        CHECK_ERROR(_toStringJunctionV1_V18(&v->junction1, outValue, outValueLen, pageIdx, &pages[1]))
        return parser_ok;
    }
    ...
    uint8_t* pageCount)
{
    ...
    CHECK_ERROR(_toStringJunctionV1_V18(&v->junction0, outValue, outValueLen, 0, &pages[0]))
    CHECK_ERROR(_toStringJunctionV1_V18(&v->junction1, outValue, outValueLen, 0, &pages[1]))
    CHECK_ERROR(_toStringJunctionV1_V18(&v->junction2, outValue, outValueLen, 0, &pages[2]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[2]) {
        CHECK_ERROR(_toStringJunctionV1_V18(&v->junction2, outValue, outValueLen, pageIdx, &pages[2]))
        return parser_ok;
    }
    ...
    uint8_t* pageCount)
{
    ...
    CHECK_ERROR(_toStringJunctionV1_V18(&v->junction1, outValue, outValueLen, 0, &pages[1]))
    CHECK_ERROR(_toStringJunctionV1_V18(&v->junction2, outValue, outValueLen, 0, &pages[2]))
    CHECK_ERROR(_toStringJunctionV1_V18(&v->junction3, outValue, outValueLen, 0, &pages[3]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[3]) {
        CHECK_ERROR(_toStringJunctionV1_V18(&v->junction3, outValue, outValueLen, pageIdx, &pages[3]))
        return parser_ok;
    }
    ...
    uint8_t* pageCount)
{
    ...
    CHECK_ERROR(_toStringJunctionV1_V18(&v->junction2, outValue, outValueLen, 0, &pages[2]))
    CHECK_ERROR(_toStringJunctionV1_V18(&v->junction3, outValue, outValueLen, 0, &pages[3]))
    CHECK_ERROR(_toStringJunctionV1_V18(&v->junction4, outValue, outValueLen, 0, &pages[4]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[4]) {
        CHECK_ERROR(_toStringJunctionV1_V18(&v->junction4, outValue, outValueLen, pageIdx, &pages[4]))
        return parser_ok;
    }
    ...
    uint8_t* pageCount)
{
    ...
    CHECK_ERROR(_toStringJunctionV1_V18(&v->junction3, outValue, outValueLen, 0, &pages[3]))
    CHECK_ERROR(_toStringJunctionV1_V18(&v->junction4, outValue, outValueLen, 0, &pages[4]))
    CHECK_ERROR(_toStringJunctionV1_V18(&v->junction5, outValue, outValueLen, 0, &pages[5]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[5]) {
        CHECK_ERROR(_toStringJunctionV1_V18(&v->junction5, outValue, outValueLen, pageIdx, &pages[5]))
        return parser_ok;
    }
    ...
    uint8_t* pageCount)
{
    ...
    CHECK_ERROR(_toStringJunctionV1_V18(&v->junction4, outValue, outValueLen, 0, &pages[4]))
    CHECK_ERROR(_toStringJunctionV1_V18(&v->junction5, outValue, outValueLen, 0, &pages[5]))
    CHECK_ERROR(_toStringJunctionV1_V18(&v->junction6, outValue, outValueLen, 0, &pages[6]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[6]) {
        CHECK_ERROR(_toStringJunctionV1_V18(&v->junction6, outValue, outValueLen, pageIdx, &pages[6]))
        return parser_ok;
    }
    ...
    uint8_t* pageCount)
{
    ...
    CHECK_ERROR(_toStringJunctionV1_V18(&v->junction5, outValue, outValueLen, 0, &pages[5]))
    CHECK_ERROR(_toStringJunctionV1_V18(&v->junction6, outValue, outValueLen, 0, &pages[6]))
    CHECK_ERROR(_toStringJunctionV1_V18(&v->junction7, outValue, outValueLen, 0, &pages[7]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[7]) {
        CHECK_ERROR(_toStringJunctionV1_V18(&v->junction7, outValue, outValueLen, pageIdx, &pages[7]))
        return parser_ok;
    }
    ...
    uint8_t* pageCount)
{
    ...
    case 0: // Null
        *pageCount = 1;
        ...
        break;
    case 1: // X1
        CHECK_ERROR(_toStringJunctionV0X1_V18(&v->x1, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 2: // X2
        CHECK_ERROR(_toStringJunctionV0X2_V18(&v->x2, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 3: // X3
        CHECK_ERROR(_toStringJunctionV0X3_V18(&v->x3, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 4: // X4
        CHECK_ERROR(_toStringJunctionV0X4_V18(&v->x4, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 5: // X5
        CHECK_ERROR(_toStringJunctionV0X5_V18(&v->x5, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 6: // X6
        CHECK_ERROR(_toStringJunctionV0X6_V18(&v->x6, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 7: // X7
        CHECK_ERROR(_toStringJunctionV0X7_V18(&v->x7, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 8: // X8
        CHECK_ERROR(_toStringJunctionV0X8_V18(&v->x8, outValue, outValueLen, pageIdx, pageCount))
        break;
    default:
        return parser_unexpected_value;
    }
    ...
    uint8_t* pageCount)
{
    ...
    case 0: // Here
        *pageCount = 1;
        ...
        break;
    case 1: // X1
        CHECK_ERROR(_toStringJunctionV1X1_V18(&v->x1, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 2: // X2
        CHECK_ERROR(_toStringJunctionV1X2_V18(&v->x2, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 3: // X3
        CHECK_ERROR(_toStringJunctionV1X3_V18(&v->x3, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 4: // X4
        CHECK_ERROR(_toStringJunctionV1X4_V18(&v->x4, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 5: // X5
        CHECK_ERROR(_toStringJunctionV1X5_V18(&v->x5, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 6: // X6
        CHECK_ERROR(_toStringJunctionV1X6_V18(&v->x6, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 7: // X7
        CHECK_ERROR(_toStringJunctionV1X7_V18(&v->x7, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 8: // X8
        CHECK_ERROR(_toStringJunctionV1X8_V18(&v->x8, outValue, outValueLen, pageIdx, pageCount))
        break;
    default:
        return parser_unexpected_value;
    }
    ...
    uint8_t* pageCount)
{
    ...
    switch (v->value) {
    case 0: // Concrete
        CHECK_ERROR(_toStringMultiLocationV1_V18(&v->concrete, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 1: // Abstract
    ...
    uint8_t* pageCount)
{
    ...
    *pageCount = 1;
    ...
    case 6: // AllConcreteFungible
    case 7: // AllConcreteNonFungible
        CHECK_ERROR(_toStringMultiLocationV0_V18(&v->concrete, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 8: // AbstractFungible
        CHECK_ERROR(_toStringAbstractFungible_V18(&v->abstractFungible, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 9: // AbstractNonFungible
        CHECK_ERROR(_toStringAbstractNonFungible_V18(&v->abstractNonFungible, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 10: // ConcreteFungible
        CHECK_ERROR(_toStringConcreteFungible_V18(&v->concreteFungible, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 11: // ConcreteNonFungible
        CHECK_ERROR(_toStringConcreteNonFungible_V18(&v->concreteNonFungible, outValue, outValueLen, pageIdx, pageCount))
        break;
    default:
        return parser_unexpected_value;
    }
    ...
    uint8_t* pageCount)
{
    ...
    // First measure number of pages
    uint8_t pages[2] = { 0 };
    CHECK_ERROR(_toStringMultiAssetId_V18(&v->assetId, outValue, outValueLen, 0, &pages[0]))
    CHECK_ERROR(_toStringFungibility_V18(&v->fungibility, outValue, outValueLen, 0, &pages[1]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[0]) {
        CHECK_ERROR(_toStringMultiAssetId_V18(&v->assetId, outValue, outValueLen, pageIdx, &pages[0]))
        return parser_ok;
    }
    pageIdx -= pages[0];

    if (pageIdx < pages[1]) {
        CHECK_ERROR(_toStringFungibility_V18(&v->fungibility, outValue, outValueLen, pageIdx, &pages[1]))
        return parser_ok;
    }
...
{
    CLEAN_AND_CHECK()
    CHECK_ERROR(_toStringJunctionsV0_V18(&v->junctions, outValue, outValueLen, pageIdx, pageCount))
    return parser_ok;
}
    ...
    uint8_t* pageCount)
{
    ...
    CHECK_ERROR(_toStringJunctionsV1_V18(&v->interior, outValue, outValueLen, 0, &pages[1]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[1]) {
        CHECK_ERROR(_toStringJunctionsV1_V18(&v->interior, outValue, outValueLen, pageIdx, &pages[1]))
        return parser_ok;
    }
    ...
    uint8_t* pageCount)
{
    ...
    switch (v->value) {
    case 0: // Ed25519
        CHECK_ERROR(_toStringEd25519Signature_V18(&v->ed25519, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 1: // Sr25519
        CHECK_ERROR(_toStringSr25519Signature_V18(&v->sr25519, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 2: // Ecdsa
        CHECK_ERROR(_toStringEcdsaSignature_V18(&v->ecdsa, outValue, outValueLen, pageIdx, pageCount))
        break;
    default:
        return parser_not_supported;
    }
    ...
    uint8_t* pageCount)
{
    ...
    switch (v->value) {
    case 0: // Ed25519
        CHECK_ERROR(_toStringEd25519Public_V18(&v->ed25519, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 1: // Sr25519
        CHECK_ERROR(_toStringSr25519Public_V18(&v->sr25519, outValue, outValueLen, pageIdx, pageCount))
        break;
    case 2: // Ecdsa
        CHECK_ERROR(_toStringEcdsaPublic_V18(&v->ecdsa, outValue, outValueLen, pageIdx, pageCount))
        break;
    default:
        return parser_not_supported;
    }
    ...
    uint8_t* pageCount)
{
    ...
    CHECK_ERROR(_toStringBodyPart_V18(&v->part, outValue, outValueLen, 0, &pages[1]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[0]) {
        CHECK_ERROR(_toStringBodyId_V18(&v->id, outValue, outValueLen, pageIdx, &pages[0]))
        return parser_ok;
    }
    pageIdx -= pages[0];

    if (pageIdx < pages[1]) {
        CHECK_ERROR(_toStringBodyPart_V18(&v->part, outValue, outValueLen, pageIdx, &pages[1]))
        return parser_ok;
    }
...
parser_error_t _toStringPollIndexOf_V18(
    const pd_PollIndexOf_V18_t* v,
    char* outValue,
    uint16_t outValueLen,
    uint8_t pageIdx,
    uint8_t* pageCount)
...
parser_error_t _toStringPreimageHash_V18(
    const pd_PreimageHash_V18_t* v,
    char* outValue,
    uint16_t outValueLen,
    uint8_t pageIdx,
    uint8_t* pageCount) {
...
parser_error_t _toStringRank_V18(
    const pd_Rank_V18_t* v,
    char* outValue,
    uint16_t outValueLen,
    uint8_t pageIdx,
    uint8_t* pageCount)
    ...
    uint8_t* pageCount)
{
    ...
    *pageCount = 1;
    ...
    case 2:
        ...
        break;
    case 3:
        CHECK_ERROR(_toStringAccountId_V18(&v->accountId, outValue, outValueLen, pageIdx, pageCount));
        break;
    case 4:
        snprintf(outValue, outValueLen, "None");
        break;
...
parser_error_t _toStringTrackIdOf_V18(
    const pd_TrackIdOf_V18_t* v,
    char* outValue,
    uint16_t outValueLen,
    uint8_t pageIdx,
    uint8_t* pageCount)
    ...
    uint8_t* pageCount)
{
    ...
    // First measure number of pages
    uint8_t pages[2] = { 0 };
    CHECK_ERROR(_toStringAccountId_V18(&v->id, outValue, outValueLen, 0, &pages[0]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[0]) {
        CHECK_ERROR(_toStringAccountId_V18(&v->id, outValue, outValueLen, pageIdx, &pages[0]))
        return parser_ok;
    }
    pageIdx -= pages[0];
    ...
    uint8_t* pageCount)
{
    ...
    // First measure number of pages
    uint8_t pages[2] = { 0 };
    CHECK_ERROR(_toStringCompactPerBill_V18(&v->commission, outValue, outValueLen, 0, &pages[0]))
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[0]) {
        CHECK_ERROR(_toStringCompactPerBill_V18(&v->commission, outValue, outValueLen, pageIdx, &pages[0]))
        return parser_ok;
    }
    pageIdx -= pages[0];
    ...
    uint8_t* pageCount)
{
    ...
    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringAccountId_V18(
            &v->contained,
...
parser_error_t _toStringOptionClassOf_V18(
    const pd_OptionClassOf_V18_t* v,
    char* outValue,
    uint16_t outValueLen,
    uint8_t pageIdx,
    uint8_t* pageCount)
{
    ...
    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringClassOf_V18(
            &v->contained,
            outValue, outValueLen,
            pageIdx, pageCount));
    } else {
    ...
    uint8_t* pageCount)
{
    ...
    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringMultiSignature_V18(
            &v->contained,
            outValue, outValueLen,
            pageIdx, pageCount));
    } else {
    ...
    uint8_t* pageCount)
{
    ...
    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringMultiSigner_V18(
            &v->contained,
            outValue, outValueLen,
            pageIdx, pageCount));
    } else {
    ...
    uint8_t* pageCount)
{
    ...
    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringProxyType_V18(
            &v->contained,
            outValue, outValueLen,
            pageIdx, pageCount));
    } else {
    ...
    uint8_t* pageCount)
{
    ...
    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringReferendumIndex_V18(
            &v->contained,
            outValue, outValueLen,
            pageIdx, pageCount));
    } else {
    ...
    uint8_t* pageCount)
{
    ...
    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringTimepoint_V18(
            &v->contained,
            outValue, outValueLen,
            pageIdx, pageCount));
    } else {
