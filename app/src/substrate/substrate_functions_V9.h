...
parser_error_t _readBoxCallOrHashOfT_V9(parser_context_t* c, pd_BoxCallOrHashOfT_V9_t* v);
...
parser_error_t _readJudgement_V9(parser_context_t* c, pd_Judgement_V9_t* v);
...
parser_error_t _readPvfCheckStatement_V9(parser_context_t* c, pd_PvfCheckStatement_V9_t* v);
...
parser_error_t _readValidationCodeHash_V9(parser_context_t* c, pd_ValidationCodeHash_V9_t* v);
...
parser_error_t _readValidatorSignature_V9(parser_context_t* c, pd_ValidatorSignature_V9_t* v);
...
parser_error_t _toStringBoxCallOrHashOfT_V9(
    const pd_BoxCallOrHashOfT_V9_t* v,
    char* outValue,
    uint16_t outValueLen,
    uint8_t pageIdx,
    uint8_t* pageCount);
...
parser_error_t _toStringJudgement_V9(
    const pd_Judgement_V9_t* v,
    char* outValue,
    uint16_t outValueLen,
    uint8_t pageIdx,
    uint8_t* pageCount);
...
parser_error_t _toStringPvfCheckStatement_V9(
    const pd_PvfCheckStatement_V9_t* v,
    char* outValue,
    uint16_t outValueLen,
    uint8_t pageIdx,
    uint8_t* pageCount);
...
parser_error_t _toStringValidationCodeHash_V9(
    const pd_ValidationCodeHash_V9_t* v,
    char* outValue,
    uint16_t outValueLen,
    uint8_t pageIdx,
    uint8_t* pageCount);
...
parser_error_t _toStringValidatorSignature_V9(
    const pd_ValidatorSignature_V9_t* v,
    char* outValue,
    uint16_t outValueLen,
    uint8_t pageIdx,
    uint8_t* pageCount);
