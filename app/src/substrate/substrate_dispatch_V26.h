...
parser_error_t _readMethod_V26(parser_context_t* c, uint8_t moduleIdx, uint8_t callIdx, pd_Method_V26_t* method);
...
parser_error_t _getMethod_ItemValue_V26(
    pd_Method_V26_t* m, uint8_t moduleIdx, uint8_t callIdx, uint8_t itemIdx,
