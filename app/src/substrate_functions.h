...
parser_error_t _readReferendumIndex(parser_context_t *c,
                                    pd_ReferendumIndex_t *v);
...
parser_error_t _readEthereumAddress(parser_context_t *c,
                                    pd_EthereumAddress_t *v);
...
parser_error_t _toStringEthereumAddress(const pd_EthereumAddress_t *v,
                                        char *outValue, uint16_t outValueLen,
                                        uint8_t pageIdx, uint8_t *pageCount);
