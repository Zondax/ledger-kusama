...
typedef compactInt_t pd_CompactActiveIndex_V6_t;

typedef compactInt_t pd_CompactAuctionIndex_V6_t;

typedef compactInt_t pd_CompactBountyIndex_V6_t;

typedef compactInt_t pd_CompactEraIndex_V6_t;

typedef compactInt_t pd_CompactLeasePeriodOf_V6_t;

typedef compactInt_t pd_CompactMemberCount_V6_t;

typedef compactInt_t pd_CompactMoment_V6_t;

typedef compactInt_t pd_CompactParaId_V6_t;

typedef compactInt_t pd_CompactPerquintill_V6_t;
...
typedef struct {
    uint8_t some;
    pd_ElectionScore_V6_t contained;
} pd_OptionElectionScore_V6_t;

typedef struct {
    uint8_t some;
    pd_MultiSignature_V6_t contained;
} pd_OptionMultiSignature_V6_t;

typedef struct {
    uint8_t some;
    pd_MultiSigner_V6_t contained;
} pd_OptionMultiSigner_V6_t;

typedef struct {
    uint8_t some;
    pd_Percent_V6_t contained;
} pd_OptionPercent_V6_t;
...
typedef struct {
    // TODO: Not implemented
    uint8_t _NOT_IMPLEMENTED__DO_NOT_USE;
} pd_ParachainsInherentData_V6_t;
...
typedef struct {
    // TODO: Not implemented
    uint8_t _NOT_IMPLEMENTED__DO_NOT_USE;
} pd_VersionedMultiAssets_V6_t;

typedef struct {
    // TODO: Not implemented
    uint8_t _NOT_IMPLEMENTED__DO_NOT_USE;
} pd_VersionedMultiLocation_V6_t;

typedef struct {
    // TODO: Not implemented
    uint8_t _NOT_IMPLEMENTED__DO_NOT_USE;
} pd_VersionedXcm_V6_t;
