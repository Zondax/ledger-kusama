...
|Vouch |    | :heavy_check_mark: |   | `AccountIdLookupOfT` who <br/>`BalanceOf` amount <br/>`BalanceOf` tip <br/> |
|Unvouch |    | :heavy_check_mark: |   | `u32` pos <br/> |
|Vote |    | :heavy_check_mark: |   | `AccountIdLookupOfT` candidate <br/>`bool` approve <br/> |
|Defender vote |    | :heavy_check_mark: |   | `bool` approve <br/> |
|Payout |    | :heavy_check_mark: |   |  |
|Found |    | :heavy_check_mark: |   | `AccountIdLookupOfT` founder <br/>`u32` max_members <br/>`Bytes` rules <br/> |
|Unfound |    | :heavy_check_mark: |   |  |
|Judge suspended member |    | :heavy_check_mark: |   | `AccountIdLookupOfT` who <br/>`bool` forgive <br/> |
...
|Set recovered |    | :heavy_check_mark: |   | `AccountIdLookupOfT` lost <br/>`AccountIdLookupOfT` rescuer <br/> |
|Create recovery |    |   |   | `VecAccountId` friends <br/>`u16` threshold <br/>`BlockNumber` delay_period <br/> |
|Initiate recovery |    | :heavy_check_mark: |   | `AccountIdLookupOfT` account <br/> |
|Vouch recovery |    | :heavy_check_mark: |   | `AccountIdLookupOfT` lost <br/>`AccountIdLookupOfT` rescuer <br/> |
|Claim recovery |    | :heavy_check_mark: |   | `AccountIdLookupOfT` account <br/> |
|Close recovery |    | :heavy_check_mark: |   | `AccountIdLookupOfT` rescuer <br/> |
|Remove recovery |    | :heavy_check_mark: |   |  |
|Cancel recovered |    | :heavy_check_mark: |   | `AccountIdLookupOfT` account <br/> |
...
|Set dispute period |    | :heavy_check_mark: |   | `SessionIndex` new_ <br/> |
